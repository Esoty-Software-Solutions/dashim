...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeCreateManyCreatedByInput>;
export const BeneficiaryEntityFutureStatusChangeCreateManyCreatedByInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
