...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityUpdateManyWithoutInsurancePolicyNestedInput>;
export const BeneficiaryEntityUpdateManyWithoutInsurancePolicyNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
