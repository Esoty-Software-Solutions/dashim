...
type SchemaType = z.ZodType<Prisma.MedicalCenterUncheckedCreateWithoutCityInput>;
export const MedicalCenterUncheckedCreateWithoutCityInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
