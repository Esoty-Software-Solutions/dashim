...
type SchemaType = z.ZodType<Prisma.FingerprintBiometricUpdateManyWithoutBeneficiaryNestedInput>;
export const FingerprintBiometricUpdateManyWithoutBeneficiaryNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
