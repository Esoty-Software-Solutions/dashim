...
type SchemaType = z.ZodType<Prisma.MedicalCenterCreateWithoutEntryRecordsInput>;
export const MedicalCenterCreateWithoutEntryRecordsInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
