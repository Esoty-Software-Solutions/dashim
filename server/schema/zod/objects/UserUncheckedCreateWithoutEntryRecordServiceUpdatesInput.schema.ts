...
type SchemaType = z.ZodType<Prisma.UserUncheckedCreateWithoutEntryRecordServiceUpdatesInput>;
export const UserUncheckedCreateWithoutEntryRecordServiceUpdatesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
