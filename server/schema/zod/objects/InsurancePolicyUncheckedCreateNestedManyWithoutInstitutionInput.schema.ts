...
type SchemaType = z.ZodType<Prisma.InsurancePolicyUncheckedCreateNestedManyWithoutInstitutionInput>;
export const InsurancePolicyUncheckedCreateNestedManyWithoutInstitutionInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
