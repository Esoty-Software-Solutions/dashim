...
type SchemaType = z.ZodType<Prisma.ReviewStatusEnumScalarWhereWithAggregatesInput>;
export const ReviewStatusEnumScalarWhereWithAggregatesInputObjectSchema: SchemaType = z
    .object({
        AND: z
            .union([
                z.lazy(() => ReviewStatusEnumScalarWhereWithAggregatesInputObjectSchema),
                z.lazy(() => ReviewStatusEnumScalarWhereWithAggregatesInputObjectSchema).array(),
            ])
            .optional(),
        OR: z
