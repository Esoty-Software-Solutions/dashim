...
type SchemaType = z.ZodType<Prisma.InstitutionMedicalServiceUncheckedUpdateManyWithoutInstitutionNestedInput>;
export const InstitutionMedicalServiceUncheckedUpdateManyWithoutInstitutionNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
                z.lazy(() => InstitutionMedicalServiceCreateWithoutInstitutionInputObjectSchema),
                z.lazy(() => InstitutionMedicalServiceCreateWithoutInstitutionInputObjectSchema).array(),
                z.lazy(() => InstitutionMedicalServiceUncheckedCreateWithoutInstitutionInputObjectSchema),
                z.lazy(() => InstitutionMedicalServiceUncheckedCreateWithoutInstitutionInputObjectSchema).array(),
            ])
            .optional(),
        connectOrCreate: z
            .union([
                z.lazy(() => InstitutionMedicalServiceCreateOrConnectWithoutInstitutionInputObjectSchema),
                z.lazy(() => InstitutionMedicalServiceCreateOrConnectWithoutInstitutionInputObjectSchema).array(),
            ])
            .optional(),
        upsert: z
            .union([
                z.lazy(() => InstitutionMedicalServiceUpsertWithWhereUniqueWithoutInstitutionInputObjectSchema),
                z.lazy(() => InstitutionMedicalServiceUpsertWithWhereUniqueWithoutInstitutionInputObjectSchema).array(),
            ])
            .optional(),
        createMany: z.lazy(() => InstitutionMedicalServiceCreateManyInstitutionInputEnvelopeObjectSchema).optional(),
        set: z
            .union([
        ...
        update: z
            .union([
                z.lazy(() => InstitutionMedicalServiceUpdateWithWhereUniqueWithoutInstitutionInputObjectSchema),
                z.lazy(() => InstitutionMedicalServiceUpdateWithWhereUniqueWithoutInstitutionInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => InstitutionMedicalServiceUpdateManyWithWhereWithoutInstitutionInputObjectSchema),
                z.lazy(() => InstitutionMedicalServiceUpdateManyWithWhereWithoutInstitutionInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
