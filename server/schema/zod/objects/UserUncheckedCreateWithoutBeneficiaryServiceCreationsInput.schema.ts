...
type SchemaType = z.ZodType<Prisma.UserUncheckedCreateWithoutBeneficiaryServiceCreationsInput>;
export const UserUncheckedCreateWithoutBeneficiaryServiceCreationsInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
