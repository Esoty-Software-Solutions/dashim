...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceCreateNestedManyWithoutMedicalServiceInput>;
export const BeneficiaryServiceCreateNestedManyWithoutMedicalServiceInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
