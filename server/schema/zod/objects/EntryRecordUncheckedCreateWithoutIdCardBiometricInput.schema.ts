...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedCreateWithoutIdCardBiometricInput>;
export const EntryRecordUncheckedCreateWithoutIdCardBiometricInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
