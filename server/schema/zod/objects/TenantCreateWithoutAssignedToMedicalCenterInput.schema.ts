...
type SchemaType = z.ZodType<Prisma.TenantCreateWithoutAssignedToMedicalCenterInput>;
export const TenantCreateWithoutAssignedToMedicalCenterInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
