...
type SchemaType =
    z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryUncheckedCreateNestedManyWithoutBenefitPackageInput>;
export const BenefitPackageMedicalServiceCategoryUncheckedCreateNestedManyWithoutBenefitPackageInputObjectSchema: SchemaType =
    z
        .object({
            create: z
                .union([
