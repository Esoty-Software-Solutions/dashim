...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceCreateNestedManyWithoutCreatedByInput>;
export const BeneficiaryServiceCreateNestedManyWithoutCreatedByInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
