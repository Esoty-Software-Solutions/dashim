...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceUncheckedCreateWithoutMedicalServiceInput>;
export const BeneficiaryServiceUncheckedCreateWithoutMedicalServiceInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
