...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeCreateInput>;
export const BeneficiaryEntityFutureStatusChangeCreateInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
