...
type SchemaType = z.ZodType<Prisma.MedicalCenterCreateNestedOneWithoutInsurancePolicyInput>;
export const MedicalCenterCreateNestedOneWithoutInsurancePolicyInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
