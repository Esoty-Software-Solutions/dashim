...
type SchemaType = z.ZodType<Prisma.TenantUncheckedCreateWithoutMembersInput>;
export const TenantUncheckedCreateWithoutMembersInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
