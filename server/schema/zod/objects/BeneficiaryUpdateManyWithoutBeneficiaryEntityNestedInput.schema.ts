...
type SchemaType = z.ZodType<Prisma.BeneficiaryUpdateManyWithoutBeneficiaryEntityNestedInput>;
export const BeneficiaryUpdateManyWithoutBeneficiaryEntityNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
