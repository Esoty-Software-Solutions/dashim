...
type SchemaType = z.ZodType<Prisma.BeneficiaryUncheckedCreateNestedManyWithoutGenderInput>;
export const BeneficiaryUncheckedCreateNestedManyWithoutGenderInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
