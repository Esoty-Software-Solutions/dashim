...
type SchemaType = z.ZodType<Prisma.TenantTypeEnumOrderByWithRelationInput>;
export const TenantTypeEnumOrderByWithRelationInputObjectSchema: SchemaType = z
    .object({
        ...
        tenant: z.lazy(() => TenantOrderByRelationAggregateInputObjectSchema).optional(),
    })
