...
type SchemaType = z.ZodType<Prisma.DeviceTokenUncheckedUpdateManyWithoutUserNestedInput>;
export const DeviceTokenUncheckedUpdateManyWithoutUserNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => DeviceTokenUpsertWithWhereUniqueWithoutUserInputObjectSchema),
                z.lazy(() => DeviceTokenUpsertWithWhereUniqueWithoutUserInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => DeviceTokenUpdateWithWhereUniqueWithoutUserInputObjectSchema),
                z.lazy(() => DeviceTokenUpdateWithWhereUniqueWithoutUserInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => DeviceTokenUpdateManyWithWhereWithoutUserInputObjectSchema),
                z.lazy(() => DeviceTokenUpdateManyWithWhereWithoutUserInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
