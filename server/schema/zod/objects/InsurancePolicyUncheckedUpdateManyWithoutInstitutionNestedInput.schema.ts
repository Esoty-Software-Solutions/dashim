...
type SchemaType = z.ZodType<Prisma.InsurancePolicyUncheckedUpdateManyWithoutInstitutionNestedInput>;
export const InsurancePolicyUncheckedUpdateManyWithoutInstitutionNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => InsurancePolicyUpsertWithWhereUniqueWithoutInstitutionInputObjectSchema),
                z.lazy(() => InsurancePolicyUpsertWithWhereUniqueWithoutInstitutionInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => InsurancePolicyUpdateWithWhereUniqueWithoutInstitutionInputObjectSchema),
                z.lazy(() => InsurancePolicyUpdateWithWhereUniqueWithoutInstitutionInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => InsurancePolicyUpdateManyWithWhereWithoutInstitutionInputObjectSchema),
                z.lazy(() => InsurancePolicyUpdateManyWithWhereWithoutInstitutionInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
