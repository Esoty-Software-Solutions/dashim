...
type SchemaType = z.ZodType<Prisma.BeneficiaryFutureStatusChangeUncheckedCreateNestedManyWithoutBeneficiaryInput>;
export const BeneficiaryFutureStatusChangeUncheckedCreateNestedManyWithoutBeneficiaryInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
