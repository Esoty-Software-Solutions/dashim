...
type SchemaType = z.ZodType<Prisma.ReviewStatusUncheckedUpdateManyWithoutUpdatedByNestedInput>;
export const ReviewStatusUncheckedUpdateManyWithoutUpdatedByNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => ReviewStatusUpsertWithWhereUniqueWithoutUpdatedByInputObjectSchema),
                z.lazy(() => ReviewStatusUpsertWithWhereUniqueWithoutUpdatedByInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => ReviewStatusUpdateWithWhereUniqueWithoutUpdatedByInputObjectSchema),
                z.lazy(() => ReviewStatusUpdateWithWhereUniqueWithoutUpdatedByInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => ReviewStatusUpdateManyWithWhereWithoutUpdatedByInputObjectSchema),
                z.lazy(() => ReviewStatusUpdateManyWithWhereWithoutUpdatedByInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
