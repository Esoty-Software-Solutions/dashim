...
type SchemaType = z.ZodType<Prisma.FingerprintBiometricCreateNestedManyWithoutFingerTypeInput>;
export const FingerprintBiometricCreateNestedManyWithoutFingerTypeInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
