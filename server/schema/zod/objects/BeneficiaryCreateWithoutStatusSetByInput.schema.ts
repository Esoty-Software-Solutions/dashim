...
type SchemaType = z.ZodType<Prisma.BeneficiaryCreateWithoutStatusSetByInput>;
export const BeneficiaryCreateWithoutStatusSetByInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
