...
type SchemaType = z.ZodType<Prisma.EntryRecordUpdateManyWithoutMedicalCenterNestedInput>;
export const EntryRecordUpdateManyWithoutMedicalCenterNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
