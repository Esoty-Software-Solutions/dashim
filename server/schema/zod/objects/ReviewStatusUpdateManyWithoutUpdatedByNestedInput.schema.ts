...
type SchemaType = z.ZodType<Prisma.ReviewStatusUpdateManyWithoutUpdatedByNestedInput>;
export const ReviewStatusUpdateManyWithoutUpdatedByNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
