...
type SchemaType = z.ZodType<Prisma.BeneficiaryUpdateManyWithoutGenderNestedInput>;
export const BeneficiaryUpdateManyWithoutGenderNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
