...
type SchemaType = z.ZodType<Prisma.BeneficiaryCreateWithoutBeneficiaryEntityInput>;
export const BeneficiaryCreateWithoutBeneficiaryEntityInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
