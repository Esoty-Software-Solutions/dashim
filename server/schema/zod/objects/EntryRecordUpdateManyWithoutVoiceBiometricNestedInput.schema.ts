...
type SchemaType = z.ZodType<Prisma.EntryRecordUpdateManyWithoutVoiceBiometricNestedInput>;
export const EntryRecordUpdateManyWithoutVoiceBiometricNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
