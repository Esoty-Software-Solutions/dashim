...
type SchemaType = z.ZodType<Prisma.IDCardCreateNestedManyWithoutBeneficiaryInput>;
export const IDCardCreateNestedManyWithoutBeneficiaryInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
