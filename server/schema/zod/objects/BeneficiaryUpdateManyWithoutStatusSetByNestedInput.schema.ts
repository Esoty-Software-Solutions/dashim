...
type SchemaType = z.ZodType<Prisma.BeneficiaryUpdateManyWithoutStatusSetByNestedInput>;
export const BeneficiaryUpdateManyWithoutStatusSetByNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
