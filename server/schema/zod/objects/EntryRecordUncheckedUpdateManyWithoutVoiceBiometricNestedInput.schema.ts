...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedUpdateManyWithoutVoiceBiometricNestedInput>;
export const EntryRecordUncheckedUpdateManyWithoutVoiceBiometricNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => EntryRecordUpsertWithWhereUniqueWithoutVoiceBiometricInputObjectSchema),
                z.lazy(() => EntryRecordUpsertWithWhereUniqueWithoutVoiceBiometricInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => EntryRecordUpdateWithWhereUniqueWithoutVoiceBiometricInputObjectSchema),
                z.lazy(() => EntryRecordUpdateWithWhereUniqueWithoutVoiceBiometricInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => EntryRecordUpdateManyWithWhereWithoutVoiceBiometricInputObjectSchema),
                z.lazy(() => EntryRecordUpdateManyWithWhereWithoutVoiceBiometricInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
