...
type SchemaType = z.ZodType<Prisma.TenantMemberUpdateManyWithoutTenantNestedInput>;
export const TenantMemberUpdateManyWithoutTenantNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
