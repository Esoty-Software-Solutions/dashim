...
type SchemaType = z.ZodType<Prisma.FaceBiometricOrderByWithAggregationInput>;
export const FaceBiometricOrderByWithAggregationInputObjectSchema: SchemaType = z
    .object({
        ...
        _count: z.lazy(() => FaceBiometricCountOrderByAggregateInputObjectSchema).optional(),
        _max: z.lazy(() => FaceBiometricMaxOrderByAggregateInputObjectSchema).optional(),
        _min: z.lazy(() => FaceBiometricMinOrderByAggregateInputObjectSchema).optional(),
    })
