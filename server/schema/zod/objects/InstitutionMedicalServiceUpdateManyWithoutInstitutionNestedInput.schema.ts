...
type SchemaType = z.ZodType<Prisma.InstitutionMedicalServiceUpdateManyWithoutInstitutionNestedInput>;
export const InstitutionMedicalServiceUpdateManyWithoutInstitutionNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
