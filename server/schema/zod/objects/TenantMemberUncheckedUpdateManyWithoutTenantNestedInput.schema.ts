...
type SchemaType = z.ZodType<Prisma.TenantMemberUncheckedUpdateManyWithoutTenantNestedInput>;
export const TenantMemberUncheckedUpdateManyWithoutTenantNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => TenantMemberUpsertWithWhereUniqueWithoutTenantInputObjectSchema),
                z.lazy(() => TenantMemberUpsertWithWhereUniqueWithoutTenantInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => TenantMemberUpdateWithWhereUniqueWithoutTenantInputObjectSchema),
                z.lazy(() => TenantMemberUpdateWithWhereUniqueWithoutTenantInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => TenantMemberUpdateManyWithWhereWithoutTenantInputObjectSchema),
                z.lazy(() => TenantMemberUpdateManyWithWhereWithoutTenantInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
