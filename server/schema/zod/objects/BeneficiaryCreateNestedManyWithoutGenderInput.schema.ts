...
type SchemaType = z.ZodType<Prisma.BeneficiaryCreateNestedManyWithoutGenderInput>;
export const BeneficiaryCreateNestedManyWithoutGenderInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
