...
type SchemaType = z.ZodType<Prisma.VoiceBiometricUpdateManyWithoutBeneficiaryNestedInput>;
export const VoiceBiometricUpdateManyWithoutBeneficiaryNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
