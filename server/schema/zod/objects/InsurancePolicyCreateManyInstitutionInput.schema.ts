...
type SchemaType = z.ZodType<Prisma.InsurancePolicyCreateManyInstitutionInput>;
export const InsurancePolicyCreateManyInstitutionInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
