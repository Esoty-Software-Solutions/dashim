...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceCreateNestedOneWithoutReviewStatusInput>;
export const BeneficiaryServiceCreateNestedOneWithoutReviewStatusInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
