...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedCreateWithoutBeneficiaryServicesInput>;
export const EntryRecordUncheckedCreateWithoutBeneficiaryServicesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
