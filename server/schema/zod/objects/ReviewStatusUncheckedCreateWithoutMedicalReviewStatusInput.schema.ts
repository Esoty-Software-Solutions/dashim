...
type SchemaType = z.ZodType<Prisma.ReviewStatusUncheckedCreateWithoutMedicalReviewStatusInput>;
export const ReviewStatusUncheckedCreateWithoutMedicalReviewStatusInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
