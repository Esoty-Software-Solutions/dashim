...
type SchemaType = z.ZodType<Prisma.ReviewStatusEnumUncheckedCreateWithoutMedicalBeneficiaryServicesInput>;
export const ReviewStatusEnumUncheckedCreateWithoutMedicalBeneficiaryServicesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
