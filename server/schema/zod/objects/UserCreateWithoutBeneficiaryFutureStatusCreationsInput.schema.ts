...
type SchemaType = z.ZodType<Prisma.UserCreateWithoutBeneficiaryFutureStatusCreationsInput>;
export const UserCreateWithoutBeneficiaryFutureStatusCreationsInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
