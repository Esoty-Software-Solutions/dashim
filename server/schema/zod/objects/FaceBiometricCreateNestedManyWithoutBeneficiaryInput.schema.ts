...
type SchemaType = z.ZodType<Prisma.FaceBiometricCreateNestedManyWithoutBeneficiaryInput>;
export const FaceBiometricCreateNestedManyWithoutBeneficiaryInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
