...
type SchemaType = z.ZodType<Prisma.EntryRecordCreateManyFingerprintBiometricInput>;
export const EntryRecordCreateManyFingerprintBiometricInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
