...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityOrderByWithRelationInput>;
export const BeneficiaryEntityOrderByWithRelationInputObjectSchema: SchemaType = z
    .object({
        ...
        beneficiaries: z.lazy(() => BeneficiaryOrderByRelationAggregateInputObjectSchema).optional(),
        futureStatus: z
