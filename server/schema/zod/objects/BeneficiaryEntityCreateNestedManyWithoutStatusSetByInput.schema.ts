...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityCreateNestedManyWithoutStatusSetByInput>;
export const BeneficiaryEntityCreateNestedManyWithoutStatusSetByInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
