...
type SchemaType = z.ZodType<Prisma.EntryRecordCreateNestedManyWithoutUpdatedByInput>;
export const EntryRecordCreateNestedManyWithoutUpdatedByInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
