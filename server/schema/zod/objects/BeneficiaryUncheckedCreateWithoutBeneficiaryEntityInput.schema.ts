...
type SchemaType = z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutBeneficiaryEntityInput>;
export const BeneficiaryUncheckedCreateWithoutBeneficiaryEntityInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
