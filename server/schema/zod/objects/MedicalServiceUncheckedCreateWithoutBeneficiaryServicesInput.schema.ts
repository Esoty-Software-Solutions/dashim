...
type SchemaType = z.ZodType<Prisma.MedicalServiceUncheckedCreateWithoutBeneficiaryServicesInput>;
export const MedicalServiceUncheckedCreateWithoutBeneficiaryServicesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
