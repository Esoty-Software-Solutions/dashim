...
type SchemaType = z.ZodType<Prisma.InsurancePolicyUncheckedCreateWithoutBenefitPackagesInput>;
export const InsurancePolicyUncheckedCreateWithoutBenefitPackagesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
