...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceUncheckedCreateWithoutEntryRecordInput>;
export const BeneficiaryServiceUncheckedCreateWithoutEntryRecordInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
