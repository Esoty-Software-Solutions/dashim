...
type SchemaType = z.ZodType<Prisma.BeneficiaryCreateWithoutEntryRecordsInput>;
export const BeneficiaryCreateWithoutEntryRecordsInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
