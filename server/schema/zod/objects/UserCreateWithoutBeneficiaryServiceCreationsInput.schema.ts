...
type SchemaType = z.ZodType<Prisma.UserCreateWithoutBeneficiaryServiceCreationsInput>;
export const UserCreateWithoutBeneficiaryServiceCreationsInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
