...
type SchemaType = z.ZodType<Prisma.BeneficiaryBalanceUncheckedCreateNestedManyWithoutBeneficiaryInput>;
export const BeneficiaryBalanceUncheckedCreateNestedManyWithoutBeneficiaryInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
