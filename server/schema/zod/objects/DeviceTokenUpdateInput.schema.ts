...
type SchemaType = z.ZodType<Prisma.DeviceTokenUpdateInput>;
export const DeviceTokenUpdateInputObjectSchema: SchemaType = z
    .object({
        ...
        deactivationDate: z
            ...
            .optional()
            .nullable(),
        deviceName: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
        token: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
        deviceType: z.lazy(() => DeviceTypeEnumUpdateOneRequiredWithoutDeviceTokenNestedInputObjectSchema).optional(),
        user: z.lazy(() => UserUpdateOneRequiredWithoutDeviceTokenNestedInputObjectSchema).optional(),
    })
