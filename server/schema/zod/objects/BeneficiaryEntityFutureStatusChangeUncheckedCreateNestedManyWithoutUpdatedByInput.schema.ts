...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeUncheckedCreateNestedManyWithoutUpdatedByInput>;
export const BeneficiaryEntityFutureStatusChangeUncheckedCreateNestedManyWithoutUpdatedByInputObjectSchema: SchemaType =
    z
        .object({
            create: z
                .union([
