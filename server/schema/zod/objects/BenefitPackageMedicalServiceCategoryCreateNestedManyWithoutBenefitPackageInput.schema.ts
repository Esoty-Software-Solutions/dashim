...
type SchemaType = z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryCreateNestedManyWithoutBenefitPackageInput>;
export const BenefitPackageMedicalServiceCategoryCreateNestedManyWithoutBenefitPackageInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
