...
type SchemaType = z.ZodType<Prisma.ReviewStatusOrderByWithRelationInput>;
export const ReviewStatusOrderByWithRelationInputObjectSchema: SchemaType = z
    .object({
        ...
        beneficiaryService: z.lazy(() => BeneficiaryServiceOrderByWithRelationInputObjectSchema).optional(),
        transactionReviewStatus: z.lazy(() => ReviewStatusEnumOrderByWithRelationInputObjectSchema).optional(),
        medicalReviewStatus: z.lazy(() => ReviewStatusEnumOrderByWithRelationInputObjectSchema).optional(),
    })
