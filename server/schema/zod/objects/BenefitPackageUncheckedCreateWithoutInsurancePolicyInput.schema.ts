...
type SchemaType = z.ZodType<Prisma.BenefitPackageUncheckedCreateWithoutInsurancePolicyInput>;
export const BenefitPackageUncheckedCreateWithoutInsurancePolicyInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
