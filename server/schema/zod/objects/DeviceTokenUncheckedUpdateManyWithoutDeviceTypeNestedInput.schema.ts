...
type SchemaType = z.ZodType<Prisma.DeviceTokenUncheckedUpdateManyWithoutDeviceTypeNestedInput>;
export const DeviceTokenUncheckedUpdateManyWithoutDeviceTypeNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => DeviceTokenUpsertWithWhereUniqueWithoutDeviceTypeInputObjectSchema),
                z.lazy(() => DeviceTokenUpsertWithWhereUniqueWithoutDeviceTypeInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => DeviceTokenUpdateWithWhereUniqueWithoutDeviceTypeInputObjectSchema),
                z.lazy(() => DeviceTokenUpdateWithWhereUniqueWithoutDeviceTypeInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => DeviceTokenUpdateManyWithWhereWithoutDeviceTypeInputObjectSchema),
                z.lazy(() => DeviceTokenUpdateManyWithWhereWithoutDeviceTypeInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
