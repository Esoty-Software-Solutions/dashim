...
type SchemaType = z.ZodType<Prisma.InsurancePolicyMedicalCenterUncheckedUpdateManyWithoutInsurancePolicyNestedInput>;
export const InsurancePolicyMedicalCenterUncheckedUpdateManyWithoutInsurancePolicyNestedInputObjectSchema: SchemaType =
    z
        .object({
            create: z
                .union([
