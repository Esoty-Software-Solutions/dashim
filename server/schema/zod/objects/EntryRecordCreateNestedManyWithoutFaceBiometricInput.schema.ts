...
type SchemaType = z.ZodType<Prisma.EntryRecordCreateNestedManyWithoutFaceBiometricInput>;
export const EntryRecordCreateNestedManyWithoutFaceBiometricInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
