...
type SchemaType = z.ZodType<Prisma.MedicalServiceCategoryUncheckedCreateWithoutServicesInput>;
export const MedicalServiceCategoryUncheckedCreateWithoutServicesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
