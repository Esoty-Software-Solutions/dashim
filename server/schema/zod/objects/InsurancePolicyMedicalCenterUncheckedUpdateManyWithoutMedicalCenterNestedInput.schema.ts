...
type SchemaType = z.ZodType<Prisma.InsurancePolicyMedicalCenterUncheckedUpdateManyWithoutMedicalCenterNestedInput>;
export const InsurancePolicyMedicalCenterUncheckedUpdateManyWithoutMedicalCenterNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
