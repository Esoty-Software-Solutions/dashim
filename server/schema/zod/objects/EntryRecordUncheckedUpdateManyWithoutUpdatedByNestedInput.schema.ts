...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedUpdateManyWithoutUpdatedByNestedInput>;
export const EntryRecordUncheckedUpdateManyWithoutUpdatedByNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => EntryRecordUpsertWithWhereUniqueWithoutUpdatedByInputObjectSchema),
                z.lazy(() => EntryRecordUpsertWithWhereUniqueWithoutUpdatedByInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => EntryRecordUpdateWithWhereUniqueWithoutUpdatedByInputObjectSchema),
                z.lazy(() => EntryRecordUpdateWithWhereUniqueWithoutUpdatedByInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => EntryRecordUpdateManyWithWhereWithoutUpdatedByInputObjectSchema),
                z.lazy(() => EntryRecordUpdateManyWithWhereWithoutUpdatedByInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
