...
type SchemaType = z.ZodType<Prisma.EntryRecordCreateWithoutBeneficiaryServicesInput>;
export const EntryRecordCreateWithoutBeneficiaryServicesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
