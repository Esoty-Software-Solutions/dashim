...
type SchemaType = z.ZodType<Prisma.ReviewStatusCreateNestedManyWithoutMedicalReviewStatusInput>;
export const ReviewStatusCreateNestedManyWithoutMedicalReviewStatusInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
