...
type SchemaType = z.ZodType<Prisma.MedicalServiceCreateWithoutMedicalCenterInput>;
export const MedicalServiceCreateWithoutMedicalCenterInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
