...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeOrderByWithAggregationInput>;
export const BeneficiaryEntityFutureStatusChangeOrderByWithAggregationInputObjectSchema: SchemaType = z
    .object({
        ...
        _count: z.lazy(() => BeneficiaryEntityFutureStatusChangeCountOrderByAggregateInputObjectSchema).optional(),
        _max: z.lazy(() => BeneficiaryEntityFutureStatusChangeMaxOrderByAggregateInputObjectSchema).optional(),
        _min: z.lazy(() => BeneficiaryEntityFutureStatusChangeMinOrderByAggregateInputObjectSchema).optional(),
    })
