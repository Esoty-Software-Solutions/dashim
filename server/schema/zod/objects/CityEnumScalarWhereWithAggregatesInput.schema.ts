...
type SchemaType = z.ZodType<Prisma.CityEnumScalarWhereWithAggregatesInput>;
export const CityEnumScalarWhereWithAggregatesInputObjectSchema: SchemaType = z
    .object({
        AND: z
            .union([
                z.lazy(() => CityEnumScalarWhereWithAggregatesInputObjectSchema),
                z.lazy(() => CityEnumScalarWhereWithAggregatesInputObjectSchema).array(),
            ])
            .optional(),
        OR: z
        ...
        countryId: z.union([z.lazy(() => StringWithAggregatesFilterObjectSchema), z.string()]).optional(),
    })
