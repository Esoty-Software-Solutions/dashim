...
type SchemaType = z.ZodType<Prisma.MedicalServiceUncheckedUpdateWithoutInstitutionPricingInput>;
export const MedicalServiceUncheckedUpdateWithoutInstitutionPricingInputObjectSchema: SchemaType = z
    .object({
        ...
        beneficiaryServices: z
            .lazy(() => BeneficiaryServiceUncheckedUpdateManyWithoutMedicalServiceNestedInputObjectSchema)
            .optional(),
    })
