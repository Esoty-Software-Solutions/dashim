...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityUpdateManyWithoutCityNestedInput>;
export const BeneficiaryEntityUpdateManyWithoutCityNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
