...
type SchemaType = z.ZodType<Prisma.BeneficiaryCreateManyBeneficiaryEntityInput>;
export const BeneficiaryCreateManyBeneficiaryEntityInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
