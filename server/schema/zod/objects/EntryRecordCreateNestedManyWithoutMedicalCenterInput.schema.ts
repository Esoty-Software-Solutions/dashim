...
type SchemaType = z.ZodType<Prisma.EntryRecordCreateNestedManyWithoutMedicalCenterInput>;
export const EntryRecordCreateNestedManyWithoutMedicalCenterInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
