...
type SchemaType = z.ZodType<Prisma.BeneficiaryCreateNestedManyWithoutStatusSetByInput>;
export const BeneficiaryCreateNestedManyWithoutStatusSetByInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
