...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedCreateWithoutFingerprintBiometricInput>;
export const EntryRecordUncheckedCreateWithoutFingerprintBiometricInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
