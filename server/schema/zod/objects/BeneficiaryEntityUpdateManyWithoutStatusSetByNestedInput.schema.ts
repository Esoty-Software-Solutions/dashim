...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityUpdateManyWithoutStatusSetByNestedInput>;
export const BeneficiaryEntityUpdateManyWithoutStatusSetByNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
