...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceUncheckedUpdateManyWithoutUpdatedByNestedInput>;
export const BeneficiaryServiceUncheckedUpdateManyWithoutUpdatedByNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
