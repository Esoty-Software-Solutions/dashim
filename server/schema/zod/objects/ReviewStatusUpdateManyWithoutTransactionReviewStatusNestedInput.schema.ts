...
type SchemaType = z.ZodType<Prisma.ReviewStatusUpdateManyWithoutTransactionReviewStatusNestedInput>;
export const ReviewStatusUpdateManyWithoutTransactionReviewStatusNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
