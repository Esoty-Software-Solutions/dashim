...
type SchemaType = z.ZodType<Prisma.MedicalServiceUpdateManyWithoutCategoryNestedInput>;
export const MedicalServiceUpdateManyWithoutCategoryNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
