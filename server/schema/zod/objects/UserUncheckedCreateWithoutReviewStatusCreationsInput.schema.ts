...
type SchemaType = z.ZodType<Prisma.UserUncheckedCreateWithoutReviewStatusCreationsInput>;
export const UserUncheckedCreateWithoutReviewStatusCreationsInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
