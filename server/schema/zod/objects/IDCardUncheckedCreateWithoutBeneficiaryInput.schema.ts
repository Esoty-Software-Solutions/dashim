...
type SchemaType = z.ZodType<Prisma.IDCardUncheckedCreateWithoutBeneficiaryInput>;
export const IDCardUncheckedCreateWithoutBeneficiaryInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
