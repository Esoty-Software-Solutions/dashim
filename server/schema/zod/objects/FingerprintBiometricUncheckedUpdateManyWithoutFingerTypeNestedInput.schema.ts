...
type SchemaType = z.ZodType<Prisma.FingerprintBiometricUncheckedUpdateManyWithoutFingerTypeNestedInput>;
export const FingerprintBiometricUncheckedUpdateManyWithoutFingerTypeNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => FingerprintBiometricUpsertWithWhereUniqueWithoutFingerTypeInputObjectSchema),
                z.lazy(() => FingerprintBiometricUpsertWithWhereUniqueWithoutFingerTypeInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => FingerprintBiometricUpdateWithWhereUniqueWithoutFingerTypeInputObjectSchema),
                z.lazy(() => FingerprintBiometricUpdateWithWhereUniqueWithoutFingerTypeInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => FingerprintBiometricUpdateManyWithWhereWithoutFingerTypeInputObjectSchema),
                z.lazy(() => FingerprintBiometricUpdateManyWithWhereWithoutFingerTypeInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
