...
type SchemaType = z.ZodType<Prisma.FingerprintBiometricUpdateManyWithoutFingerTypeNestedInput>;
export const FingerprintBiometricUpdateManyWithoutFingerTypeNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
