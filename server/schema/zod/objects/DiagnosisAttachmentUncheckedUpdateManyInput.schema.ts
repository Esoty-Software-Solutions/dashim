...
type SchemaType = z.ZodType<Prisma.DiagnosisAttachmentUncheckedUpdateManyInput>;
export const DiagnosisAttachmentUncheckedUpdateManyInputObjectSchema: SchemaType = z
    .object({
        ...
        metadata: z.union([z.lazy(() => JsonNullValueInputSchema), jsonSchema]).optional(),
    })
