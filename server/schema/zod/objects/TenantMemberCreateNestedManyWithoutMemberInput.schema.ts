...
type SchemaType = z.ZodType<Prisma.TenantMemberCreateNestedManyWithoutMemberInput>;
export const TenantMemberCreateNestedManyWithoutMemberInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
