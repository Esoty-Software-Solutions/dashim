...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceCreateNestedManyWithoutUpdatedByInput>;
export const BeneficiaryServiceCreateNestedManyWithoutUpdatedByInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
