...
type SchemaType = z.ZodType<Prisma.ReviewStatusUncheckedCreateNestedManyWithoutUpdatedByInput>;
export const ReviewStatusUncheckedCreateNestedManyWithoutUpdatedByInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
