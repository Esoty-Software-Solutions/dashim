...
type SchemaType = z.ZodType<Prisma.MedicalServiceUpdateWithoutBeneficiaryServicesInput>;
export const MedicalServiceUpdateWithoutBeneficiaryServicesInputObjectSchema: SchemaType = z
    .object({
        ...
        institutionPricing: z
            .lazy(() => InstitutionMedicalServiceUpdateManyWithoutMedicalServiceNestedInputObjectSchema)
            .optional(),
        category: z
