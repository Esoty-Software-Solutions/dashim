...
type SchemaType = z.ZodType<Prisma.BeneficiaryFutureStatusChangeUncheckedUpdateManyWithoutUpdatedByNestedInput>;
export const BeneficiaryFutureStatusChangeUncheckedUpdateManyWithoutUpdatedByNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => BeneficiaryFutureStatusChangeUpsertWithWhereUniqueWithoutUpdatedByInputObjectSchema),
                z
                    .lazy(() => BeneficiaryFutureStatusChangeUpsertWithWhereUniqueWithoutUpdatedByInputObjectSchema)
                    .array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => BeneficiaryFutureStatusChangeUpdateWithWhereUniqueWithoutUpdatedByInputObjectSchema),
                z
                    .lazy(() => BeneficiaryFutureStatusChangeUpdateWithWhereUniqueWithoutUpdatedByInputObjectSchema)
                    .array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => BeneficiaryFutureStatusChangeUpdateManyWithWhereWithoutUpdatedByInputObjectSchema),
                z.lazy(() => BeneficiaryFutureStatusChangeUpdateManyWithWhereWithoutUpdatedByInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
