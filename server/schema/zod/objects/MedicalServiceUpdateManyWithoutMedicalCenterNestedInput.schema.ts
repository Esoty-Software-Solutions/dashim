...
type SchemaType = z.ZodType<Prisma.MedicalServiceUpdateManyWithoutMedicalCenterNestedInput>;
export const MedicalServiceUpdateManyWithoutMedicalCenterNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
