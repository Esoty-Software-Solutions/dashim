...
type SchemaType = z.ZodType<Prisma.UserCreateWithoutBeneficiaryEntityStatusChangesInput>;
export const UserCreateWithoutBeneficiaryEntityStatusChangesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
