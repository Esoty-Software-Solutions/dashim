...
type SchemaType = z.ZodType<Prisma.MedicalCenterCreateNestedManyWithoutCityInput>;
export const MedicalCenterCreateNestedManyWithoutCityInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
