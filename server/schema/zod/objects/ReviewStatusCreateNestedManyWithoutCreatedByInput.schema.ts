...
type SchemaType = z.ZodType<Prisma.ReviewStatusCreateNestedManyWithoutCreatedByInput>;
export const ReviewStatusCreateNestedManyWithoutCreatedByInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
