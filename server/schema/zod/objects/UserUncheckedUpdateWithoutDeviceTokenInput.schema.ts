...
type SchemaType = z.ZodType<Prisma.UserUncheckedUpdateWithoutDeviceTokenInput>;
export const UserUncheckedUpdateWithoutDeviceTokenInputObjectSchema: SchemaType = z
    .object({
