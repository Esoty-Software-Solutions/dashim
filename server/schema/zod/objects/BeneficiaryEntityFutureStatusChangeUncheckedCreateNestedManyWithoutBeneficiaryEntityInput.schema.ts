...
type SchemaType =
    z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeUncheckedCreateNestedManyWithoutBeneficiaryEntityInput>;
export const BeneficiaryEntityFutureStatusChangeUncheckedCreateNestedManyWithoutBeneficiaryEntityInputObjectSchema: SchemaType =
    z
        .object({
            create: z
                .union([
