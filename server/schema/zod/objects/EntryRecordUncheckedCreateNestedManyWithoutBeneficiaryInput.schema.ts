...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedCreateNestedManyWithoutBeneficiaryInput>;
export const EntryRecordUncheckedCreateNestedManyWithoutBeneficiaryInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
