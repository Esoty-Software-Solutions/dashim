...
type SchemaType = z.ZodType<Prisma.MedicalCenterUpdateManyWithoutCityNestedInput>;
export const MedicalCenterUpdateManyWithoutCityNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
