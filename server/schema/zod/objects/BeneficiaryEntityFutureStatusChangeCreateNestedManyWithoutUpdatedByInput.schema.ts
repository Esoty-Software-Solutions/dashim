...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeCreateNestedManyWithoutUpdatedByInput>;
export const BeneficiaryEntityFutureStatusChangeCreateNestedManyWithoutUpdatedByInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
