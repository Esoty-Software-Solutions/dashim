...
type SchemaType = z.ZodType<Prisma.InsurancePolicyCreateWithoutBenefitPackagesInput>;
export const InsurancePolicyCreateWithoutBenefitPackagesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
