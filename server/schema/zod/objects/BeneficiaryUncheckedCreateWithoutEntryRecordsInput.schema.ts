...
type SchemaType = z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutEntryRecordsInput>;
export const BeneficiaryUncheckedCreateWithoutEntryRecordsInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
