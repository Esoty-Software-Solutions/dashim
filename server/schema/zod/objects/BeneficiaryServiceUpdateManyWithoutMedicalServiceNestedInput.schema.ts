...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceUpdateManyWithoutMedicalServiceNestedInput>;
export const BeneficiaryServiceUpdateManyWithoutMedicalServiceNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
