...
type SchemaType = z.ZodType<Prisma.FingerprintBiometricUncheckedUpdateWithoutBeneficiaryInput>;
export const FingerprintBiometricUncheckedUpdateWithoutBeneficiaryInputObjectSchema: SchemaType = z
    .object({
        ...
        deactivationDate: z
            ...
            .optional()
            .nullable(),
        fingerTypeId: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
        record: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
        entryRecords: z
            .lazy(() => EntryRecordUncheckedUpdateManyWithoutFingerprintBiometricNestedInputObjectSchema)
            .optional(),
    })
