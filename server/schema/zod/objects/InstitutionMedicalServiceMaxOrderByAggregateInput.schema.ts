...
type SchemaType = z.ZodType<Prisma.InstitutionMedicalServiceMaxOrderByAggregateInput>;
export const InstitutionMedicalServiceMaxOrderByAggregateInputObjectSchema: SchemaType = z
    .object({
