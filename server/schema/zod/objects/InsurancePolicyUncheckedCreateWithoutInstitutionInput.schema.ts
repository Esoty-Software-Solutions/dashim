...
type SchemaType = z.ZodType<Prisma.InsurancePolicyUncheckedCreateWithoutInstitutionInput>;
export const InsurancePolicyUncheckedCreateWithoutInstitutionInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
