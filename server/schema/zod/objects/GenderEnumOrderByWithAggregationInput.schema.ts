...
type SchemaType = z.ZodType<Prisma.GenderEnumOrderByWithAggregationInput>;
export const GenderEnumOrderByWithAggregationInputObjectSchema: SchemaType = z
    .object({
        ...
        _count: z.lazy(() => GenderEnumCountOrderByAggregateInputObjectSchema).optional(),
        _max: z.lazy(() => GenderEnumMaxOrderByAggregateInputObjectSchema).optional(),
        _min: z.lazy(() => GenderEnumMinOrderByAggregateInputObjectSchema).optional(),
    })
