...
type SchemaType = z.ZodType<Prisma.UserCreateWithoutEntryRecordServiceUpdatesInput>;
export const UserCreateWithoutEntryRecordServiceUpdatesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
