...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityUncheckedCreateWithoutCityInput>;
export const BeneficiaryEntityUncheckedCreateWithoutCityInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
