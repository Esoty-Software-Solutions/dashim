...
type SchemaType = z.ZodType<Prisma.CityEnumUncheckedUpdateManyWithoutCountryNestedInput>;
export const CityEnumUncheckedUpdateManyWithoutCountryNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => CityEnumUpsertWithWhereUniqueWithoutCountryInputObjectSchema),
                z.lazy(() => CityEnumUpsertWithWhereUniqueWithoutCountryInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => CityEnumUpdateWithWhereUniqueWithoutCountryInputObjectSchema),
                z.lazy(() => CityEnumUpdateWithWhereUniqueWithoutCountryInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => CityEnumUpdateManyWithWhereWithoutCountryInputObjectSchema),
                z.lazy(() => CityEnumUpdateManyWithWhereWithoutCountryInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
