...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityUncheckedCreateNestedManyWithoutInsurancePolicyInput>;
export const BeneficiaryEntityUncheckedCreateNestedManyWithoutInsurancePolicyInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
