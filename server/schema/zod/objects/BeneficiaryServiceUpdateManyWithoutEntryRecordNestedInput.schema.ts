...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceUpdateManyWithoutEntryRecordNestedInput>;
export const BeneficiaryServiceUpdateManyWithoutEntryRecordNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
