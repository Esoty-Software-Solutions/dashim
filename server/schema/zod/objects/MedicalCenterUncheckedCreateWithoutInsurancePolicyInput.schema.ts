...
type SchemaType = z.ZodType<Prisma.MedicalCenterUncheckedCreateWithoutInsurancePolicyInput>;
export const MedicalCenterUncheckedCreateWithoutInsurancePolicyInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
        ...
        services: z.lazy(() => MedicalServiceUncheckedCreateNestedManyWithoutMedicalCenterInputObjectSchema).optional(),
        entryRecords: z
