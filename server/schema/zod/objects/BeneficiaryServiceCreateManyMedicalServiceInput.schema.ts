...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceCreateManyMedicalServiceInput>;
export const BeneficiaryServiceCreateManyMedicalServiceInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
