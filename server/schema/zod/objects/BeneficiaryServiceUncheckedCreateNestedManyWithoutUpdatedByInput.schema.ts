...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceUncheckedCreateNestedManyWithoutUpdatedByInput>;
export const BeneficiaryServiceUncheckedCreateNestedManyWithoutUpdatedByInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
