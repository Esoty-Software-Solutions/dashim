...
type SchemaType = z.ZodType<Prisma.InstitutionUpdateInput>;
export const InstitutionUpdateInputObjectSchema: SchemaType = z
    .object({
        ...
        longitude: z
            ...
            .optional()
            .nullable(),
        city: z.lazy(() => CityEnumUpdateOneRequiredWithoutInstitutionsNestedInputObjectSchema).optional(),
        policies: z.lazy(() => InsurancePolicyUpdateManyWithoutInstitutionNestedInputObjectSchema).optional(),
        MedicalCenterPricing: z
            .lazy(() => InstitutionMedicalServiceUpdateManyWithoutInstitutionNestedInputObjectSchema)
            .optional(),
    })
