...
type SchemaType = z.ZodType<Prisma.IDCardWhereUniqueInput>;
export const IDCardWhereUniqueInputObjectSchema: SchemaType = z
    .object({
        id: z.string().optional(),
        record: z.string().optional(),
        AND: z
            .union([z.lazy(() => IDCardWhereInputObjectSchema), z.lazy(() => IDCardWhereInputObjectSchema).array()])
            .optional(),
        OR: z
