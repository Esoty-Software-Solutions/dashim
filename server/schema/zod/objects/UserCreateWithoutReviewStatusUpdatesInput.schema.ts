...
type SchemaType = z.ZodType<Prisma.UserCreateWithoutReviewStatusUpdatesInput>;
export const UserCreateWithoutReviewStatusUpdatesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
