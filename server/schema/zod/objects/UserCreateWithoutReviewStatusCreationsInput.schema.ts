...
type SchemaType = z.ZodType<Prisma.UserCreateWithoutReviewStatusCreationsInput>;
export const UserCreateWithoutReviewStatusCreationsInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
