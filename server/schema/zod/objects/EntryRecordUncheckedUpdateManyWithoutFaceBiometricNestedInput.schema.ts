...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedUpdateManyWithoutFaceBiometricNestedInput>;
export const EntryRecordUncheckedUpdateManyWithoutFaceBiometricNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => EntryRecordUpsertWithWhereUniqueWithoutFaceBiometricInputObjectSchema),
                z.lazy(() => EntryRecordUpsertWithWhereUniqueWithoutFaceBiometricInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => EntryRecordUpdateWithWhereUniqueWithoutFaceBiometricInputObjectSchema),
                z.lazy(() => EntryRecordUpdateWithWhereUniqueWithoutFaceBiometricInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => EntryRecordUpdateManyWithWhereWithoutFaceBiometricInputObjectSchema),
                z.lazy(() => EntryRecordUpdateManyWithWhereWithoutFaceBiometricInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
