...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceCreateWithoutUpdatedByInput>;
export const BeneficiaryServiceCreateWithoutUpdatedByInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
