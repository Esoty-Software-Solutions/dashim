...
type SchemaType = z.ZodType<Prisma.BeneficiaryUncheckedUpdateManyWithoutRelationshipNestedInput>;
export const BeneficiaryUncheckedUpdateManyWithoutRelationshipNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => BeneficiaryUpsertWithWhereUniqueWithoutRelationshipInputObjectSchema),
                z.lazy(() => BeneficiaryUpsertWithWhereUniqueWithoutRelationshipInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => BeneficiaryUpdateWithWhereUniqueWithoutRelationshipInputObjectSchema),
                z.lazy(() => BeneficiaryUpdateWithWhereUniqueWithoutRelationshipInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => BeneficiaryUpdateManyWithWhereWithoutRelationshipInputObjectSchema),
                z.lazy(() => BeneficiaryUpdateManyWithWhereWithoutRelationshipInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
