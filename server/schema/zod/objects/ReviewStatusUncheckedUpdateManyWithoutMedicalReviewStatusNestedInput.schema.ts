...
type SchemaType = z.ZodType<Prisma.ReviewStatusUncheckedUpdateManyWithoutMedicalReviewStatusNestedInput>;
export const ReviewStatusUncheckedUpdateManyWithoutMedicalReviewStatusNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
