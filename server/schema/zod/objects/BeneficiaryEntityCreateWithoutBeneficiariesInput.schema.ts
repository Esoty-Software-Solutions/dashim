...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityCreateWithoutBeneficiariesInput>;
export const BeneficiaryEntityCreateWithoutBeneficiariesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
