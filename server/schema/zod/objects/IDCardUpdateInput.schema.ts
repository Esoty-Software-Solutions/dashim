...
type SchemaType = z.ZodType<Prisma.IDCardUpdateInput>;
export const IDCardUpdateInputObjectSchema: SchemaType = z
    .object({
        ...
        beneficiary: z.lazy(() => BeneficiaryUpdateOneRequiredWithoutIdCardNestedInputObjectSchema).optional(),
        entryRecords: z.lazy(() => EntryRecordUpdateManyWithoutIdCardBiometricNestedInputObjectSchema).optional(),
    })
