...
type SchemaType = z.ZodType<Prisma.UserUncheckedCreateWithoutBeneficiaryStatusChangesInput>;
export const UserUncheckedCreateWithoutBeneficiaryStatusChangesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
