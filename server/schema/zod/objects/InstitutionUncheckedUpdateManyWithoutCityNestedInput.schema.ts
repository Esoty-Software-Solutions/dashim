...
type SchemaType = z.ZodType<Prisma.InstitutionUncheckedUpdateManyWithoutCityNestedInput>;
export const InstitutionUncheckedUpdateManyWithoutCityNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => InstitutionUpsertWithWhereUniqueWithoutCityInputObjectSchema),
                z.lazy(() => InstitutionUpsertWithWhereUniqueWithoutCityInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => InstitutionUpdateWithWhereUniqueWithoutCityInputObjectSchema),
                z.lazy(() => InstitutionUpdateWithWhereUniqueWithoutCityInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => InstitutionUpdateManyWithWhereWithoutCityInputObjectSchema),
                z.lazy(() => InstitutionUpdateManyWithWhereWithoutCityInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
