...
type SchemaType = z.ZodType<Prisma.CityEnumUncheckedUpdateInput>;
export const CityEnumUncheckedUpdateInputObjectSchema: SchemaType = z
    .object({
        ...
        countryId: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
        institutions: z.lazy(() => InstitutionUncheckedUpdateManyWithoutCityNestedInputObjectSchema).optional(),
        medicalcenters: z.lazy(() => MedicalCenterUncheckedUpdateManyWithoutCityNestedInputObjectSchema).optional(),
        beneficiaryEntities: z
            .lazy(() => BeneficiaryEntityUncheckedUpdateManyWithoutCityNestedInputObjectSchema)
            .optional(),
    })
