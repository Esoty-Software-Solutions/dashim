...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceUncheckedCreateWithoutUpdatedByInput>;
export const BeneficiaryServiceUncheckedCreateWithoutUpdatedByInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
