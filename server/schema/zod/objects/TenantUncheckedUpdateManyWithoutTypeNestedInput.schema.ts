...
type SchemaType = z.ZodType<Prisma.TenantUncheckedUpdateManyWithoutTypeNestedInput>;
export const TenantUncheckedUpdateManyWithoutTypeNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                ...
                z.lazy(() => TenantUpsertWithWhereUniqueWithoutTypeInputObjectSchema).array(),
            ])
            .optional(),
        createMany: z.lazy(() => TenantCreateManyTypeInputEnvelopeObjectSchema).optional(),
        set: z
            .union([
        ...
        update: z
            .union([
                ...
                z.lazy(() => TenantUpdateWithWhereUniqueWithoutTypeInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => TenantUpdateManyWithWhereWithoutTypeInputObjectSchema),
                z.lazy(() => TenantUpdateManyWithWhereWithoutTypeInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
