...
type SchemaType = z.ZodType<Prisma.DeviceTokenUncheckedUpdateManyWithoutUserInput>;
export const DeviceTokenUncheckedUpdateManyWithoutUserInputObjectSchema: SchemaType = z
    .object({
        ...
        deviceTypeId: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
    })
