...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedCreateNestedManyWithoutIdCardBiometricInput>;
export const EntryRecordUncheckedCreateNestedManyWithoutIdCardBiometricInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
