...
type SchemaType = z.ZodType<Prisma.TenantUncheckedCreateWithoutAssignedToMedicalCenterInput>;
export const TenantUncheckedCreateWithoutAssignedToMedicalCenterInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
