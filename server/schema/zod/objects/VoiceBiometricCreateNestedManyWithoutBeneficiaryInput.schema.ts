...
type SchemaType = z.ZodType<Prisma.VoiceBiometricCreateNestedManyWithoutBeneficiaryInput>;
export const VoiceBiometricCreateNestedManyWithoutBeneficiaryInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
