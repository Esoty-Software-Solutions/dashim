...
type SchemaType = z.ZodType<Prisma.MedicalServiceOrderByWithAggregationInput>;
export const MedicalServiceOrderByWithAggregationInputObjectSchema: SchemaType = z
    .object({
        ...
        _count: z.lazy(() => MedicalServiceCountOrderByAggregateInputObjectSchema).optional(),
        _avg: z.lazy(() => MedicalServiceAvgOrderByAggregateInputObjectSchema).optional(),
        _max: z.lazy(() => MedicalServiceMaxOrderByAggregateInputObjectSchema).optional(),
        _min: z.lazy(() => MedicalServiceMinOrderByAggregateInputObjectSchema).optional(),
        _sum: z.lazy(() => MedicalServiceSumOrderByAggregateInputObjectSchema).optional(),
    })
