...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedCreateWithoutVoiceBiometricInput>;
export const EntryRecordUncheckedCreateWithoutVoiceBiometricInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
