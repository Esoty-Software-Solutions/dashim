...
type SchemaType = z.ZodType<Prisma.MedicalServiceUncheckedCreateNestedManyWithoutMedicalCenterInput>;
export const MedicalServiceUncheckedCreateNestedManyWithoutMedicalCenterInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
