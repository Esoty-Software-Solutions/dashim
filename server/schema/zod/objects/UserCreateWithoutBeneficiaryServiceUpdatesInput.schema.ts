...
type SchemaType = z.ZodType<Prisma.UserCreateWithoutBeneficiaryServiceUpdatesInput>;
export const UserCreateWithoutBeneficiaryServiceUpdatesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
