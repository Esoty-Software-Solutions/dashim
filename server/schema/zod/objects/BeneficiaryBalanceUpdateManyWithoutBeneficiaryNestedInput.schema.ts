...
type SchemaType = z.ZodType<Prisma.BeneficiaryBalanceUpdateManyWithoutBeneficiaryNestedInput>;
export const BeneficiaryBalanceUpdateManyWithoutBeneficiaryNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
