...
type SchemaType = z.ZodType<Prisma.ReviewStatusUncheckedUpdateManyWithoutCreatedByNestedInput>;
export const ReviewStatusUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
