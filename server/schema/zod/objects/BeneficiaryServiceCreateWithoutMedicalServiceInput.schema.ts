...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceCreateWithoutMedicalServiceInput>;
export const BeneficiaryServiceCreateWithoutMedicalServiceInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
        ...
        reviewStatus: z.lazy(() => ReviewStatusCreateNestedOneWithoutBeneficiaryServiceInputObjectSchema),
