...
type SchemaType = z.ZodType<Prisma.CityEnumWhereUniqueInput>;
export const CityEnumWhereUniqueInputObjectSchema: SchemaType = z
    .object({
        id: z.string().optional(),
        name_countryId: z.lazy(() => CityEnumNameCountryIdCompoundUniqueInputObjectSchema).optional(),
        AND: z
