...
type SchemaType = z.ZodType<Prisma.UserCreateWithoutBeneficiaryFutureStatusUpdatesInput>;
export const UserCreateWithoutBeneficiaryFutureStatusUpdatesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
