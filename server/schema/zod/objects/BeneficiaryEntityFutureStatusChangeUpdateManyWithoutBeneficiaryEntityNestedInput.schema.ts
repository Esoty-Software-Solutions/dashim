...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeUpdateManyWithoutBeneficiaryEntityNestedInput>;
export const BeneficiaryEntityFutureStatusChangeUpdateManyWithoutBeneficiaryEntityNestedInputObjectSchema: SchemaType =
    z
        .object({
            create: z
                .union([
