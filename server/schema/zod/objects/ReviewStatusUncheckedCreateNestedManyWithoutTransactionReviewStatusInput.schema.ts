...
type SchemaType = z.ZodType<Prisma.ReviewStatusUncheckedCreateNestedManyWithoutTransactionReviewStatusInput>;
export const ReviewStatusUncheckedCreateNestedManyWithoutTransactionReviewStatusInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
