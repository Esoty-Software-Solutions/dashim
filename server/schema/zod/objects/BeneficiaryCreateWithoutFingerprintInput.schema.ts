...
type SchemaType = z.ZodType<Prisma.BeneficiaryCreateWithoutFingerprintInput>;
export const BeneficiaryCreateWithoutFingerprintInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
