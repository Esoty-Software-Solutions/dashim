...
type SchemaType = z.ZodType<Prisma.InstitutionUpdateManyWithoutCityNestedInput>;
export const InstitutionUpdateManyWithoutCityNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
