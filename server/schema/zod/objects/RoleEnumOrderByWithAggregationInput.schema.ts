...
type SchemaType = z.ZodType<Prisma.RoleEnumOrderByWithAggregationInput>;
export const RoleEnumOrderByWithAggregationInputObjectSchema: SchemaType = z
    .object({
        ...
        _count: z.lazy(() => RoleEnumCountOrderByAggregateInputObjectSchema).optional(),
