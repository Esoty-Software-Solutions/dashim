...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceUpdateOneWithoutReviewStatusNestedInput>;
export const BeneficiaryServiceUpdateOneWithoutReviewStatusNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
