...
type SchemaType = z.ZodType<Prisma.EntryRecordCreateNestedManyWithoutIdCardBiometricInput>;
export const EntryRecordCreateNestedManyWithoutIdCardBiometricInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
