...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityCreateNestedManyWithoutCityInput>;
export const BeneficiaryEntityCreateNestedManyWithoutCityInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
