...
type SchemaType = z.ZodType<Prisma.TenantUncheckedUpdateManyWithoutOwnerNestedInput>;
export const TenantUncheckedUpdateManyWithoutOwnerNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
                ...
                z.lazy(() => TenantUncheckedCreateWithoutOwnerInputObjectSchema).array(),
            ])
            .optional(),
        connectOrCreate: z
            .union([
                z.lazy(() => TenantCreateOrConnectWithoutOwnerInputObjectSchema),
                z.lazy(() => TenantCreateOrConnectWithoutOwnerInputObjectSchema).array(),
            ])
            .optional(),
        upsert: z
            .union([
                z.lazy(() => TenantUpsertWithWhereUniqueWithoutOwnerInputObjectSchema),
                z.lazy(() => TenantUpsertWithWhereUniqueWithoutOwnerInputObjectSchema).array(),
            ])
            .optional(),
        createMany: z.lazy(() => TenantCreateManyOwnerInputEnvelopeObjectSchema).optional(),
        set: z
            .union([
        ...
        update: z
            .union([
                ...
                z.lazy(() => TenantUpdateWithWhereUniqueWithoutOwnerInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => TenantUpdateManyWithWhereWithoutOwnerInputObjectSchema),
                z.lazy(() => TenantUpdateManyWithWhereWithoutOwnerInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
