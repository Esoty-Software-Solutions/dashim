...
type SchemaType = z.ZodType<Prisma.MedicalServiceUncheckedUpdateManyWithoutCategoryNestedInput>;
export const MedicalServiceUncheckedUpdateManyWithoutCategoryNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => MedicalServiceUpsertWithWhereUniqueWithoutCategoryInputObjectSchema),
                z.lazy(() => MedicalServiceUpsertWithWhereUniqueWithoutCategoryInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => MedicalServiceUpdateWithWhereUniqueWithoutCategoryInputObjectSchema),
                z.lazy(() => MedicalServiceUpdateWithWhereUniqueWithoutCategoryInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => MedicalServiceUpdateManyWithWhereWithoutCategoryInputObjectSchema),
                z.lazy(() => MedicalServiceUpdateManyWithWhereWithoutCategoryInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
