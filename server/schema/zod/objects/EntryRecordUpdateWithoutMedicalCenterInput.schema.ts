...
type SchemaType = z.ZodType<Prisma.EntryRecordUpdateWithoutMedicalCenterInput>;
export const EntryRecordUpdateWithoutMedicalCenterInputObjectSchema: SchemaType = z
    .object({
