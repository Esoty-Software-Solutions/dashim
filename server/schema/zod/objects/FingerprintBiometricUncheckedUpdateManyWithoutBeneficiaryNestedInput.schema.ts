...
type SchemaType = z.ZodType<Prisma.FingerprintBiometricUncheckedUpdateManyWithoutBeneficiaryNestedInput>;
export const FingerprintBiometricUncheckedUpdateManyWithoutBeneficiaryNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => FingerprintBiometricUpsertWithWhereUniqueWithoutBeneficiaryInputObjectSchema),
                z.lazy(() => FingerprintBiometricUpsertWithWhereUniqueWithoutBeneficiaryInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => FingerprintBiometricUpdateWithWhereUniqueWithoutBeneficiaryInputObjectSchema),
                z.lazy(() => FingerprintBiometricUpdateWithWhereUniqueWithoutBeneficiaryInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => FingerprintBiometricUpdateManyWithWhereWithoutBeneficiaryInputObjectSchema),
                z.lazy(() => FingerprintBiometricUpdateManyWithWhereWithoutBeneficiaryInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
