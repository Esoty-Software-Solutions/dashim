...
type SchemaType = z.ZodType<Prisma.BeneficiaryBalanceCreateNestedManyWithoutBeneftiPackageInput>;
export const BeneficiaryBalanceCreateNestedManyWithoutBeneftiPackageInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
