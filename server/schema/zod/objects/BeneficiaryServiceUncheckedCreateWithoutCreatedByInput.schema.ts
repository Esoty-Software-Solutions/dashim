...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceUncheckedCreateWithoutCreatedByInput>;
export const BeneficiaryServiceUncheckedCreateWithoutCreatedByInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
