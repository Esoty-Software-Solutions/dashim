...
type SchemaType = z.ZodType<Prisma.UserUncheckedCreateWithoutBeneficiaryEntityStatusChangesInput>;
export const UserUncheckedCreateWithoutBeneficiaryEntityStatusChangesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
