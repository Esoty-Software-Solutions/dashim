...
type SchemaType = z.ZodType<Prisma.CityEnumUpdateManyWithoutCountryNestedInput>;
export const CityEnumUpdateManyWithoutCountryNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
