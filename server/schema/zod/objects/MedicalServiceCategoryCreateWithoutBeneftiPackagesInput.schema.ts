...
type SchemaType = z.ZodType<Prisma.MedicalServiceCategoryCreateWithoutBeneftiPackagesInput>;
export const MedicalServiceCategoryCreateWithoutBeneftiPackagesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
