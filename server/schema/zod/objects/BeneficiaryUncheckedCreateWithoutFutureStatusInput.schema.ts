...
type SchemaType = z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutFutureStatusInput>;
export const BeneficiaryUncheckedCreateWithoutFutureStatusInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
