...
type SchemaType = z.ZodType<Prisma.DeviceTokenUpdateManyWithoutDeviceTypeNestedInput>;
export const DeviceTokenUpdateManyWithoutDeviceTypeNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
