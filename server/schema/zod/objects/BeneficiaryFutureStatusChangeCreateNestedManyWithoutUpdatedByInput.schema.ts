...
type SchemaType = z.ZodType<Prisma.BeneficiaryFutureStatusChangeCreateNestedManyWithoutUpdatedByInput>;
export const BeneficiaryFutureStatusChangeCreateNestedManyWithoutUpdatedByInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
