...
type SchemaType = z.ZodType<Prisma.FaceBiometricUpdateManyWithoutBeneficiaryNestedInput>;
export const FaceBiometricUpdateManyWithoutBeneficiaryNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
