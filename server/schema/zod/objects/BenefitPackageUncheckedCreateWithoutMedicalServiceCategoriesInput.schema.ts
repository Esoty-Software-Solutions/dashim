...
type SchemaType = z.ZodType<Prisma.BenefitPackageUncheckedCreateWithoutMedicalServiceCategoriesInput>;
export const BenefitPackageUncheckedCreateWithoutMedicalServiceCategoriesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
        ...
        beneficiaryBalances: z
            .lazy(() => BeneficiaryBalanceUncheckedCreateNestedManyWithoutBeneftiPackageInputObjectSchema)
            .optional(),
    })
