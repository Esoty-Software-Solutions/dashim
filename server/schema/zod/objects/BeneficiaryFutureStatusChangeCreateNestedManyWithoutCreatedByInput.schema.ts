...
type SchemaType = z.ZodType<Prisma.BeneficiaryFutureStatusChangeCreateNestedManyWithoutCreatedByInput>;
export const BeneficiaryFutureStatusChangeCreateNestedManyWithoutCreatedByInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
