...
type SchemaType = z.ZodType<Prisma.MedicalCenterUncheckedCreateWithoutEntryRecordsInput>;
export const MedicalCenterUncheckedCreateWithoutEntryRecordsInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
