...
type SchemaType = z.ZodType<Prisma.InsurancePolicyUpdateWithoutBenefitPackagesInput>;
export const InsurancePolicyUpdateWithoutBenefitPackagesInputObjectSchema: SchemaType = z
    .object({
        ...
        beneficiaryEntities: z
            .lazy(() => BeneficiaryEntityUpdateManyWithoutInsurancePolicyNestedInputObjectSchema)
            .optional(),
        medicalCenters: z
