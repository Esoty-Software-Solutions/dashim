...
type SchemaType = z.ZodType<Prisma.BeneficiaryFutureStatusChangeUncheckedCreateInput>;
export const BeneficiaryFutureStatusChangeUncheckedCreateInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
