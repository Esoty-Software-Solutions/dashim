...
type SchemaType =
    z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryCreateNestedManyWithoutMedicalServiceCategoryInput>;
export const BenefitPackageMedicalServiceCategoryCreateNestedManyWithoutMedicalServiceCategoryInputObjectSchema: SchemaType =
    z
        .object({
            create: z
                .union([
