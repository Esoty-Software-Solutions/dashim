...
type SchemaType = z.ZodType<Prisma.InsurancePolicyCreateWithoutMedicalCentersInput>;
export const InsurancePolicyCreateWithoutMedicalCentersInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
