...
type SchemaType = z.ZodType<Prisma.MedicalServiceCreateNestedManyWithoutCategoryInput>;
export const MedicalServiceCreateNestedManyWithoutCategoryInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
