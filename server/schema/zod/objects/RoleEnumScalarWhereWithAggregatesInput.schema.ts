...
type SchemaType = z.ZodType<Prisma.RoleEnumScalarWhereWithAggregatesInput>;
export const RoleEnumScalarWhereWithAggregatesInputObjectSchema: SchemaType = z
    .object({
        AND: z
            .union([
                z.lazy(() => RoleEnumScalarWhereWithAggregatesInputObjectSchema),
                z.lazy(() => RoleEnumScalarWhereWithAggregatesInputObjectSchema).array(),
            ])
            .optional(),
        OR: z
