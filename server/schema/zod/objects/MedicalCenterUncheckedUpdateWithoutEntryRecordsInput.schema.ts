...
type SchemaType = z.ZodType<Prisma.MedicalCenterUncheckedUpdateWithoutEntryRecordsInput>;
export const MedicalCenterUncheckedUpdateWithoutEntryRecordsInputObjectSchema: SchemaType = z
    .object({
