...
type SchemaType = z.ZodType<Prisma.TenantUncheckedCreateNestedManyWithoutTypeInput>;
export const TenantUncheckedCreateNestedManyWithoutTypeInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
