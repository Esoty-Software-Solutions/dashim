...
type SchemaType = z.ZodType<Prisma.UserCreateWithoutEntryRecordServiceCreationsInput>;
export const UserCreateWithoutEntryRecordServiceCreationsInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
