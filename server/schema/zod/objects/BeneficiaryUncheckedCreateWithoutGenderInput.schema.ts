...
type SchemaType = z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutGenderInput>;
export const BeneficiaryUncheckedCreateWithoutGenderInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
