...
type SchemaType = z.ZodType<Prisma.BeneficiaryUncheckedUpdateManyWithoutGenderNestedInput>;
export const BeneficiaryUncheckedUpdateManyWithoutGenderNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
                ...
                z.lazy(() => BeneficiaryUncheckedCreateWithoutGenderInputObjectSchema).array(),
            ])
            .optional(),
        connectOrCreate: z
            .union([
                z.lazy(() => BeneficiaryCreateOrConnectWithoutGenderInputObjectSchema),
                z.lazy(() => BeneficiaryCreateOrConnectWithoutGenderInputObjectSchema).array(),
            ])
            .optional(),
        upsert: z
            .union([
                z.lazy(() => BeneficiaryUpsertWithWhereUniqueWithoutGenderInputObjectSchema),
                z.lazy(() => BeneficiaryUpsertWithWhereUniqueWithoutGenderInputObjectSchema).array(),
            ])
            .optional(),
        createMany: z.lazy(() => BeneficiaryCreateManyGenderInputEnvelopeObjectSchema).optional(),
        set: z
            .union([
        ...
        update: z
            .union([
                z.lazy(() => BeneficiaryUpdateWithWhereUniqueWithoutGenderInputObjectSchema),
                z.lazy(() => BeneficiaryUpdateWithWhereUniqueWithoutGenderInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => BeneficiaryUpdateManyWithWhereWithoutGenderInputObjectSchema),
                z.lazy(() => BeneficiaryUpdateManyWithWhereWithoutGenderInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
