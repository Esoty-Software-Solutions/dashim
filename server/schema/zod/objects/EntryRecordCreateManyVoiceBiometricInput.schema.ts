...
type SchemaType = z.ZodType<Prisma.EntryRecordCreateManyVoiceBiometricInput>;
export const EntryRecordCreateManyVoiceBiometricInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
