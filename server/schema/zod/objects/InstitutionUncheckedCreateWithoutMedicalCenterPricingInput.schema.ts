...
type SchemaType = z.ZodType<Prisma.InstitutionUncheckedCreateWithoutMedicalCenterPricingInput>;
export const InstitutionUncheckedCreateWithoutMedicalCenterPricingInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
        ...
        policies: z.lazy(() => InsurancePolicyUncheckedCreateNestedManyWithoutInstitutionInputObjectSchema).optional(),
    })
