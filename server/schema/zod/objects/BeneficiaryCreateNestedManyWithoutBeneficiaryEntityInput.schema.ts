...
type SchemaType = z.ZodType<Prisma.BeneficiaryCreateNestedManyWithoutBeneficiaryEntityInput>;
export const BeneficiaryCreateNestedManyWithoutBeneficiaryEntityInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
