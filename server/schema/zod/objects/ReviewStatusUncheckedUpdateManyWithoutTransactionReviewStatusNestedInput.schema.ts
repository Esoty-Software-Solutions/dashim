...
type SchemaType = z.ZodType<Prisma.ReviewStatusUncheckedUpdateManyWithoutTransactionReviewStatusNestedInput>;
export const ReviewStatusUncheckedUpdateManyWithoutTransactionReviewStatusNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => ReviewStatusUpsertWithWhereUniqueWithoutTransactionReviewStatusInputObjectSchema),
                z.lazy(() => ReviewStatusUpsertWithWhereUniqueWithoutTransactionReviewStatusInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => ReviewStatusUpdateWithWhereUniqueWithoutTransactionReviewStatusInputObjectSchema),
                z.lazy(() => ReviewStatusUpdateWithWhereUniqueWithoutTransactionReviewStatusInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => ReviewStatusUpdateManyWithWhereWithoutTransactionReviewStatusInputObjectSchema),
                z.lazy(() => ReviewStatusUpdateManyWithWhereWithoutTransactionReviewStatusInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
