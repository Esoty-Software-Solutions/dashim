...
type SchemaType = z.ZodType<Prisma.BeneficiaryCreateNestedManyWithoutRelationshipInput>;
export const BeneficiaryCreateNestedManyWithoutRelationshipInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
