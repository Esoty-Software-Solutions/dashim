...
type SchemaType = z.ZodType<Prisma.BeneficiaryBalanceOrderByWithAggregationInput>;
export const BeneficiaryBalanceOrderByWithAggregationInputObjectSchema: SchemaType = z
    .object({
        ...
        _count: z.lazy(() => BeneficiaryBalanceCountOrderByAggregateInputObjectSchema).optional(),
        _avg: z.lazy(() => BeneficiaryBalanceAvgOrderByAggregateInputObjectSchema).optional(),
        _max: z.lazy(() => BeneficiaryBalanceMaxOrderByAggregateInputObjectSchema).optional(),
        _min: z.lazy(() => BeneficiaryBalanceMinOrderByAggregateInputObjectSchema).optional(),
        _sum: z.lazy(() => BeneficiaryBalanceSumOrderByAggregateInputObjectSchema).optional(),
    })
