...
type SchemaType = z.ZodType<Prisma.InsurancePolicyMedicalCenterUncheckedCreateNestedManyWithoutInsurancePolicyInput>;
export const InsurancePolicyMedicalCenterUncheckedCreateNestedManyWithoutInsurancePolicyInputObjectSchema: SchemaType =
    z
        .object({
            create: z
                .union([
