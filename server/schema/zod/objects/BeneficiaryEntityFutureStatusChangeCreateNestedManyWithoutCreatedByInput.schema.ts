...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeCreateNestedManyWithoutCreatedByInput>;
export const BeneficiaryEntityFutureStatusChangeCreateNestedManyWithoutCreatedByInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
