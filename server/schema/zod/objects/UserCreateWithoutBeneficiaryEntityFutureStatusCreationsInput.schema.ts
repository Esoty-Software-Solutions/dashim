...
type SchemaType = z.ZodType<Prisma.UserCreateWithoutBeneficiaryEntityFutureStatusCreationsInput>;
export const UserCreateWithoutBeneficiaryEntityFutureStatusCreationsInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
