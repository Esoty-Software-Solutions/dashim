...
type SchemaType = z.ZodType<Prisma.IDCardOrderByWithAggregationInput>;
export const IDCardOrderByWithAggregationInputObjectSchema: SchemaType = z
    .object({
        ...
        _count: z.lazy(() => IDCardCountOrderByAggregateInputObjectSchema).optional(),
