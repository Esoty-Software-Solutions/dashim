...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityUncheckedCreateWithoutStatusSetByInput>;
export const BeneficiaryEntityUncheckedCreateWithoutStatusSetByInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
