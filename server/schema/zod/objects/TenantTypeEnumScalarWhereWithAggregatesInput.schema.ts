...
type SchemaType = z.ZodType<Prisma.TenantTypeEnumScalarWhereWithAggregatesInput>;
export const TenantTypeEnumScalarWhereWithAggregatesInputObjectSchema: SchemaType = z
    .object({
        AND: z
            .union([
                z.lazy(() => TenantTypeEnumScalarWhereWithAggregatesInputObjectSchema),
                z.lazy(() => TenantTypeEnumScalarWhereWithAggregatesInputObjectSchema).array(),
            ])
            .optional(),
        OR: z
