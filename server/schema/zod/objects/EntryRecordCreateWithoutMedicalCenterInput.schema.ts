...
type SchemaType = z.ZodType<Prisma.EntryRecordCreateWithoutMedicalCenterInput>;
export const EntryRecordCreateWithoutMedicalCenterInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
