...
type SchemaType = z.ZodType<Prisma.BeneficiaryCreateWithoutBeneficiaryBalancesInput>;
export const BeneficiaryCreateWithoutBeneficiaryBalancesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
