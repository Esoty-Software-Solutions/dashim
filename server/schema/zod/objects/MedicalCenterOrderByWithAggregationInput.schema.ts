...
type SchemaType = z.ZodType<Prisma.MedicalCenterOrderByWithAggregationInput>;
export const MedicalCenterOrderByWithAggregationInputObjectSchema: SchemaType = z
    .object({
        ...
        _count: z.lazy(() => MedicalCenterCountOrderByAggregateInputObjectSchema).optional(),
        _avg: z.lazy(() => MedicalCenterAvgOrderByAggregateInputObjectSchema).optional(),
        _max: z.lazy(() => MedicalCenterMaxOrderByAggregateInputObjectSchema).optional(),
        _min: z.lazy(() => MedicalCenterMinOrderByAggregateInputObjectSchema).optional(),
        _sum: z.lazy(() => MedicalCenterSumOrderByAggregateInputObjectSchema).optional(),
    })
