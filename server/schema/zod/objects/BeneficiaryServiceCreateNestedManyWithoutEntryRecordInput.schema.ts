...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceCreateNestedManyWithoutEntryRecordInput>;
export const BeneficiaryServiceCreateNestedManyWithoutEntryRecordInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
