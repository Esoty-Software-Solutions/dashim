...
type SchemaType = z.ZodType<Prisma.DeviceTokenOrderByWithAggregationInput>;
export const DeviceTokenOrderByWithAggregationInputObjectSchema: SchemaType = z
    .object({
        ...
        _count: z.lazy(() => DeviceTokenCountOrderByAggregateInputObjectSchema).optional(),
        _max: z.lazy(() => DeviceTokenMaxOrderByAggregateInputObjectSchema).optional(),
        _min: z.lazy(() => DeviceTokenMinOrderByAggregateInputObjectSchema).optional(),
    })
