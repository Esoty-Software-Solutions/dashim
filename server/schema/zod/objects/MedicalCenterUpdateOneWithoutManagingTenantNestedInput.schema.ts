...
type SchemaType = z.ZodType<Prisma.MedicalCenterUpdateOneWithoutManagingTenantNestedInput>;
export const MedicalCenterUpdateOneWithoutManagingTenantNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
