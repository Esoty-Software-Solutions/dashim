...
type SchemaType = z.ZodType<Prisma.FingerprintBiometricUncheckedCreateNestedManyWithoutBeneficiaryInput>;
export const FingerprintBiometricUncheckedCreateNestedManyWithoutBeneficiaryInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
