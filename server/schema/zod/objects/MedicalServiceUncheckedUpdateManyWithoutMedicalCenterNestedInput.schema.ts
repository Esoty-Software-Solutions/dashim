...
type SchemaType = z.ZodType<Prisma.MedicalServiceUncheckedUpdateManyWithoutMedicalCenterNestedInput>;
export const MedicalServiceUncheckedUpdateManyWithoutMedicalCenterNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => MedicalServiceUpsertWithWhereUniqueWithoutMedicalCenterInputObjectSchema),
                z.lazy(() => MedicalServiceUpsertWithWhereUniqueWithoutMedicalCenterInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => MedicalServiceUpdateWithWhereUniqueWithoutMedicalCenterInputObjectSchema),
                z.lazy(() => MedicalServiceUpdateWithWhereUniqueWithoutMedicalCenterInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => MedicalServiceUpdateManyWithWhereWithoutMedicalCenterInputObjectSchema),
                z.lazy(() => MedicalServiceUpdateManyWithWhereWithoutMedicalCenterInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
