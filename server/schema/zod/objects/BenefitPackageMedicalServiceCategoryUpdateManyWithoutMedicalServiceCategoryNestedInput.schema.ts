...
type SchemaType =
    z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryUpdateManyWithoutMedicalServiceCategoryNestedInput>;
export const BenefitPackageMedicalServiceCategoryUpdateManyWithoutMedicalServiceCategoryNestedInputObjectSchema: SchemaType =
    z
        .object({
            create: z
                .union([
