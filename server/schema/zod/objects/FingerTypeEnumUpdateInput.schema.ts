...
type SchemaType = z.ZodType<Prisma.FingerTypeEnumUpdateInput>;
export const FingerTypeEnumUpdateInputObjectSchema: SchemaType = z
    .object({
        ...
        fingerType: z.lazy(() => FingerprintBiometricUpdateManyWithoutFingerTypeNestedInputObjectSchema).optional(),
    })
