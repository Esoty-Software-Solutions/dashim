...
type SchemaType = z.ZodType<Prisma.InstitutionScalarWhereInput>;
export const InstitutionScalarWhereInputObjectSchema: SchemaType = z
    .object({
        AND: z
            .union([
            ...
            .optional(),
        OR: z
            .lazy(() => InstitutionScalarWhereInputObjectSchema)
            .array()
            .optional(),
        NOT: z
            .union([
