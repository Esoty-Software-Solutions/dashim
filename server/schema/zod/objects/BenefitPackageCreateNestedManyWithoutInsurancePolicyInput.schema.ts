...
type SchemaType = z.ZodType<Prisma.BenefitPackageCreateNestedManyWithoutInsurancePolicyInput>;
export const BenefitPackageCreateNestedManyWithoutInsurancePolicyInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
