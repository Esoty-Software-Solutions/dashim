...
type SchemaType = z.ZodType<Prisma.UserUncheckedCreateWithoutBeneficiaryFutureStatusCreationsInput>;
export const UserUncheckedCreateWithoutBeneficiaryFutureStatusCreationsInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
