...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityUncheckedCreateWithoutBeneficiariesInput>;
export const BeneficiaryEntityUncheckedCreateWithoutBeneficiariesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
