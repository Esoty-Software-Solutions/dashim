...
type SchemaType = z.ZodType<Prisma.UserUncheckedCreateWithoutBeneficiaryEntityFutureStatusUpdatesInput>;
export const UserUncheckedCreateWithoutBeneficiaryEntityFutureStatusUpdatesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
