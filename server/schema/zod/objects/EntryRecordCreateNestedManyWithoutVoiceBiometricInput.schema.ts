...
type SchemaType = z.ZodType<Prisma.EntryRecordCreateNestedManyWithoutVoiceBiometricInput>;
export const EntryRecordCreateNestedManyWithoutVoiceBiometricInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
