...
type SchemaType = z.ZodType<Prisma.IDCardUncheckedUpdateManyWithoutBeneficiaryNestedInput>;
export const IDCardUncheckedUpdateManyWithoutBeneficiaryNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => IDCardUpsertWithWhereUniqueWithoutBeneficiaryInputObjectSchema),
                z.lazy(() => IDCardUpsertWithWhereUniqueWithoutBeneficiaryInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => IDCardUpdateWithWhereUniqueWithoutBeneficiaryInputObjectSchema),
                z.lazy(() => IDCardUpdateWithWhereUniqueWithoutBeneficiaryInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => IDCardUpdateManyWithWhereWithoutBeneficiaryInputObjectSchema),
                z.lazy(() => IDCardUpdateManyWithWhereWithoutBeneficiaryInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
