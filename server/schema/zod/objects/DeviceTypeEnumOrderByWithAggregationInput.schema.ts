...
type SchemaType = z.ZodType<Prisma.DeviceTypeEnumOrderByWithAggregationInput>;
export const DeviceTypeEnumOrderByWithAggregationInputObjectSchema: SchemaType = z
    .object({
        ...
        _count: z.lazy(() => DeviceTypeEnumCountOrderByAggregateInputObjectSchema).optional(),
        _max: z.lazy(() => DeviceTypeEnumMaxOrderByAggregateInputObjectSchema).optional(),
        _min: z.lazy(() => DeviceTypeEnumMinOrderByAggregateInputObjectSchema).optional(),
    })
