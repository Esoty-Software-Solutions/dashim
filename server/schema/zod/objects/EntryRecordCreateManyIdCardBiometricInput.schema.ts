...
type SchemaType = z.ZodType<Prisma.EntryRecordCreateManyIdCardBiometricInput>;
export const EntryRecordCreateManyIdCardBiometricInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
