...
type SchemaType = z.ZodType<Prisma.CityEnumCreateNestedManyWithoutCountryInput>;
export const CityEnumCreateNestedManyWithoutCountryInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
