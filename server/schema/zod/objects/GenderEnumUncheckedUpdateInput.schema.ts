...
type SchemaType = z.ZodType<Prisma.GenderEnumUncheckedUpdateInput>;
export const GenderEnumUncheckedUpdateInputObjectSchema: SchemaType = z
    .object({
        ...
        user: z.lazy(() => UserUncheckedUpdateManyWithoutGenderNestedInputObjectSchema).optional(),
        beneficiary: z.lazy(() => BeneficiaryUncheckedUpdateManyWithoutGenderNestedInputObjectSchema).optional(),
    })
