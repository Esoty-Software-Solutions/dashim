...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityUncheckedCreateWithoutInsurancePolicyInput>;
export const BeneficiaryEntityUncheckedCreateWithoutInsurancePolicyInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
