...
type SchemaType = z.ZodType<Prisma.InsurancePolicyUpdateManyWithoutInstitutionNestedInput>;
export const InsurancePolicyUpdateManyWithoutInstitutionNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
