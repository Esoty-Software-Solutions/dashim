...
type SchemaType = z.ZodType<Prisma.BeneficiaryBalanceUncheckedUpdateManyWithoutBeneftiPackageNestedInput>;
export const BeneficiaryBalanceUncheckedUpdateManyWithoutBeneftiPackageNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => BeneficiaryBalanceUpsertWithWhereUniqueWithoutBeneftiPackageInputObjectSchema),
                z.lazy(() => BeneficiaryBalanceUpsertWithWhereUniqueWithoutBeneftiPackageInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => BeneficiaryBalanceUpdateWithWhereUniqueWithoutBeneftiPackageInputObjectSchema),
                z.lazy(() => BeneficiaryBalanceUpdateWithWhereUniqueWithoutBeneftiPackageInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => BeneficiaryBalanceUpdateManyWithWhereWithoutBeneftiPackageInputObjectSchema),
                z.lazy(() => BeneficiaryBalanceUpdateManyWithWhereWithoutBeneftiPackageInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
