...
type SchemaType = z.ZodType<Prisma.InstitutionMedicalServiceUncheckedUpdateManyWithoutMedicalServiceNestedInput>;
export const InstitutionMedicalServiceUncheckedUpdateManyWithoutMedicalServiceNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
