...
type SchemaType = z.ZodType<Prisma.InsurancePolicyCreateWithoutInstitutionInput>;
export const InsurancePolicyCreateWithoutInstitutionInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
