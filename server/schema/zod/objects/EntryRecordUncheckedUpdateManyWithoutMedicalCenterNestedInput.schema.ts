...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedUpdateManyWithoutMedicalCenterNestedInput>;
export const EntryRecordUncheckedUpdateManyWithoutMedicalCenterNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => EntryRecordUpsertWithWhereUniqueWithoutMedicalCenterInputObjectSchema),
                z.lazy(() => EntryRecordUpsertWithWhereUniqueWithoutMedicalCenterInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => EntryRecordUpdateWithWhereUniqueWithoutMedicalCenterInputObjectSchema),
                z.lazy(() => EntryRecordUpdateWithWhereUniqueWithoutMedicalCenterInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => EntryRecordUpdateManyWithWhereWithoutMedicalCenterInputObjectSchema),
                z.lazy(() => EntryRecordUpdateManyWithWhereWithoutMedicalCenterInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
