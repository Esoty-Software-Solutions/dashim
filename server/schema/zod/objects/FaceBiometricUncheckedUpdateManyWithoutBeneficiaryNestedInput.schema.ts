...
type SchemaType = z.ZodType<Prisma.FaceBiometricUncheckedUpdateManyWithoutBeneficiaryNestedInput>;
export const FaceBiometricUncheckedUpdateManyWithoutBeneficiaryNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => FaceBiometricUpsertWithWhereUniqueWithoutBeneficiaryInputObjectSchema),
                z.lazy(() => FaceBiometricUpsertWithWhereUniqueWithoutBeneficiaryInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => FaceBiometricUpdateWithWhereUniqueWithoutBeneficiaryInputObjectSchema),
                z.lazy(() => FaceBiometricUpdateWithWhereUniqueWithoutBeneficiaryInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => FaceBiometricUpdateManyWithWhereWithoutBeneficiaryInputObjectSchema),
                z.lazy(() => FaceBiometricUpdateManyWithWhereWithoutBeneficiaryInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
