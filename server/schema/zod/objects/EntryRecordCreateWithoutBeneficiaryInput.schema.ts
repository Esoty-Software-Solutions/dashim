...
type SchemaType = z.ZodType<Prisma.EntryRecordCreateWithoutBeneficiaryInput>;
export const EntryRecordCreateWithoutBeneficiaryInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
