...
type SchemaType = z.ZodType<Prisma.UserUncheckedCreateWithoutDeviceTokenInput>;
export const UserUncheckedCreateWithoutDeviceTokenInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
