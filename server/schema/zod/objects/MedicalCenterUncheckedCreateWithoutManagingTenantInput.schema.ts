...
type SchemaType = z.ZodType<Prisma.MedicalCenterUncheckedCreateWithoutManagingTenantInput>;
export const MedicalCenterUncheckedCreateWithoutManagingTenantInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
