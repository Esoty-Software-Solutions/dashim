...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceUncheckedUpdateManyWithoutMedicalServiceNestedInput>;
export const BeneficiaryServiceUncheckedUpdateManyWithoutMedicalServiceNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => BeneficiaryServiceUpsertWithWhereUniqueWithoutMedicalServiceInputObjectSchema),
                z.lazy(() => BeneficiaryServiceUpsertWithWhereUniqueWithoutMedicalServiceInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => BeneficiaryServiceUpdateWithWhereUniqueWithoutMedicalServiceInputObjectSchema),
                z.lazy(() => BeneficiaryServiceUpdateWithWhereUniqueWithoutMedicalServiceInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => BeneficiaryServiceUpdateManyWithWhereWithoutMedicalServiceInputObjectSchema),
                z.lazy(() => BeneficiaryServiceUpdateManyWithWhereWithoutMedicalServiceInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
