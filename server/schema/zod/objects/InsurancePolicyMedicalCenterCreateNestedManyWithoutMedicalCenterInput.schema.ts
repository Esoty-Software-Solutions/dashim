...
type SchemaType = z.ZodType<Prisma.InsurancePolicyMedicalCenterCreateNestedManyWithoutMedicalCenterInput>;
export const InsurancePolicyMedicalCenterCreateNestedManyWithoutMedicalCenterInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
