...
type SchemaType = z.ZodType<Prisma.MedicalServiceUncheckedCreateWithoutMedicalCenterInput>;
export const MedicalServiceUncheckedCreateWithoutMedicalCenterInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
