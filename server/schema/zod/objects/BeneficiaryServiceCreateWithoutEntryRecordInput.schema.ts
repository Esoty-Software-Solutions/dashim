...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceCreateWithoutEntryRecordInput>;
export const BeneficiaryServiceCreateWithoutEntryRecordInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
