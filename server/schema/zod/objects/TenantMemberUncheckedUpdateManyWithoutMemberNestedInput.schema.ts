...
type SchemaType = z.ZodType<Prisma.TenantMemberUncheckedUpdateManyWithoutMemberNestedInput>;
export const TenantMemberUncheckedUpdateManyWithoutMemberNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
