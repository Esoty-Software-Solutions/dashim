...
type SchemaType = z.ZodType<Prisma.EntryRecordCreateWithoutIdCardBiometricInput>;
export const EntryRecordCreateWithoutIdCardBiometricInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
