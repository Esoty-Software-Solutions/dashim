...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedUpdateManyWithoutIdCardBiometricNestedInput>;
export const EntryRecordUncheckedUpdateManyWithoutIdCardBiometricNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
                z.lazy(() => EntryRecordCreateWithoutIdCardBiometricInputObjectSchema),
                z.lazy(() => EntryRecordCreateWithoutIdCardBiometricInputObjectSchema).array(),
                z.lazy(() => EntryRecordUncheckedCreateWithoutIdCardBiometricInputObjectSchema),
                z.lazy(() => EntryRecordUncheckedCreateWithoutIdCardBiometricInputObjectSchema).array(),
            ])
            .optional(),
        connectOrCreate: z
            .union([
                z.lazy(() => EntryRecordCreateOrConnectWithoutIdCardBiometricInputObjectSchema),
                z.lazy(() => EntryRecordCreateOrConnectWithoutIdCardBiometricInputObjectSchema).array(),
            ])
            .optional(),
        upsert: z
            .union([
                z.lazy(() => EntryRecordUpsertWithWhereUniqueWithoutIdCardBiometricInputObjectSchema),
                z.lazy(() => EntryRecordUpsertWithWhereUniqueWithoutIdCardBiometricInputObjectSchema).array(),
            ])
            .optional(),
        createMany: z.lazy(() => EntryRecordCreateManyIdCardBiometricInputEnvelopeObjectSchema).optional(),
        set: z
            .union([
        ...
        update: z
            .union([
                z.lazy(() => EntryRecordUpdateWithWhereUniqueWithoutIdCardBiometricInputObjectSchema),
                z.lazy(() => EntryRecordUpdateWithWhereUniqueWithoutIdCardBiometricInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => EntryRecordUpdateManyWithWhereWithoutIdCardBiometricInputObjectSchema),
                z.lazy(() => EntryRecordUpdateManyWithWhereWithoutIdCardBiometricInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
