...
type SchemaType = z.ZodType<Prisma.InsurancePolicyMedicalCenterUpdateManyWithoutInsurancePolicyNestedInput>;
export const InsurancePolicyMedicalCenterUpdateManyWithoutInsurancePolicyNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => InsurancePolicyMedicalCenterUpsertWithWhereUniqueWithoutInsurancePolicyInputObjectSchema),
                z
                    .lazy(
        ...
        update: z
            .union([
                z.lazy(() => InsurancePolicyMedicalCenterUpdateWithWhereUniqueWithoutInsurancePolicyInputObjectSchema),
                z
                    .lazy(
        ...
        updateMany: z
            .union([
                z.lazy(() => InsurancePolicyMedicalCenterUpdateManyWithWhereWithoutInsurancePolicyInputObjectSchema),
                z
                    .lazy(() => InsurancePolicyMedicalCenterUpdateManyWithWhereWithoutInsurancePolicyInputObjectSchema)
                    .array(),
            ])
            .optional(),
        deleteMany: z
