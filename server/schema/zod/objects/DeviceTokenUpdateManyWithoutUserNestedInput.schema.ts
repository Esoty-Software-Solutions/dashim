...
type SchemaType = z.ZodType<Prisma.DeviceTokenUpdateManyWithoutUserNestedInput>;
export const DeviceTokenUpdateManyWithoutUserNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
