...
type SchemaType = z.ZodType<Prisma.TenantUncheckedCreateWithoutOwnerInput>;
export const TenantUncheckedCreateWithoutOwnerInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
        ...
        assignedToMedicalCenter: z
            .lazy(() => MedicalCenterUncheckedCreateNestedOneWithoutManagingTenantInputObjectSchema)
            .optional(),
        members: z.lazy(() => TenantMemberUncheckedCreateNestedManyWithoutTenantInputObjectSchema).optional(),
    })
