...
type SchemaType = z.ZodType<Prisma.InstitutionMedicalServiceUncheckedCreateNestedManyWithoutInstitutionInput>;
export const InstitutionMedicalServiceUncheckedCreateNestedManyWithoutInstitutionInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
