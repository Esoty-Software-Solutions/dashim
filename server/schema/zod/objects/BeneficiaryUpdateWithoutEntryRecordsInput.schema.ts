...
type SchemaType = z.ZodType<Prisma.BeneficiaryUpdateWithoutEntryRecordsInput>;
export const BeneficiaryUpdateWithoutEntryRecordsInputObjectSchema: SchemaType = z
    .object({
