...
type SchemaType = z.ZodType<Prisma.InstitutionMedicalServiceUncheckedCreateNestedManyWithoutMedicalServiceInput>;
export const InstitutionMedicalServiceUncheckedCreateNestedManyWithoutMedicalServiceInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
