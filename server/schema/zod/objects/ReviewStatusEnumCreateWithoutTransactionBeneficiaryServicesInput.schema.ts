...
type SchemaType = z.ZodType<Prisma.ReviewStatusEnumCreateWithoutTransactionBeneficiaryServicesInput>;
export const ReviewStatusEnumCreateWithoutTransactionBeneficiaryServicesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
