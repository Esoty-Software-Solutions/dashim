...
type SchemaType = z.ZodType<Prisma.InstitutionMedicalServiceOrderByWithAggregationInput>;
export const InstitutionMedicalServiceOrderByWithAggregationInputObjectSchema: SchemaType = z
    .object({
        ...
        _count: z.lazy(() => InstitutionMedicalServiceCountOrderByAggregateInputObjectSchema).optional(),
        _avg: z.lazy(() => InstitutionMedicalServiceAvgOrderByAggregateInputObjectSchema).optional(),
        _max: z.lazy(() => InstitutionMedicalServiceMaxOrderByAggregateInputObjectSchema).optional(),
        _min: z.lazy(() => InstitutionMedicalServiceMinOrderByAggregateInputObjectSchema).optional(),
        _sum: z.lazy(() => InstitutionMedicalServiceSumOrderByAggregateInputObjectSchema).optional(),
    })
