...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedCreateWithoutCreatedByInput>;
export const EntryRecordUncheckedCreateWithoutCreatedByInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
