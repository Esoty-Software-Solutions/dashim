...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeUncheckedUpdateManyWithoutUpdatedByNestedInput>;
export const BeneficiaryEntityFutureStatusChangeUncheckedUpdateManyWithoutUpdatedByNestedInputObjectSchema: SchemaType =
    z
        .object({
            create: z
                .union([
            ...
            updateMany: z
                .union([
                    z.lazy(
                        () => BeneficiaryEntityFutureStatusChangeUpdateManyWithWhereWithoutUpdatedByInputObjectSchema,
                    ),
                    z
                        .lazy(
                            () =>
