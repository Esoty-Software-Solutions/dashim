...
type SchemaType = z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutRelationshipInput>;
export const BeneficiaryUncheckedCreateWithoutRelationshipInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
