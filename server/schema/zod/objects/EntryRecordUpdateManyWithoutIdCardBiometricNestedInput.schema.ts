...
type SchemaType = z.ZodType<Prisma.EntryRecordUpdateManyWithoutIdCardBiometricNestedInput>;
export const EntryRecordUpdateManyWithoutIdCardBiometricNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
