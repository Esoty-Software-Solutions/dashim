...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedCreateWithoutFaceBiometricInput>;
export const EntryRecordUncheckedCreateWithoutFaceBiometricInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
