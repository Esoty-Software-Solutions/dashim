...
type SchemaType = z.ZodType<Prisma.DeviceTokenUncheckedCreateNestedManyWithoutUserInput>;
export const DeviceTokenUncheckedCreateNestedManyWithoutUserInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
