...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedUpdateManyWithoutFingerprintBiometricNestedInput>;
export const EntryRecordUncheckedUpdateManyWithoutFingerprintBiometricNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => EntryRecordUpsertWithWhereUniqueWithoutFingerprintBiometricInputObjectSchema),
                z.lazy(() => EntryRecordUpsertWithWhereUniqueWithoutFingerprintBiometricInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => EntryRecordUpdateWithWhereUniqueWithoutFingerprintBiometricInputObjectSchema),
                z.lazy(() => EntryRecordUpdateWithWhereUniqueWithoutFingerprintBiometricInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => EntryRecordUpdateManyWithWhereWithoutFingerprintBiometricInputObjectSchema),
                z.lazy(() => EntryRecordUpdateManyWithWhereWithoutFingerprintBiometricInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
