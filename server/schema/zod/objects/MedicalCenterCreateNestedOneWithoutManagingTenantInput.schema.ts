...
type SchemaType = z.ZodType<Prisma.MedicalCenterCreateNestedOneWithoutManagingTenantInput>;
export const MedicalCenterCreateNestedOneWithoutManagingTenantInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
