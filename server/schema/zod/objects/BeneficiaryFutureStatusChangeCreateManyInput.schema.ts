...
type SchemaType = z.ZodType<Prisma.BeneficiaryFutureStatusChangeCreateManyInput>;
export const BeneficiaryFutureStatusChangeCreateManyInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
