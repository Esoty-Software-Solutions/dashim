...
type SchemaType = z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutIdCardInput>;
export const BeneficiaryUncheckedCreateWithoutIdCardInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
