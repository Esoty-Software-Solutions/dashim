...
type SchemaType = z.ZodType<Prisma.BenefitPackageUpdateManyWithoutInsurancePolicyNestedInput>;
export const BenefitPackageUpdateManyWithoutInsurancePolicyNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
