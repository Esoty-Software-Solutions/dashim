...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedCreateWithoutBeneficiaryInput>;
export const EntryRecordUncheckedCreateWithoutBeneficiaryInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
