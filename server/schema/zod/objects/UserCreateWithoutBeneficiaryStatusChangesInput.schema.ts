...
type SchemaType = z.ZodType<Prisma.UserCreateWithoutBeneficiaryStatusChangesInput>;
export const UserCreateWithoutBeneficiaryStatusChangesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
