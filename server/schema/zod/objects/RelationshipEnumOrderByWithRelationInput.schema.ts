...
type SchemaType = z.ZodType<Prisma.RelationshipEnumOrderByWithRelationInput>;
export const RelationshipEnumOrderByWithRelationInputObjectSchema: SchemaType = z
    .object({
        ...
        beneficiary: z.lazy(() => BeneficiaryOrderByRelationAggregateInputObjectSchema).optional(),
    })
