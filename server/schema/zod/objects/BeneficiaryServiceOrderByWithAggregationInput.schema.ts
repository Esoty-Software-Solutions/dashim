...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceOrderByWithAggregationInput>;
export const BeneficiaryServiceOrderByWithAggregationInputObjectSchema: SchemaType = z
    .object({
        ...
        Note: z.union([z.lazy(() => SortOrderSchema), z.lazy(() => SortOrderInputObjectSchema)]).optional(),
        ...
        _count: z.lazy(() => BeneficiaryServiceCountOrderByAggregateInputObjectSchema).optional(),
        _avg: z.lazy(() => BeneficiaryServiceAvgOrderByAggregateInputObjectSchema).optional(),
        _max: z.lazy(() => BeneficiaryServiceMaxOrderByAggregateInputObjectSchema).optional(),
        _min: z.lazy(() => BeneficiaryServiceMinOrderByAggregateInputObjectSchema).optional(),
        _sum: z.lazy(() => BeneficiaryServiceSumOrderByAggregateInputObjectSchema).optional(),
    })
