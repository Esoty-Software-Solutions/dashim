...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityUncheckedUpdateManyWithoutStatusSetByNestedInput>;
export const BeneficiaryEntityUncheckedUpdateManyWithoutStatusSetByNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => BeneficiaryEntityUpsertWithWhereUniqueWithoutStatusSetByInputObjectSchema),
                z.lazy(() => BeneficiaryEntityUpsertWithWhereUniqueWithoutStatusSetByInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => BeneficiaryEntityUpdateWithWhereUniqueWithoutStatusSetByInputObjectSchema),
                z.lazy(() => BeneficiaryEntityUpdateWithWhereUniqueWithoutStatusSetByInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => BeneficiaryEntityUpdateManyWithWhereWithoutStatusSetByInputObjectSchema),
                z.lazy(() => BeneficiaryEntityUpdateManyWithWhereWithoutStatusSetByInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
