...
type SchemaType = z.ZodType<Prisma.InsurancePolicyUncheckedUpdateInput>;
export const InsurancePolicyUncheckedUpdateInputObjectSchema: SchemaType = z
    .object({
        ...
        serviceEntryTimeWindow: z
            ...
            .optional(),
        institutionId: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
        beneficiaryEntities: z
            .lazy(() => BeneficiaryEntityUncheckedUpdateManyWithoutInsurancePolicyNestedInputObjectSchema)
            .optional(),
        benefitPackages: z
            .lazy(() => BenefitPackageUncheckedUpdateManyWithoutInsurancePolicyNestedInputObjectSchema)
            .optional(),
        medicalCenters: z
            .lazy(() => InsurancePolicyMedicalCenterUncheckedUpdateManyWithoutInsurancePolicyNestedInputObjectSchema)
            .optional(),
    })
