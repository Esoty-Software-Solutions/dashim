...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceCreateWithoutCreatedByInput>;
export const BeneficiaryServiceCreateWithoutCreatedByInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
