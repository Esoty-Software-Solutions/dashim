...
type SchemaType = z.ZodType<Prisma.VoiceBiometricUpdateInput>;
export const VoiceBiometricUpdateInputObjectSchema: SchemaType = z
    .object({
        ...
        beneficiary: z.lazy(() => BeneficiaryUpdateOneRequiredWithoutVoiceNestedInputObjectSchema).optional(),
        entryRecords: z.lazy(() => EntryRecordUpdateManyWithoutVoiceBiometricNestedInputObjectSchema).optional(),
    })
