...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceCreateManyCreatedByInput>;
export const BeneficiaryServiceCreateManyCreatedByInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
