...
type SchemaType = z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryUpdateManyWithoutBenefitPackageNestedInput>;
export const BenefitPackageMedicalServiceCategoryUpdateManyWithoutBenefitPackageNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
                z.lazy(() => BenefitPackageMedicalServiceCategoryCreateWithoutBenefitPackageInputObjectSchema),
                z.lazy(() => BenefitPackageMedicalServiceCategoryCreateWithoutBenefitPackageInputObjectSchema).array(),
        ...
        connectOrCreate: z
            .union([
                z.lazy(() => BenefitPackageMedicalServiceCategoryCreateOrConnectWithoutBenefitPackageInputObjectSchema),
                z
                    .lazy(
