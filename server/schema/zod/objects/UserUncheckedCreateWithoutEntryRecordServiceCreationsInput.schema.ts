...
type SchemaType = z.ZodType<Prisma.UserUncheckedCreateWithoutEntryRecordServiceCreationsInput>;
export const UserUncheckedCreateWithoutEntryRecordServiceCreationsInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
