...
type SchemaType = z.ZodType<Prisma.FingerprintBiometricCreateWithoutEntryRecordsInput>;
export const FingerprintBiometricCreateWithoutEntryRecordsInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
