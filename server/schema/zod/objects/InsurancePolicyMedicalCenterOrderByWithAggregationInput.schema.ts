...
type SchemaType = z.ZodType<Prisma.InsurancePolicyMedicalCenterOrderByWithAggregationInput>;
export const InsurancePolicyMedicalCenterOrderByWithAggregationInputObjectSchema: SchemaType = z
    .object({
        ...
        _count: z.lazy(() => InsurancePolicyMedicalCenterCountOrderByAggregateInputObjectSchema).optional(),
        _max: z.lazy(() => InsurancePolicyMedicalCenterMaxOrderByAggregateInputObjectSchema).optional(),
        _min: z.lazy(() => InsurancePolicyMedicalCenterMinOrderByAggregateInputObjectSchema).optional(),
    })
