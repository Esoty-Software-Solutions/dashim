...
type SchemaType = z.ZodType<Prisma.UserUncheckedCreateWithoutBeneficiaryServiceUpdatesInput>;
export const UserUncheckedCreateWithoutBeneficiaryServiceUpdatesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
