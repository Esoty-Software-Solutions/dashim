...
type SchemaType = z.ZodType<Prisma.BenefitPackageCreateWithoutInsurancePolicyInput>;
export const BenefitPackageCreateWithoutInsurancePolicyInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
