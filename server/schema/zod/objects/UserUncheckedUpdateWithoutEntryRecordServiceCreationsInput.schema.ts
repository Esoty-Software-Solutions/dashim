...
type SchemaType = z.ZodType<Prisma.UserUncheckedUpdateWithoutEntryRecordServiceCreationsInput>;
export const UserUncheckedUpdateWithoutEntryRecordServiceCreationsInputObjectSchema: SchemaType = z
    .object({
