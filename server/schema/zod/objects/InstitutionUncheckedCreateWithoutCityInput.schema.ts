...
type SchemaType = z.ZodType<Prisma.InstitutionUncheckedCreateWithoutCityInput>;
export const InstitutionUncheckedCreateWithoutCityInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
