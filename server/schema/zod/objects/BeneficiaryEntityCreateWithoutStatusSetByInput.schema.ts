...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityCreateWithoutStatusSetByInput>;
export const BeneficiaryEntityCreateWithoutStatusSetByInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
