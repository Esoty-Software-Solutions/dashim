...
type SchemaType = z.ZodType<Prisma.MedicalServiceUncheckedCreateWithoutCategoryInput>;
export const MedicalServiceUncheckedCreateWithoutCategoryInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
