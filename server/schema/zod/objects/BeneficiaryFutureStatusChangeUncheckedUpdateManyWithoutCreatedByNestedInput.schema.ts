...
type SchemaType = z.ZodType<Prisma.BeneficiaryFutureStatusChangeUncheckedUpdateManyWithoutCreatedByNestedInput>;
export const BeneficiaryFutureStatusChangeUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => BeneficiaryFutureStatusChangeUpsertWithWhereUniqueWithoutCreatedByInputObjectSchema),
                z
                    .lazy(() => BeneficiaryFutureStatusChangeUpsertWithWhereUniqueWithoutCreatedByInputObjectSchema)
                    .array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => BeneficiaryFutureStatusChangeUpdateWithWhereUniqueWithoutCreatedByInputObjectSchema),
                z
                    .lazy(() => BeneficiaryFutureStatusChangeUpdateWithWhereUniqueWithoutCreatedByInputObjectSchema)
                    .array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => BeneficiaryFutureStatusChangeUpdateManyWithWhereWithoutCreatedByInputObjectSchema),
                z.lazy(() => BeneficiaryFutureStatusChangeUpdateManyWithWhereWithoutCreatedByInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
