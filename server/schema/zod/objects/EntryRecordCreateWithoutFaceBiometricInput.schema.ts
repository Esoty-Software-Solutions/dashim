...
type SchemaType = z.ZodType<Prisma.EntryRecordCreateWithoutFaceBiometricInput>;
export const EntryRecordCreateWithoutFaceBiometricInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
