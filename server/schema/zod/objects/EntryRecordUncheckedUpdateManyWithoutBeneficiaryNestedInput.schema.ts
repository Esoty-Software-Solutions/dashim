...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedUpdateManyWithoutBeneficiaryNestedInput>;
export const EntryRecordUncheckedUpdateManyWithoutBeneficiaryNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
