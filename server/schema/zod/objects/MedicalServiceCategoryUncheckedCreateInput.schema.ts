...
type SchemaType = z.ZodType<Prisma.MedicalServiceCategoryUncheckedCreateInput>;
export const MedicalServiceCategoryUncheckedCreateInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
