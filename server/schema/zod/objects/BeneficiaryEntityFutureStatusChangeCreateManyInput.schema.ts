...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeCreateManyInput>;
export const BeneficiaryEntityFutureStatusChangeCreateManyInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
