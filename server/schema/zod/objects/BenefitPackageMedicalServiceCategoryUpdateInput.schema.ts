...
type SchemaType = z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryUpdateInput>;
export const BenefitPackageMedicalServiceCategoryUpdateInputObjectSchema: SchemaType = z
    .object({
        ...
        deactivationDate: z
            ...
            .nullable(),
        benefitPackage: z
            .lazy(() => BenefitPackageUpdateOneRequiredWithoutMedicalServiceCategoriesNestedInputObjectSchema)
            .optional(),
        medicalServiceCategory: z
            .lazy(() => MedicalServiceCategoryUpdateOneRequiredWithoutBeneftiPackagesNestedInputObjectSchema)
            .optional(),
    })
