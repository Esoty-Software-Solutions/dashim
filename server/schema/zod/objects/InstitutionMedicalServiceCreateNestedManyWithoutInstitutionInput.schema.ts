...
type SchemaType = z.ZodType<Prisma.InstitutionMedicalServiceCreateNestedManyWithoutInstitutionInput>;
export const InstitutionMedicalServiceCreateNestedManyWithoutInstitutionInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
