...
type SchemaType = z.ZodType<Prisma.UserUncheckedCreateWithoutBeneficiaryEntityFutureStatusCreationsInput>;
export const UserUncheckedCreateWithoutBeneficiaryEntityFutureStatusCreationsInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
        ...
        ReviewStatusUpdates: z
            .lazy(() => ReviewStatusUncheckedCreateNestedManyWithoutUpdatedByInputObjectSchema)
            .optional(),
