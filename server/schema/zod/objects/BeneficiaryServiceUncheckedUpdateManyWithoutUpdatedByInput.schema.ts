...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceUncheckedUpdateManyWithoutUpdatedByInput>;
export const BeneficiaryServiceUncheckedUpdateManyWithoutUpdatedByInputObjectSchema: SchemaType = z
    .object({
        ...
        reviewStatusId: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
        entryRecordId: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
        medicalServiceId: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
    })
