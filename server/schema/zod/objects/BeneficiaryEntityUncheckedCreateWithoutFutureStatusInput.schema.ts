...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityUncheckedCreateWithoutFutureStatusInput>;
export const BeneficiaryEntityUncheckedCreateWithoutFutureStatusInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
