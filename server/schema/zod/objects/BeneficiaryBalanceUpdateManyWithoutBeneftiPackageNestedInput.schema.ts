...
type SchemaType = z.ZodType<Prisma.BeneficiaryBalanceUpdateManyWithoutBeneftiPackageNestedInput>;
export const BeneficiaryBalanceUpdateManyWithoutBeneftiPackageNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
