...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceUncheckedCreateWithoutReviewStatusInput>;
export const BeneficiaryServiceUncheckedCreateWithoutReviewStatusInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
