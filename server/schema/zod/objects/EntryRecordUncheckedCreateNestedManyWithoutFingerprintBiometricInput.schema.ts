...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedCreateNestedManyWithoutFingerprintBiometricInput>;
export const EntryRecordUncheckedCreateNestedManyWithoutFingerprintBiometricInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
