...
type SchemaType = z.ZodType<Prisma.BeneficiaryUpdateManyWithoutRelationshipNestedInput>;
export const BeneficiaryUpdateManyWithoutRelationshipNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
