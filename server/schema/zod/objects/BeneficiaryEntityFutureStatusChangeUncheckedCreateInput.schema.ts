...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeUncheckedCreateInput>;
export const BeneficiaryEntityFutureStatusChangeUncheckedCreateInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
