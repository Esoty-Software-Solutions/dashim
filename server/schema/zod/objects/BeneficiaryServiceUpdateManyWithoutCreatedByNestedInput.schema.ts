...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceUpdateManyWithoutCreatedByNestedInput>;
export const BeneficiaryServiceUpdateManyWithoutCreatedByNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
