...
type SchemaType = z.ZodType<Prisma.EntryRecordUpdateManyWithoutUpdatedByNestedInput>;
export const EntryRecordUpdateManyWithoutUpdatedByNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
