...
type SchemaType = z.ZodType<Prisma.InstitutionCreateWithoutMedicalCenterPricingInput>;
export const InstitutionCreateWithoutMedicalCenterPricingInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
