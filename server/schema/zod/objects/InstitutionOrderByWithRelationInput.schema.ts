...
type SchemaType = z.ZodType<Prisma.InstitutionOrderByWithRelationInput>;
export const InstitutionOrderByWithRelationInputObjectSchema: SchemaType = z
    .object({
        ...
        policies: z.lazy(() => InsurancePolicyOrderByRelationAggregateInputObjectSchema).optional(),
        MedicalCenterPricing: z
            .lazy(() => InstitutionMedicalServiceOrderByRelationAggregateInputObjectSchema)
            .optional(),
    })
