...
type SchemaType = z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutStatusSetByInput>;
export const BeneficiaryUncheckedCreateWithoutStatusSetByInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
