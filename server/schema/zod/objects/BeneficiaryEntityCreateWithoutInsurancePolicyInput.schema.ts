...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityCreateWithoutInsurancePolicyInput>;
export const BeneficiaryEntityCreateWithoutInsurancePolicyInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
