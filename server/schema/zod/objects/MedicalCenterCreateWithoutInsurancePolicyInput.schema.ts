...
type SchemaType = z.ZodType<Prisma.MedicalCenterCreateWithoutInsurancePolicyInput>;
export const MedicalCenterCreateWithoutInsurancePolicyInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
