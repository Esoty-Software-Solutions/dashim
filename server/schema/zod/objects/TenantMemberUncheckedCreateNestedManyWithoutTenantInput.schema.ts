...
type SchemaType = z.ZodType<Prisma.TenantMemberUncheckedCreateNestedManyWithoutTenantInput>;
export const TenantMemberUncheckedCreateNestedManyWithoutTenantInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
