...
type SchemaType = z.ZodType<Prisma.InsurancePolicyOrderByWithRelationInput>;
export const InsurancePolicyOrderByWithRelationInputObjectSchema: SchemaType = z
    .object({
        ...
        institution: z.lazy(() => InstitutionOrderByWithRelationInputObjectSchema).optional(),
        beneficiaryEntities: z.lazy(() => BeneficiaryEntityOrderByRelationAggregateInputObjectSchema).optional(),
        benefitPackages: z.lazy(() => BenefitPackageOrderByRelationAggregateInputObjectSchema).optional(),
        medicalCenters: z.lazy(() => InsurancePolicyMedicalCenterOrderByRelationAggregateInputObjectSchema).optional(),
    })
