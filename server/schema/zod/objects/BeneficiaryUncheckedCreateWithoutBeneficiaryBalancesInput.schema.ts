...
type SchemaType = z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutBeneficiaryBalancesInput>;
export const BeneficiaryUncheckedCreateWithoutBeneficiaryBalancesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
        ...
        voice: z.lazy(() => VoiceBiometricUncheckedCreateNestedManyWithoutBeneficiaryInputObjectSchema).optional(),
