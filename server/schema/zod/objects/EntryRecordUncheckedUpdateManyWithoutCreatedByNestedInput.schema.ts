...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedUpdateManyWithoutCreatedByNestedInput>;
export const EntryRecordUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
