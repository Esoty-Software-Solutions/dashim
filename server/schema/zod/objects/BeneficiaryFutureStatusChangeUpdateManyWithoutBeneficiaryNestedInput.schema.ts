...
type SchemaType = z.ZodType<Prisma.BeneficiaryFutureStatusChangeUpdateManyWithoutBeneficiaryNestedInput>;
export const BeneficiaryFutureStatusChangeUpdateManyWithoutBeneficiaryNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
