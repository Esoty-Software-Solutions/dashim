...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceUncheckedUpdateManyWithoutEntryRecordNestedInput>;
export const BeneficiaryServiceUncheckedUpdateManyWithoutEntryRecordNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => BeneficiaryServiceUpsertWithWhereUniqueWithoutEntryRecordInputObjectSchema),
                z.lazy(() => BeneficiaryServiceUpsertWithWhereUniqueWithoutEntryRecordInputObjectSchema).array(),
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => BeneficiaryServiceUpdateWithWhereUniqueWithoutEntryRecordInputObjectSchema),
                z.lazy(() => BeneficiaryServiceUpdateWithWhereUniqueWithoutEntryRecordInputObjectSchema).array(),
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => BeneficiaryServiceUpdateManyWithWhereWithoutEntryRecordInputObjectSchema),
                z.lazy(() => BeneficiaryServiceUpdateManyWithWhereWithoutEntryRecordInputObjectSchema).array(),
            ])
            .optional(),
        deleteMany: z
            .union([
