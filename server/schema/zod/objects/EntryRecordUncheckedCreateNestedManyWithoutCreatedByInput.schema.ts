...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedCreateNestedManyWithoutCreatedByInput>;
export const EntryRecordUncheckedCreateNestedManyWithoutCreatedByInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
