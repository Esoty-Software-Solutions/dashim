...
type SchemaType = z.ZodType<Prisma.BenefitPackageCreateWithoutBeneficiaryBalancesInput>;
export const BenefitPackageCreateWithoutBeneficiaryBalancesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
        ...
        medicalServiceCategories: z
            .lazy(() => BenefitPackageMedicalServiceCategoryCreateNestedManyWithoutBenefitPackageInputObjectSchema)
            .optional(),
