...
type SchemaType = z.ZodType<Prisma.EntryRecordUpdateManyWithoutFaceBiometricNestedInput>;
export const EntryRecordUpdateManyWithoutFaceBiometricNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
