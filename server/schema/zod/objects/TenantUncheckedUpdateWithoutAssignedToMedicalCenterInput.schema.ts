...
type SchemaType = z.ZodType<Prisma.TenantUncheckedUpdateWithoutAssignedToMedicalCenterInput>;
export const TenantUncheckedUpdateWithoutAssignedToMedicalCenterInputObjectSchema: SchemaType = z
    .object({
        ...
        typeId: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
        description: z
            .union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema), z.null()])
            .optional()
            .nullable(),
