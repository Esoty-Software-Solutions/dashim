...
type SchemaType = z.ZodType<Prisma.UserCreateWithoutBeneficiaryEntityFutureStatusUpdatesInput>;
export const UserCreateWithoutBeneficiaryEntityFutureStatusUpdatesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
