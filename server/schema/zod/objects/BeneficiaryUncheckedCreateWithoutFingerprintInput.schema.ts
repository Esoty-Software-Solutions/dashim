...
type SchemaType = z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutFingerprintInput>;
export const BeneficiaryUncheckedCreateWithoutFingerprintInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
