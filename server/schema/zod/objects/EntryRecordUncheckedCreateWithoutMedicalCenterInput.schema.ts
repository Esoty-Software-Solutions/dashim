...
type SchemaType = z.ZodType<Prisma.EntryRecordUncheckedCreateWithoutMedicalCenterInput>;
export const EntryRecordUncheckedCreateWithoutMedicalCenterInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
