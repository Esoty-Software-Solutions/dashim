...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceCreateManyEntryRecordInput>;
export const BeneficiaryServiceCreateManyEntryRecordInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
