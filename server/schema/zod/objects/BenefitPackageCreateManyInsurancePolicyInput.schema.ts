...
type SchemaType = z.ZodType<Prisma.BenefitPackageCreateManyInsurancePolicyInput>;
export const BenefitPackageCreateManyInsurancePolicyInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
