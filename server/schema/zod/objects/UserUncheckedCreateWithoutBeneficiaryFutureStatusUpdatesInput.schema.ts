...
type SchemaType = z.ZodType<Prisma.UserUncheckedCreateWithoutBeneficiaryFutureStatusUpdatesInput>;
export const UserUncheckedCreateWithoutBeneficiaryFutureStatusUpdatesInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
