...
type SchemaType = z.ZodType<Prisma.BeneficiaryCreateWithoutFutureStatusInput>;
export const BeneficiaryCreateWithoutFutureStatusInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
