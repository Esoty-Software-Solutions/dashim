...
type SchemaType = z.ZodType<Prisma.BeneficiaryServiceCreateManyUpdatedByInput>;
export const BeneficiaryServiceCreateManyUpdatedByInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
