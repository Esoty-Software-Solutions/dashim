...
type SchemaType = z.ZodType<Prisma.TenantUncheckedCreateNestedManyWithoutOwnerInput>;
export const TenantUncheckedCreateNestedManyWithoutOwnerInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
