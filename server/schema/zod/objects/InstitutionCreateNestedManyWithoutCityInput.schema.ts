...
type SchemaType = z.ZodType<Prisma.InstitutionCreateNestedManyWithoutCityInput>;
export const InstitutionCreateNestedManyWithoutCityInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
