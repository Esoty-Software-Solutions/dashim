...
type SchemaType = z.ZodType<Prisma.IDCardUpdateManyWithoutBeneficiaryNestedInput>;
export const IDCardUpdateManyWithoutBeneficiaryNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
