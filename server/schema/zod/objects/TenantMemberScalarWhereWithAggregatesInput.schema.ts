...
type SchemaType = z.ZodType<Prisma.TenantMemberScalarWhereWithAggregatesInput>;
export const TenantMemberScalarWhereWithAggregatesInputObjectSchema: SchemaType = z
    .object({
        AND: z
            .union([
                z.lazy(() => TenantMemberScalarWhereWithAggregatesInputObjectSchema),
                z.lazy(() => TenantMemberScalarWhereWithAggregatesInputObjectSchema).array(),
            ])
            .optional(),
        OR: z
