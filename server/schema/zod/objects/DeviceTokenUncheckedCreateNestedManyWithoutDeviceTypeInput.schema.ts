...
type SchemaType = z.ZodType<Prisma.DeviceTokenUncheckedCreateNestedManyWithoutDeviceTypeInput>;
export const DeviceTokenUncheckedCreateNestedManyWithoutDeviceTypeInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
