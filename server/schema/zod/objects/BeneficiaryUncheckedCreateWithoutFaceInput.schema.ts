...
type SchemaType = z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutFaceInput>;
export const BeneficiaryUncheckedCreateWithoutFaceInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
