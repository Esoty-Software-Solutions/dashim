...
type SchemaType = z.ZodType<Prisma.MedicalCenterCreateWithoutManagingTenantInput>;
export const MedicalCenterCreateWithoutManagingTenantInputObjectSchema: SchemaType = z
    .object({
        id: z.string(),
