...
type SchemaType = z.ZodType<Prisma.EntryRecordUpdateManyWithoutFingerprintBiometricNestedInput>;
export const EntryRecordUpdateManyWithoutFingerprintBiometricNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
