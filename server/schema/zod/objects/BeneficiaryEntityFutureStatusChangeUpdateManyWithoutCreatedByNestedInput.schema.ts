...
type SchemaType = z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeUpdateManyWithoutCreatedByNestedInput>;
export const BeneficiaryEntityFutureStatusChangeUpdateManyWithoutCreatedByNestedInputObjectSchema: SchemaType = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => BeneficiaryEntityFutureStatusChangeUpsertWithWhereUniqueWithoutCreatedByInputObjectSchema),
                z
                    .lazy(
        ...
        update: z
            .union([
                z.lazy(() => BeneficiaryEntityFutureStatusChangeUpdateWithWhereUniqueWithoutCreatedByInputObjectSchema),
                z
                    .lazy(
        ...
        updateMany: z
            .union([
                z.lazy(() => BeneficiaryEntityFutureStatusChangeUpdateManyWithWhereWithoutCreatedByInputObjectSchema),
                z
                    .lazy(() => BeneficiaryEntityFutureStatusChangeUpdateManyWithWhereWithoutCreatedByInputObjectSchema)
                    .array(),
            ])
            .optional(),
        deleteMany: z
