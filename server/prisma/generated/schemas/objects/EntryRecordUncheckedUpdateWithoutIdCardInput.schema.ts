...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedUpdateWithoutIdCardInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const EntryRecordUncheckedUpdateWithoutIdCardInputObjectSchema = Schema;
