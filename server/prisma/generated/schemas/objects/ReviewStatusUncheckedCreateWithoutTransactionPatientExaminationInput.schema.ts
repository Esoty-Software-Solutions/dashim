...
const Schema: z.ZodType<Prisma.ReviewStatusUncheckedCreateWithoutTransactionPatientExaminationInput> =
  z
    .object({
      id: z.string(),
...
export const ReviewStatusUncheckedCreateWithoutTransactionPatientExaminationInputObjectSchema =
  Schema;
