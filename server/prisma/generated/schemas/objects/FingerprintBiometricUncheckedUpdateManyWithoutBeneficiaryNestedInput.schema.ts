...
const Schema: z.ZodType<Prisma.FingerprintBiometricUncheckedUpdateManyWithoutBeneficiaryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const FingerprintBiometricUncheckedUpdateManyWithoutBeneficiaryNestedInputObjectSchema =
  Schema;
