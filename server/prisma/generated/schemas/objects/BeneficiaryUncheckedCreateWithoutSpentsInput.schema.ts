...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutSpentsInput> = z
  .object({
    id: z.string(),
...
export const BeneficiaryUncheckedCreateWithoutSpentsInputObjectSchema = Schema;
