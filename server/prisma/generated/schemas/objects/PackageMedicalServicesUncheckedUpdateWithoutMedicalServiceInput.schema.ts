...
const Schema: z.ZodType<Prisma.PackageMedicalServicesUncheckedUpdateWithoutMedicalServiceInput> =
  z
    .object({
      id: z
        .union([
...
export const PackageMedicalServicesUncheckedUpdateWithoutMedicalServiceInputObjectSchema =
  Schema;
