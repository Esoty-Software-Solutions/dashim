...
const Schema: z.ZodType<Prisma.PatientExaminationUpdateWithoutMedicalReviewStatusInput> =
  z
    .object({
      id: z
        .union([
...
export const PatientExaminationUpdateWithoutMedicalReviewStatusInputObjectSchema =
  Schema;
