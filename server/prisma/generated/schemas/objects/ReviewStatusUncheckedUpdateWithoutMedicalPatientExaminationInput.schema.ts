...
const Schema: z.ZodType<Prisma.ReviewStatusUncheckedUpdateWithoutMedicalPatientExaminationInput> =
  z
    .object({
      id: z
        .union([
...
export const ReviewStatusUncheckedUpdateWithoutMedicalPatientExaminationInputObjectSchema =
  Schema;
