...
const Schema: z.ZodType<Prisma.MedicalCenterUncheckedUpdateWithoutInsurancePolicyInput> =
  z
    .object({
      id: z
        .union([
...
export const MedicalCenterUncheckedUpdateWithoutInsurancePolicyInputObjectSchema =
  Schema;
