...
const Schema: z.ZodType<Prisma.EntryRecordUpdateManyWithoutMedicalCenterNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordUpdateManyWithoutMedicalCenterNestedInputObjectSchema =
  Schema;
