...
const Schema: z.ZodType<Prisma.MedicalCenterUncheckedUpdateWithoutTimeWindowInput> =
  z
    .object({
      id: z
        .union([
...
export const MedicalCenterUncheckedUpdateWithoutTimeWindowInputObjectSchema =
  Schema;
