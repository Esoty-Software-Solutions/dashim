...
const Schema: z.ZodType<Prisma.PatientExaminationUncheckedCreateWithoutEntryRecordInput> =
  z
    .object({
      id: z.string(),
...
export const PatientExaminationUncheckedCreateWithoutEntryRecordInputObjectSchema =
  Schema;
