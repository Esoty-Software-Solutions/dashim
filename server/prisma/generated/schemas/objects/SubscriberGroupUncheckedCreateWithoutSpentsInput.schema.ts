...
const Schema: z.ZodType<Prisma.SubscriberGroupUncheckedCreateWithoutSpentsInput> =
  z
    .object({
      id: z.string(),
...
export const SubscriberGroupUncheckedCreateWithoutSpentsInputObjectSchema =
  Schema;
