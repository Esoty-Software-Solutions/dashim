...
const Schema: z.ZodType<Prisma.PatientExaminationUncheckedUpdateWithoutEntryRecordInput> =
  z
    .object({
      id: z
        .union([
...
export const PatientExaminationUncheckedUpdateWithoutEntryRecordInputObjectSchema =
  Schema;
