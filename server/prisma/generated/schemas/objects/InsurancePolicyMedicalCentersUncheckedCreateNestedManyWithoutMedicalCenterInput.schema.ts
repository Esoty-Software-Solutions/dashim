...
const Schema: z.ZodType<Prisma.InsurancePolicyMedicalCentersUncheckedCreateNestedManyWithoutMedicalCenterInput> =
  z
    .object({
      create: z
        .union([
...
export const InsurancePolicyMedicalCentersUncheckedCreateNestedManyWithoutMedicalCenterInputObjectSchema =
  Schema;
