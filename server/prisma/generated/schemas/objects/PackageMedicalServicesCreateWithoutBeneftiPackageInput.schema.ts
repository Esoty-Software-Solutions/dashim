...
const Schema: z.ZodType<Prisma.PackageMedicalServicesCreateWithoutBeneftiPackageInput> =
  z
    .object({
      id: z.string(),
...
export const PackageMedicalServicesCreateWithoutBeneftiPackageInputObjectSchema =
  Schema;
