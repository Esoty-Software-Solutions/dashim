...
const Schema: z.ZodType<Prisma.PatientServiceUpdateWithoutPatientExaminationInput> =
  z
    .object({
      id: z
        .union([
...
export const PatientServiceUpdateWithoutPatientExaminationInputObjectSchema =
  Schema;
