...
const Schema: z.ZodType<Prisma.PatientServiceUncheckedCreateNestedManyWithoutPatientExaminationInput> =
  z
    .object({
      create: z
        .union([
...
export const PatientServiceUncheckedCreateNestedManyWithoutPatientExaminationInputObjectSchema =
  Schema;
