...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedUpdateManyWithoutVoiceNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordUncheckedUpdateManyWithoutVoiceNestedInputObjectSchema =
  Schema;
