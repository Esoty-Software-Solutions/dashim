...
const Schema: z.ZodType<Prisma.PatientExaminationUncheckedCreateNestedManyWithoutMedicalReviewStatusInput> =
  z
    .object({
      create: z
        .union([
...
export const PatientExaminationUncheckedCreateNestedManyWithoutMedicalReviewStatusInputObjectSchema =
  Schema;
