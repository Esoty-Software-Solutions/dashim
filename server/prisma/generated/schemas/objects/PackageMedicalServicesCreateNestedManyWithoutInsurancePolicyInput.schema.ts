...
const Schema: z.ZodType<Prisma.PackageMedicalServicesCreateNestedManyWithoutInsurancePolicyInput> =
  z
    .object({
      create: z
        .union([
...
export const PackageMedicalServicesCreateNestedManyWithoutInsurancePolicyInputObjectSchema =
  Schema;
