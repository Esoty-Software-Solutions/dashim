...
const Schema: z.ZodType<Prisma.DiagnosisAttachmentOrderByWithAggregationInput> =
  z
    .object({
      ...
      _count: z
        .lazy(() => DiagnosisAttachmentCountOrderByAggregateInputObjectSchema)
        .optional(),
      _avg: z
        .lazy(() => DiagnosisAttachmentAvgOrderByAggregateInputObjectSchema)
        .optional(),
      _max: z
        .lazy(() => DiagnosisAttachmentMaxOrderByAggregateInputObjectSchema)
        .optional(),
      _min: z
        .lazy(() => DiagnosisAttachmentMinOrderByAggregateInputObjectSchema)
        .optional(),
      _sum: z
        .lazy(() => DiagnosisAttachmentSumOrderByAggregateInputObjectSchema)
        .optional(),
    })
    .strict();

export const DiagnosisAttachmentOrderByWithAggregationInputObjectSchema =
  Schema;
