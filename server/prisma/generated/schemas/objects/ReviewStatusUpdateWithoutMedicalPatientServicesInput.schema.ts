...
const Schema: z.ZodType<Prisma.ReviewStatusUpdateWithoutMedicalPatientServicesInput> =
  z
    .object({
      id: z
        .union([
...
export const ReviewStatusUpdateWithoutMedicalPatientServicesInputObjectSchema =
  Schema;
