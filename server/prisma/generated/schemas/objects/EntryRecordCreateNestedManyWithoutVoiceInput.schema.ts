...
const Schema: z.ZodType<Prisma.EntryRecordCreateNestedManyWithoutVoiceInput> = z
  .object({
    create: z
      .union([
...
export const EntryRecordCreateNestedManyWithoutVoiceInputObjectSchema = Schema;
