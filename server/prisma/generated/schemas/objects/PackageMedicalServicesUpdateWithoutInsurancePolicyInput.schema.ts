...
const Schema: z.ZodType<Prisma.PackageMedicalServicesUpdateWithoutInsurancePolicyInput> =
  z
    .object({
      id: z
        .union([
...
export const PackageMedicalServicesUpdateWithoutInsurancePolicyInputObjectSchema =
  Schema;
