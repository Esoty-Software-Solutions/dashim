...
const Schema: z.ZodType<Prisma.PatientExaminationUncheckedUpdateOneWithoutEntryRecordNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PatientExaminationUncheckedUpdateOneWithoutEntryRecordNestedInputObjectSchema =
  Schema;
