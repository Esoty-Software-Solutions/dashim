...
const Schema: z.ZodType<Prisma.InsurancePolicyUpdateWithoutPackageMedicalServicesInput> =
  z
    .object({
      id: z
        .union([
...
export const InsurancePolicyUpdateWithoutPackageMedicalServicesInputObjectSchema =
  Schema;
