...
const Schema: z.ZodType<Prisma.SubscriberGroupUpdateWithoutEntryRecordsInput> =
  z
    .object({
      id: z
        .union([
...
export const SubscriberGroupUpdateWithoutEntryRecordsInputObjectSchema = Schema;
