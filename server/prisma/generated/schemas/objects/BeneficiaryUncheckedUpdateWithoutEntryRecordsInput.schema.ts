...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedUpdateWithoutEntryRecordsInput> =
  z
    .object({
      id: z
        .union([
...
export const BeneficiaryUncheckedUpdateWithoutEntryRecordsInputObjectSchema =
  Schema;
