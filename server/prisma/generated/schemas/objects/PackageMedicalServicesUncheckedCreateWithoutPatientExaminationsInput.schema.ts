...
const Schema: z.ZodType<Prisma.PackageMedicalServicesUncheckedCreateWithoutPatientExaminationsInput> =
  z
    .object({
      id: z.string(),
...
export const PackageMedicalServicesUncheckedCreateWithoutPatientExaminationsInputObjectSchema =
  Schema;
