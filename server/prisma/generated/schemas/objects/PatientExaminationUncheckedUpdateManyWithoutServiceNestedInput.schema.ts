...
const Schema: z.ZodType<Prisma.PatientExaminationUncheckedUpdateManyWithoutServiceNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PatientExaminationUncheckedUpdateManyWithoutServiceNestedInputObjectSchema =
  Schema;
