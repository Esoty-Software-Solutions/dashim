...
const Schema: z.ZodType<Prisma.SubscriberGroupBalanceCreateNestedManyWithoutBeneftiPackageInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberGroupBalanceCreateNestedManyWithoutBeneftiPackageInputObjectSchema =
  Schema;
