...
const Schema: z.ZodType<Prisma.PatientExaminationCreateNestedManyWithoutTransactionReviewStatusInput> =
  z
    .object({
      create: z
        .union([
...
export const PatientExaminationCreateNestedManyWithoutTransactionReviewStatusInputObjectSchema =
  Schema;
