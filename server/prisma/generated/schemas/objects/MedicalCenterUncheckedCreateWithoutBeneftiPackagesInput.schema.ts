...
const Schema: z.ZodType<Prisma.MedicalCenterUncheckedCreateWithoutBeneftiPackagesInput> =
  z
    .object({
      id: z.string(),
...
export const MedicalCenterUncheckedCreateWithoutBeneftiPackagesInputObjectSchema =
  Schema;
