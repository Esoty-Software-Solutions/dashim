...
const Schema: z.ZodType<Prisma.PatientServiceUncheckedCreateNestedManyWithoutEntryRecordInput> =
  z
    .object({
      create: z
        .union([
...
export const PatientServiceUncheckedCreateNestedManyWithoutEntryRecordInputObjectSchema =
  Schema;
