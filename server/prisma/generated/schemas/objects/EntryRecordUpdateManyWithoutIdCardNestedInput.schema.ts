...
const Schema: z.ZodType<Prisma.EntryRecordUpdateManyWithoutIdCardNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordUpdateManyWithoutIdCardNestedInputObjectSchema = Schema;
