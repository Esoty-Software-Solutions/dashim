...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedCreateNestedManyWithoutIdCardBiometricInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordUncheckedCreateNestedManyWithoutIdCardBiometricInputObjectSchema =
  Schema;
