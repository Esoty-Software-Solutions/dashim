...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutSubscriberInput> =
  z
    .object({
      id: z.string(),
...
export const BeneficiaryUncheckedCreateWithoutSubscriberInputObjectSchema =
  Schema;
