...
const Schema: z.ZodType<Prisma.FaceBiometricUncheckedUpdateManyWithoutBeneficiaryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const FaceBiometricUncheckedUpdateManyWithoutBeneficiaryNestedInputObjectSchema =
  Schema;
