...
const Schema: z.ZodType<Prisma.PackageMedicalServicesUpdateInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    insurancePolicy: z
      ...
      .optional(),
    patientServices: z
      .lazy(() => PatientServiceUpdateManyWithoutServiceNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const PackageMedicalServicesUpdateInputObjectSchema = Schema;
