...
const Schema: z.ZodType<Prisma.SubscriberGroupBalanceCreateNestedManyWithoutSubscriberGroupInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberGroupBalanceCreateNestedManyWithoutSubscriberGroupInputObjectSchema =
  Schema;
