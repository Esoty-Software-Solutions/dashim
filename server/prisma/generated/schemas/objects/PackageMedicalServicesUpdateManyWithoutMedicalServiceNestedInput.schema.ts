...
const Schema: z.ZodType<Prisma.PackageMedicalServicesUpdateManyWithoutMedicalServiceNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PackageMedicalServicesUpdateManyWithoutMedicalServiceNestedInputObjectSchema =
  Schema;
