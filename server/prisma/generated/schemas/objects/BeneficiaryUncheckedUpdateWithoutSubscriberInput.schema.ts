...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedUpdateWithoutSubscriberInput> =
  z
    .object({
      id: z
        .union([
...
export const BeneficiaryUncheckedUpdateWithoutSubscriberInputObjectSchema =
  Schema;
