...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedUpdateWithoutPatientServicesInput> =
  z
    .object({
      id: z
        .union([
...
export const EntryRecordUncheckedUpdateWithoutPatientServicesInputObjectSchema =
  Schema;
