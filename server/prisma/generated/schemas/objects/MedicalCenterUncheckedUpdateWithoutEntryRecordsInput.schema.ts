...
const Schema: z.ZodType<Prisma.MedicalCenterUncheckedUpdateWithoutEntryRecordsInput> =
  z
    .object({
      id: z
        .union([
...
export const MedicalCenterUncheckedUpdateWithoutEntryRecordsInputObjectSchema =
  Schema;
