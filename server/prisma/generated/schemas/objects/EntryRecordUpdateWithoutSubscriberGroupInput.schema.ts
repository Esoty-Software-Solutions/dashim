...
const Schema: z.ZodType<Prisma.EntryRecordUpdateWithoutSubscriberGroupInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const EntryRecordUpdateWithoutSubscriberGroupInputObjectSchema = Schema;
