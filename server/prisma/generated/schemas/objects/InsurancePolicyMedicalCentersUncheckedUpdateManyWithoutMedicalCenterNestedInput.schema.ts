...
const Schema: z.ZodType<Prisma.InsurancePolicyMedicalCentersUncheckedUpdateManyWithoutMedicalCenterNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const InsurancePolicyMedicalCentersUncheckedUpdateManyWithoutMedicalCenterNestedInputObjectSchema =
  Schema;
