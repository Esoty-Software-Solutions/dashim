...
const Schema: z.ZodType<Prisma.SubscriberGroupUncheckedUpdateWithoutSpentsInput> =
  z
    .object({
      id: z
        .union([
...
export const SubscriberGroupUncheckedUpdateWithoutSpentsInputObjectSchema =
  Schema;
