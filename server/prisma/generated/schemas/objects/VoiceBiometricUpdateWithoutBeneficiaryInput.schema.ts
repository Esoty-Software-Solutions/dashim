...
const Schema: z.ZodType<Prisma.VoiceBiometricUpdateWithoutBeneficiaryInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const VoiceBiometricUpdateWithoutBeneficiaryInputObjectSchema = Schema;
