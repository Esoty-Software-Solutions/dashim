...
const Schema: z.ZodType<Prisma.SubscriberGroupUncheckedUpdateWithoutEntryRecordsInput> =
  z
    .object({
      id: z
        .union([
...
export const SubscriberGroupUncheckedUpdateWithoutEntryRecordsInputObjectSchema =
  Schema;
