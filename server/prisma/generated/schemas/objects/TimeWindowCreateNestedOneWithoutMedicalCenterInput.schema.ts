...
const Schema: z.ZodType<Prisma.TimeWindowCreateNestedOneWithoutMedicalCenterInput> =
  z
    .object({
      create: z
        .union([
...
export const TimeWindowCreateNestedOneWithoutMedicalCenterInputObjectSchema =
  Schema;
