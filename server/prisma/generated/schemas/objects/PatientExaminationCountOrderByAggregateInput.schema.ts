...
const Schema: z.ZodType<Prisma.PatientExaminationCountOrderByAggregateInput> = z
  .object({
...
export const PatientExaminationCountOrderByAggregateInputObjectSchema = Schema;
