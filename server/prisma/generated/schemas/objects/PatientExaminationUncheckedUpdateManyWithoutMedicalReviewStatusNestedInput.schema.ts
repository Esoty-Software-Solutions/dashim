...
const Schema: z.ZodType<Prisma.PatientExaminationUncheckedUpdateManyWithoutMedicalReviewStatusNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PatientExaminationUncheckedUpdateManyWithoutMedicalReviewStatusNestedInputObjectSchema =
  Schema;
