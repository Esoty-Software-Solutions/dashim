...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedUpdateManyWithoutSubscriberGroupNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordUncheckedUpdateManyWithoutSubscriberGroupNestedInputObjectSchema =
  Schema;
