...
const Schema: z.ZodType<Prisma.FingerprintBiometricMinOrderByAggregateInput> = z
  .object({
...
export const FingerprintBiometricMinOrderByAggregateInputObjectSchema = Schema;
