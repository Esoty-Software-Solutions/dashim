...
const Schema: z.ZodType<Prisma.ReviewStatusUpdateWithoutTransactionPatientServicesInput> =
  z
    .object({
      id: z
        .union([
...
export const ReviewStatusUpdateWithoutTransactionPatientServicesInputObjectSchema =
  Schema;
