...
const Schema: z.ZodType<Prisma.PatientServiceUncheckedUpdateManyWithoutPatientExaminationNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PatientServiceUncheckedUpdateManyWithoutPatientExaminationNestedInputObjectSchema =
  Schema;
