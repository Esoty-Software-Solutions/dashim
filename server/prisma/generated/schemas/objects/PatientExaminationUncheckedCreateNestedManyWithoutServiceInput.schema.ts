...
const Schema: z.ZodType<Prisma.PatientExaminationUncheckedCreateNestedManyWithoutServiceInput> =
  z
    .object({
      create: z
        .union([
...
export const PatientExaminationUncheckedCreateNestedManyWithoutServiceInputObjectSchema =
  Schema;
