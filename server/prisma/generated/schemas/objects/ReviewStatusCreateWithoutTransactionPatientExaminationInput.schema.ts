...
const Schema: z.ZodType<Prisma.ReviewStatusCreateWithoutTransactionPatientExaminationInput> =
  z
    .object({
      id: z.string(),
...
export const ReviewStatusCreateWithoutTransactionPatientExaminationInputObjectSchema =
  Schema;
