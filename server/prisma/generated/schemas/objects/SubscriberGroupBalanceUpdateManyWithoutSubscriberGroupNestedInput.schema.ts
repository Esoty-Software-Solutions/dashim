...
const Schema: z.ZodType<Prisma.SubscriberGroupBalanceUpdateManyWithoutSubscriberGroupNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberGroupBalanceUpdateManyWithoutSubscriberGroupNestedInputObjectSchema =
  Schema;
