...
const Schema: z.ZodType<Prisma.BenefitPackageUncheckedUpdateWithoutMedicalServicesInput> =
  z
    .object({
      id: z
        .union([
      ...
      spents: z
        .lazy(
          () =>
            SubscriberGroupBalanceUncheckedUpdateManyWithoutBeneftiPackageNestedInputObjectSchema,
        )
        .optional(),
    })
    .strict();

export const BenefitPackageUncheckedUpdateWithoutMedicalServicesInputObjectSchema =
  Schema;
