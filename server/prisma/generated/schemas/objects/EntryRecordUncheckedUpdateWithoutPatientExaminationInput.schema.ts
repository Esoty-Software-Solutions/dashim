...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedUpdateWithoutPatientExaminationInput> =
  z
    .object({
      id: z
        .union([
...
export const EntryRecordUncheckedUpdateWithoutPatientExaminationInputObjectSchema =
  Schema;
