...
const Schema: z.ZodType<Prisma.InsurancePolicyMedicalCenterUpdateWithoutMedicalCenterInput> =
  z
    .object({
      id: z
        .union([
...
export const InsurancePolicyMedicalCenterUpdateWithoutMedicalCenterInputObjectSchema =
  Schema;
