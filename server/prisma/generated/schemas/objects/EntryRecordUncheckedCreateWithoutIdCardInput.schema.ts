...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedCreateWithoutIdCardInput> = z
  .object({
    id: z.string(),
...
export const EntryRecordUncheckedCreateWithoutIdCardInputObjectSchema = Schema;
