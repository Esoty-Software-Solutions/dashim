...
const Schema: z.ZodType<Prisma.SubscriberGroupUncheckedCreateWithoutEntryRecordsInput> =
  z
    .object({
      id: z.string(),
...
export const SubscriberGroupUncheckedCreateWithoutEntryRecordsInputObjectSchema =
  Schema;
