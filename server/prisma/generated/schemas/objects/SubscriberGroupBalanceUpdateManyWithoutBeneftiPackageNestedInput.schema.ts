...
const Schema: z.ZodType<Prisma.SubscriberGroupBalanceUpdateManyWithoutBeneftiPackageNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberGroupBalanceUpdateManyWithoutBeneftiPackageNestedInputObjectSchema =
  Schema;
