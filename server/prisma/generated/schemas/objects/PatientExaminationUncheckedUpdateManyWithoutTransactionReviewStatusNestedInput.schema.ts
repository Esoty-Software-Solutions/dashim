...
const Schema: z.ZodType<Prisma.PatientExaminationUncheckedUpdateManyWithoutTransactionReviewStatusNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PatientExaminationUncheckedUpdateManyWithoutTransactionReviewStatusNestedInputObjectSchema =
  Schema;
