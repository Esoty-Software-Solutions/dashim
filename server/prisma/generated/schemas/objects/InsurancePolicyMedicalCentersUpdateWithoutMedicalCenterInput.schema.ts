...
const Schema: z.ZodType<Prisma.InsurancePolicyMedicalCentersUpdateWithoutMedicalCenterInput> =
  z
    .object({
      id: z
        .union([
...
export const InsurancePolicyMedicalCentersUpdateWithoutMedicalCenterInputObjectSchema =
  Schema;
