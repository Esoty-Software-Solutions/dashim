...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedUpdateWithoutSpentsInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const BeneficiaryUncheckedUpdateWithoutSpentsInputObjectSchema = Schema;
