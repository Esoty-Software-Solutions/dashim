...
const Schema: z.ZodType<Prisma.EntryRecordUpdateManyWithWhereWithoutSubscriberGroupInput> =
  z
    .object({
...
export const EntryRecordUpdateManyWithWhereWithoutSubscriberGroupInputObjectSchema =
  Schema;
