...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedCreateNestedManyWithoutRelationshipInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryUncheckedCreateNestedManyWithoutRelationshipInputObjectSchema =
  Schema;
