...
const Schema: z.ZodType<Prisma.MedicalCenterUncheckedCreateWithoutTimeWindowInput> =
  z
    .object({
      id: z.string(),
...
export const MedicalCenterUncheckedCreateWithoutTimeWindowInputObjectSchema =
  Schema;
