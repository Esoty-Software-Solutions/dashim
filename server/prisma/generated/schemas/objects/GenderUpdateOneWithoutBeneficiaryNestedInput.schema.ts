...
const Schema: z.ZodType<Prisma.GenderUpdateOneWithoutBeneficiaryNestedInput> = z
  .object({
    create: z
      .union([
...
export const GenderUpdateOneWithoutBeneficiaryNestedInputObjectSchema = Schema;
