...
const Schema: z.ZodType<Prisma.BeneficiaryBalanceUncheckedCreateNestedManyWithoutBeneficiaryInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryBalanceUncheckedCreateNestedManyWithoutBeneficiaryInputObjectSchema =
  Schema;
