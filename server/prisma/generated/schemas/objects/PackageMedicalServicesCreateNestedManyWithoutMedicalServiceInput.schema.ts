...
const Schema: z.ZodType<Prisma.PackageMedicalServicesCreateNestedManyWithoutMedicalServiceInput> =
  z
    .object({
      create: z
        .union([
...
export const PackageMedicalServicesCreateNestedManyWithoutMedicalServiceInputObjectSchema =
  Schema;
