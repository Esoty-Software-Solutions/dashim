...
const Schema: z.ZodType<Prisma.InsurancePolicyMedicalCentersCreateWithoutInsurancePolicyInput> =
  z
    .object({
      id: z.string(),
...
export const InsurancePolicyMedicalCentersCreateWithoutInsurancePolicyInputObjectSchema =
  Schema;
