...
const Schema: z.ZodType<Prisma.EntryRecordCreateNestedManyWithoutMedicalCenterInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordCreateNestedManyWithoutMedicalCenterInputObjectSchema =
  Schema;
