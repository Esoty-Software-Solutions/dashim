...
const Schema: z.ZodType<Prisma.PatientServiceUncheckedCreateWithoutServiceInput> =
  z
    .object({
      id: z.string(),
...
export const PatientServiceUncheckedCreateWithoutServiceInputObjectSchema =
  Schema;
