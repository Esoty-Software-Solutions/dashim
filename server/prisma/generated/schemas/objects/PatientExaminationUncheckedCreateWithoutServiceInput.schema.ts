...
const Schema: z.ZodType<Prisma.PatientExaminationUncheckedCreateWithoutServiceInput> =
  z
    .object({
      id: z.string(),
...
export const PatientExaminationUncheckedCreateWithoutServiceInputObjectSchema =
  Schema;
