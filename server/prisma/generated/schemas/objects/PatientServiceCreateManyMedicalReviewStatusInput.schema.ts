...
const Schema: z.ZodType<Prisma.PatientServiceCreateManyMedicalReviewStatusInput> =
  z
    .object({
      id: z.string(),
...
export const PatientServiceCreateManyMedicalReviewStatusInputObjectSchema =
  Schema;
