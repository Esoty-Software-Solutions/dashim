...
const Schema: z.ZodType<Prisma.PatientExaminationUpdateWithoutServiceInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const PatientExaminationUpdateWithoutServiceInputObjectSchema = Schema;
