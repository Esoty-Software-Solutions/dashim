...
const Schema: z.ZodType<Prisma.TimeWindowUncheckedUpdateOneWithoutMedicalCenterNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TimeWindowUncheckedUpdateOneWithoutMedicalCenterNestedInputObjectSchema =
  Schema;
