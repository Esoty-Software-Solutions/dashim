...
const Schema: z.ZodType<Prisma.PatientExaminationUncheckedUpdateWithoutServiceInput> =
  z
    .object({
      id: z
        .union([
...
export const PatientExaminationUncheckedUpdateWithoutServiceInputObjectSchema =
  Schema;
