...
const Schema: z.ZodType<Prisma.PackageMedicalServicesUpdateManyWithoutBeneftiPackageNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PackageMedicalServicesUpdateManyWithoutBeneftiPackageNestedInputObjectSchema =
  Schema;
