...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutRelationshipInput> =
  z
    .object({
      id: z.string(),
...
export const BeneficiaryUncheckedCreateWithoutRelationshipInputObjectSchema =
  Schema;
