...
const Schema: z.ZodType<Prisma.EntryRecordUpdateManyWithoutFaceNestedInput> = z
  .object({
    create: z
      .union([
...
export const EntryRecordUpdateManyWithoutFaceNestedInputObjectSchema = Schema;
