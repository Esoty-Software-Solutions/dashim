...
const Schema: z.ZodType<Prisma.PackageMedicalServicesUncheckedUpdateWithoutBeneftiPackageInput> =
  z
    .object({
      id: z
        .union([
...
export const PackageMedicalServicesUncheckedUpdateWithoutBeneftiPackageInputObjectSchema =
  Schema;
