...
const Schema: z.ZodType<Prisma.BeneficiaryBalanceUpdateManyWithoutBeneftiPackageNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryBalanceUpdateManyWithoutBeneftiPackageNestedInputObjectSchema =
  Schema;
