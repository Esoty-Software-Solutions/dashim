...
const Schema: z.ZodType<Prisma.InsurancePolicyMedicalCentersCreateNestedManyWithoutInsurancePolicyInput> =
  z
    .object({
      create: z
        .union([
...
export const InsurancePolicyMedicalCentersCreateNestedManyWithoutInsurancePolicyInputObjectSchema =
  Schema;
