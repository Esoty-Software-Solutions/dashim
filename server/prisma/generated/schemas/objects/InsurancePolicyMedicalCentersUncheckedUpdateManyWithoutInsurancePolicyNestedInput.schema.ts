...
const Schema: z.ZodType<Prisma.InsurancePolicyMedicalCentersUncheckedUpdateManyWithoutInsurancePolicyNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const InsurancePolicyMedicalCentersUncheckedUpdateManyWithoutInsurancePolicyNestedInputObjectSchema =
  Schema;
