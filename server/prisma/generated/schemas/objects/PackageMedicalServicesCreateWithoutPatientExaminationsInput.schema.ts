...
const Schema: z.ZodType<Prisma.PackageMedicalServicesCreateWithoutPatientExaminationsInput> =
  z
    .object({
      id: z.string(),
...
export const PackageMedicalServicesCreateWithoutPatientExaminationsInputObjectSchema =
  Schema;
