...
const Schema: z.ZodType<Prisma.SubscriberGroupBalanceUpdateWithoutBeneftiPackageInput> =
  z
    .object({
      id: z
        .union([
...
export const SubscriberGroupBalanceUpdateWithoutBeneftiPackageInputObjectSchema =
  Schema;
