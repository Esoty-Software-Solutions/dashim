...
const Schema: z.ZodType<Prisma.EntryRecordUpdateManyWithWhereWithoutIdCardInput> =
  z
    .object({
...
export const EntryRecordUpdateManyWithWhereWithoutIdCardInputObjectSchema =
  Schema;
