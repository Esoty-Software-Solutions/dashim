...
const Schema: z.ZodType<Prisma.FingerprintBiometricUncheckedUpdateManyWithoutFingerTypeNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const FingerprintBiometricUncheckedUpdateManyWithoutFingerTypeNestedInputObjectSchema =
  Schema;
