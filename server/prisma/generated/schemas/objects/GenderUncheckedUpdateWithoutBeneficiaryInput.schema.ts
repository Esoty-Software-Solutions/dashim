...
const Schema: z.ZodType<Prisma.GenderUncheckedUpdateWithoutBeneficiaryInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const GenderUncheckedUpdateWithoutBeneficiaryInputObjectSchema = Schema;
