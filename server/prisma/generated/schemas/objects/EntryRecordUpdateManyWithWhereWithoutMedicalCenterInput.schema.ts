...
const Schema: z.ZodType<Prisma.EntryRecordUpdateManyWithWhereWithoutMedicalCenterInput> =
  z
    .object({
...
export const EntryRecordUpdateManyWithWhereWithoutMedicalCenterInputObjectSchema =
  Schema;
