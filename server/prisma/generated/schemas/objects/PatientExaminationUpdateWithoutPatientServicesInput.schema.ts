...
const Schema: z.ZodType<Prisma.PatientExaminationUpdateWithoutPatientServicesInput> =
  z
    .object({
      id: z
        .union([
...
export const PatientExaminationUpdateWithoutPatientServicesInputObjectSchema =
  Schema;
