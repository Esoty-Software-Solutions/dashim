...
const Schema: z.ZodType<Prisma.PackageMedicalServicesUncheckedCreateNestedManyWithoutBeneftiPackageInput> =
  z
    .object({
      create: z
        .union([
...
export const PackageMedicalServicesUncheckedCreateNestedManyWithoutBeneftiPackageInputObjectSchema =
  Schema;
