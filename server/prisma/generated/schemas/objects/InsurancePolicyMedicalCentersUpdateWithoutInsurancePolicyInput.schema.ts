...
const Schema: z.ZodType<Prisma.InsurancePolicyMedicalCentersUpdateWithoutInsurancePolicyInput> =
  z
    .object({
      id: z
        .union([
...
export const InsurancePolicyMedicalCentersUpdateWithoutInsurancePolicyInputObjectSchema =
  Schema;
