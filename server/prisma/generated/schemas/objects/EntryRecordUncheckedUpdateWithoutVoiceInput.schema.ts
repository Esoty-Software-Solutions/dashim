...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedUpdateWithoutVoiceInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const EntryRecordUncheckedUpdateWithoutVoiceInputObjectSchema = Schema;
