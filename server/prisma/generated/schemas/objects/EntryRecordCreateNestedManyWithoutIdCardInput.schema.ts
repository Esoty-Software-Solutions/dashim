...
const Schema: z.ZodType<Prisma.EntryRecordCreateNestedManyWithoutIdCardInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordCreateNestedManyWithoutIdCardInputObjectSchema = Schema;
