...
const Schema: z.ZodType<Prisma.PackageMedicalServicesUpdateWithoutPatientExaminationsInput> =
  z
    .object({
      id: z
        .union([
...
export const PackageMedicalServicesUpdateWithoutPatientExaminationsInputObjectSchema =
  Schema;
