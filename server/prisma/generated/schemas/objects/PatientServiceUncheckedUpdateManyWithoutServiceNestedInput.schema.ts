...
const Schema: z.ZodType<Prisma.PatientServiceUncheckedUpdateManyWithoutServiceNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PatientServiceUncheckedUpdateManyWithoutServiceNestedInputObjectSchema =
  Schema;
