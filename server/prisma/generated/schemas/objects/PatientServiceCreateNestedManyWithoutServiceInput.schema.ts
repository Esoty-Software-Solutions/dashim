...
const Schema: z.ZodType<Prisma.PatientServiceCreateNestedManyWithoutServiceInput> =
  z
    .object({
      create: z
        .union([
...
export const PatientServiceCreateNestedManyWithoutServiceInputObjectSchema =
  Schema;
