...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedCreateNestedManyWithoutSubscriberGroupInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordUncheckedCreateNestedManyWithoutSubscriberGroupInputObjectSchema =
  Schema;
