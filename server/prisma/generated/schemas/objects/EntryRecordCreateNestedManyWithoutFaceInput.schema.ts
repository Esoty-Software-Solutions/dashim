...
const Schema: z.ZodType<Prisma.EntryRecordCreateNestedManyWithoutFaceInput> = z
  .object({
    create: z
      .union([
...
export const EntryRecordCreateNestedManyWithoutFaceInputObjectSchema = Schema;
