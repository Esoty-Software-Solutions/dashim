...
const Schema: z.ZodType<Prisma.PackageMedicalServicesUncheckedCreateWithoutBeneftiPackageInput> =
  z
    .object({
      id: z.string(),
...
export const PackageMedicalServicesUncheckedCreateWithoutBeneftiPackageInputObjectSchema =
  Schema;
