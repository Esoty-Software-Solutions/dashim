...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedCreateWithoutSubscriberGroupInput> =
  z
    .object({
      id: z.string(),
...
export const EntryRecordUncheckedCreateWithoutSubscriberGroupInputObjectSchema =
  Schema;
