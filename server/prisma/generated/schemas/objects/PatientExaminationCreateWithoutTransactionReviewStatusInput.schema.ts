...
const Schema: z.ZodType<Prisma.PatientExaminationCreateWithoutTransactionReviewStatusInput> =
  z
    .object({
      id: z.string(),
...
export const PatientExaminationCreateWithoutTransactionReviewStatusInputObjectSchema =
  Schema;
