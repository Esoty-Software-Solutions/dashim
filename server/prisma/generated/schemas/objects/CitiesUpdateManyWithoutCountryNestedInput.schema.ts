...
const Schema: z.ZodType<Prisma.CitiesUpdateManyWithoutCountryNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => CitiesUpdateManyWithWhereWithoutCountryInputObjectSchema),
        z
          .lazy(() => CitiesUpdateManyWithWhereWithoutCountryInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const CitiesUpdateManyWithoutCountryNestedInputObjectSchema = Schema;
