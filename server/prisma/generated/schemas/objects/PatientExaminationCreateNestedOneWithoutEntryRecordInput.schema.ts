...
const Schema: z.ZodType<Prisma.PatientExaminationCreateNestedOneWithoutEntryRecordInput> =
  z
    .object({
      create: z
        .union([
...
export const PatientExaminationCreateNestedOneWithoutEntryRecordInputObjectSchema =
  Schema;
