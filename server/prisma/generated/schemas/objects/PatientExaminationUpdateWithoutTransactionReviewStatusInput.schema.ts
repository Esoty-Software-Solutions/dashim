...
const Schema: z.ZodType<Prisma.PatientExaminationUpdateWithoutTransactionReviewStatusInput> =
  z
    .object({
      id: z
        .union([
...
export const PatientExaminationUpdateWithoutTransactionReviewStatusInputObjectSchema =
  Schema;
