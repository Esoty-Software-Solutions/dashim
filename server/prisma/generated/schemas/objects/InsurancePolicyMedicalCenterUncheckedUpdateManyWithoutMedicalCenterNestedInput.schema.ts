...
const Schema: z.ZodType<Prisma.InsurancePolicyMedicalCenterUncheckedUpdateManyWithoutMedicalCenterNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () =>
              InsurancePolicyMedicalCenterUpsertWithWhereUniqueWithoutMedicalCenterInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      update: z
        .union([
          z.lazy(
            () =>
              InsurancePolicyMedicalCenterUpdateWithWhereUniqueWithoutMedicalCenterInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      updateMany: z
        .union([
          z.lazy(
            () =>
              InsurancePolicyMedicalCenterUpdateManyWithWhereWithoutMedicalCenterInputObjectSchema,
          ),
          z
            .lazy(
              () =>
...
export const InsurancePolicyMedicalCenterUncheckedUpdateManyWithoutMedicalCenterNestedInputObjectSchema =
  Schema;
