...
const Schema: z.ZodType<Prisma.PatientExaminationUncheckedCreateWithoutTransactionReviewStatusInput> =
  z
    .object({
      id: z.string(),
...
export const PatientExaminationUncheckedCreateWithoutTransactionReviewStatusInputObjectSchema =
  Schema;
