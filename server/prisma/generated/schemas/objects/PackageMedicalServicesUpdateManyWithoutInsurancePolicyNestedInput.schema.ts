...
const Schema: z.ZodType<Prisma.PackageMedicalServicesUpdateManyWithoutInsurancePolicyNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PackageMedicalServicesUpdateManyWithoutInsurancePolicyNestedInputObjectSchema =
  Schema;
