...
const Schema: z.ZodType<Prisma.SubscriberGroupCreateWithoutEntryRecordsInput> =
  z
    .object({
      id: z.string(),
...
export const SubscriberGroupCreateWithoutEntryRecordsInputObjectSchema = Schema;
