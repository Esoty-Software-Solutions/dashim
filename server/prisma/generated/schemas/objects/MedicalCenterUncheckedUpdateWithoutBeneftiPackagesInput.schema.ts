...
const Schema: z.ZodType<Prisma.MedicalCenterUncheckedUpdateWithoutBeneftiPackagesInput> =
  z
    .object({
      id: z
        .union([
...
export const MedicalCenterUncheckedUpdateWithoutBeneftiPackagesInputObjectSchema =
  Schema;
