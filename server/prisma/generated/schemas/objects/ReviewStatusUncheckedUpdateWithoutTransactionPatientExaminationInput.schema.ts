...
const Schema: z.ZodType<Prisma.ReviewStatusUncheckedUpdateWithoutTransactionPatientExaminationInput> =
  z
    .object({
      id: z
        .union([
...
export const ReviewStatusUncheckedUpdateWithoutTransactionPatientExaminationInputObjectSchema =
  Schema;
