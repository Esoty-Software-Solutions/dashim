...
const Schema: z.ZodType<Prisma.IDCardUncheckedCreateNestedManyWithoutBeneficiaryInput> =
  z
    .object({
      create: z
        .union([
...
export const IDCardUncheckedCreateNestedManyWithoutBeneficiaryInputObjectSchema =
  Schema;
