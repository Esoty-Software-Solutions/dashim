...
import { CountryCreateManySchema } from "../schemas/createManyCountry.schema";
...
export const countriesRouter = t.router({
  ...
  createManyCountry: publicProcedure
    .input(CountryCreateManySchema).mutation(async ({ ctx, input }) => {
      const createManyCountry = await ctx.prisma.country.createMany(input);
      return createManyCountry;
    }),
