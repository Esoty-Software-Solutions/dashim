...
async function getMany(userId: string, params?: Prisma.TenantMemberFindManyArgs) {
  return await enhancedPrisma(userId).tenantMember.findMany(params)
}

async function getOne(userId: string, params: Prisma.TenantMemberFindUniqueArgs) {
