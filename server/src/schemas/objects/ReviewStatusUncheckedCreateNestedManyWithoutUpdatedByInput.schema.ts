...
const Schema: z.ZodType<Prisma.ReviewStatusUncheckedCreateNestedManyWithoutUpdatedByInput> =
  z
    .object({
      create: z
        .union([
...
export const ReviewStatusUncheckedCreateNestedManyWithoutUpdatedByInputObjectSchema =
  Schema;
