...
const Schema: z.ZodType<Prisma.SubscriberUncheckedCreateNestedManyWithoutStatusSetByInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberUncheckedCreateNestedManyWithoutStatusSetByInputObjectSchema =
  Schema;
