...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceTemplateMinOrderByAggregateInput> =
  z
    .object({
...
export const BenefitPackageMedicalServiceTemplateMinOrderByAggregateInputObjectSchema =
  Schema;
