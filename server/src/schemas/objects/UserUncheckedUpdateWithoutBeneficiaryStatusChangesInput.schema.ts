...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutBeneficiaryStatusChangesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutBeneficiaryStatusChangesInputObjectSchema =
  Schema;
