...
const Schema: z.ZodType<Prisma.MedicalCenterUpdateManyWithoutCityNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MedicalCenterUpdateManyWithoutCityNestedInputObjectSchema = Schema;
