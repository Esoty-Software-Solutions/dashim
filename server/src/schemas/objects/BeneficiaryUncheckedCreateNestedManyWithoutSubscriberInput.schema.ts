...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedCreateNestedManyWithoutSubscriberInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryUncheckedCreateNestedManyWithoutSubscriberInputObjectSchema =
  Schema;
