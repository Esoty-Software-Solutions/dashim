...
const Schema: z.ZodType<Prisma.ReviewStatusUpdateManyWithoutMedicalReviewStatusNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ReviewStatusUpdateManyWithoutMedicalReviewStatusNestedInputObjectSchema =
  Schema;
