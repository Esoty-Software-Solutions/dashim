...
const Schema: z.ZodType<Prisma.MedicalServiceUncheckedCreateNestedManyWithoutCategoryInput> =
  z
    .object({
      create: z
        .union([
...
export const MedicalServiceUncheckedCreateNestedManyWithoutCategoryInputObjectSchema =
  Schema;
