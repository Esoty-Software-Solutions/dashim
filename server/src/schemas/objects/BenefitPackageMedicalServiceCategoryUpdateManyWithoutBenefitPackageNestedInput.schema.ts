...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryUpdateManyWithoutBenefitPackageNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BenefitPackageMedicalServiceCategoryUpdateManyWithoutBenefitPackageNestedInputObjectSchema =
  Schema;
