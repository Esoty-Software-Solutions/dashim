...
const Schema: z.ZodType<Prisma.UserUpdateWithoutSubscriberFutureStatusChangesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUpdateWithoutSubscriberFutureStatusChangesInputObjectSchema =
  Schema;
