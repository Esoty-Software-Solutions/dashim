...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryUpdateWithoutBenefitPackageInput> =
  z
    .object({
      id: z
        .union([
...
export const BenefitPackageMedicalServiceCategoryUpdateWithoutBenefitPackageInputObjectSchema =
  Schema;
