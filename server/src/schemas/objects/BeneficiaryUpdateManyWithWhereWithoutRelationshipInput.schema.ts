...
const Schema: z.ZodType<Prisma.BeneficiaryUpdateManyWithWhereWithoutRelationshipInput> =
  z
    .object({
...
export const BeneficiaryUpdateManyWithWhereWithoutRelationshipInputObjectSchema =
  Schema;
