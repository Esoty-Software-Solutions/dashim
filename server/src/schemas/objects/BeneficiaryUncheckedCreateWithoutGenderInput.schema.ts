...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutGenderInput> = z
  .object({
    id: z.string(),
...
export const BeneficiaryUncheckedCreateWithoutGenderInputObjectSchema = Schema;
