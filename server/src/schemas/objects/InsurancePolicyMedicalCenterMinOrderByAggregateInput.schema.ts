...
const Schema: z.ZodType<Prisma.InsurancePolicyMedicalCenterMinOrderByAggregateInput> =
  z
    .object({
...
export const InsurancePolicyMedicalCenterMinOrderByAggregateInputObjectSchema =
  Schema;
