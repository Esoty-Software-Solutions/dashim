...
const Schema: z.ZodType<Prisma.SubscriberUncheckedUpdateWithoutFutureStatusInput> =
  z
    .object({
      id: z
        .union([
...
export const SubscriberUncheckedUpdateWithoutFutureStatusInputObjectSchema =
  Schema;
