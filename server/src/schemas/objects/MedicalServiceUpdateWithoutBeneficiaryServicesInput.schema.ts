...
const Schema: z.ZodType<Prisma.MedicalServiceUpdateWithoutBeneficiaryServicesInput> =
  z
    .object({
      id: z
        .union([
...
export const MedicalServiceUpdateWithoutBeneficiaryServicesInputObjectSchema =
  Schema;
