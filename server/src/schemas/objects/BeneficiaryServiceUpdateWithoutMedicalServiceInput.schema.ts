...
const Schema: z.ZodType<Prisma.BeneficiaryServiceUpdateWithoutMedicalServiceInput> =
  z
    .object({
      id: z
        .union([
      ...
      CreatedBy: z
        .lazy(
          () =>
            UserUpdateOneRequiredWithoutBeneficiaryServiceCreationsNestedInputObjectSchema,
        )
        .optional(),
      UpdatedBy: z
        .lazy(
...
export const BeneficiaryServiceUpdateWithoutMedicalServiceInputObjectSchema =
  Schema;
