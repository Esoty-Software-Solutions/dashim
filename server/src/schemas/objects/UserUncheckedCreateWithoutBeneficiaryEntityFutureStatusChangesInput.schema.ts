...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutBeneficiaryEntityFutureStatusChangesInput> =
  z
    .object({
      id: z.string(),
...
export const UserUncheckedCreateWithoutBeneficiaryEntityFutureStatusChangesInputObjectSchema =
  Schema;
