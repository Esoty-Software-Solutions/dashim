...
const Schema: z.ZodType<Prisma.BeneficiaryServiceUpdateWithoutReviewStatusInput> =
  z
    .object({
      id: z
        .union([
...
export const BeneficiaryServiceUpdateWithoutReviewStatusInputObjectSchema =
  Schema;
