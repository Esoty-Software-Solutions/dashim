...
const Schema: z.ZodType<Prisma.TenantTypeEnumOrderByWithAggregationInput> = z
  .object({
    ...
    _count: z
      .lazy(() => TenantTypeEnumCountOrderByAggregateInputObjectSchema)
      .optional(),
    _max: z
      .lazy(() => TenantTypeEnumMaxOrderByAggregateInputObjectSchema)
      .optional(),
    _min: z
      .lazy(() => TenantTypeEnumMinOrderByAggregateInputObjectSchema)
      .optional(),
  })
  .strict();

export const TenantTypeEnumOrderByWithAggregationInputObjectSchema = Schema;
