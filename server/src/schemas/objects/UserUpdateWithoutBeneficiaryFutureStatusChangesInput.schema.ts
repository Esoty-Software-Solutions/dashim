...
const Schema: z.ZodType<Prisma.UserUpdateWithoutBeneficiaryFutureStatusChangesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUpdateWithoutBeneficiaryFutureStatusChangesInputObjectSchema =
  Schema;
