...
const Schema: z.ZodType<Prisma.FingerprintBiometricCreateNestedManyWithoutFingerTypeInput> =
  z
    .object({
      create: z
        .union([
...
export const FingerprintBiometricCreateNestedManyWithoutFingerTypeInputObjectSchema =
  Schema;
