...
const Schema: z.ZodType<Prisma.InsurancePolicyMedicalCenterUncheckedCreateNestedManyWithoutInsurancePolicyInput> =
  z
    .object({
      create: z
        .union([
...
export const InsurancePolicyMedicalCenterUncheckedCreateNestedManyWithoutInsurancePolicyInputObjectSchema =
  Schema;
