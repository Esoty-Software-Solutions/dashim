...
const Schema: z.ZodType<Prisma.MedicalServiceUncheckedCreateNestedManyWithoutMedicalCenterInput> =
  z
    .object({
      create: z
        .union([
...
export const MedicalServiceUncheckedCreateNestedManyWithoutMedicalCenterInputObjectSchema =
  Schema;
