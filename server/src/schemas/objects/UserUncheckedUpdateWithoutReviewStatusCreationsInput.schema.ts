...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutReviewStatusCreationsInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutReviewStatusCreationsInputObjectSchema =
  Schema;
