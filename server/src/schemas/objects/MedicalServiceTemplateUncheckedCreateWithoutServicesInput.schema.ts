...
const Schema: z.ZodType<Prisma.MedicalServiceTemplateUncheckedCreateWithoutServicesInput> =
  z
    .object({
      id: z.string(),
...
export const MedicalServiceTemplateUncheckedCreateWithoutServicesInputObjectSchema =
  Schema;
