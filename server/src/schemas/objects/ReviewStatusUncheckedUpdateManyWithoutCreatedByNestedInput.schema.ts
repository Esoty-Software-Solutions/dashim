...
const Schema: z.ZodType<Prisma.ReviewStatusUncheckedUpdateManyWithoutCreatedByNestedInput> =
  z
    .object({
      create: z
        .union([
          ...
          z
            .lazy(() => ReviewStatusCreateWithoutCreatedByInputObjectSchema)
            .array(),
          z.lazy(
      ...
      connectOrCreate: z
        .union([
          z.lazy(
            () => ReviewStatusCreateOrConnectWithoutCreatedByInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      upsert: z
        .union([
          z.lazy(
            () =>
              ReviewStatusUpsertWithWhereUniqueWithoutCreatedByInputObjectSchema,
          ),
          z
            .lazy(
              () =>
        ...
        .optional(),
      createMany: z
        .lazy(() => ReviewStatusCreateManyCreatedByInputEnvelopeObjectSchema)
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(
            () =>
              ReviewStatusUpdateWithWhereUniqueWithoutCreatedByInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      updateMany: z
        .union([
          z.lazy(
            () =>
              ReviewStatusUpdateManyWithWhereWithoutCreatedByInputObjectSchema,
          ),
          z
            .lazy(
              () =>
...
export const ReviewStatusUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema =
  Schema;
