...
const Schema: z.ZodType<Prisma.BeneficiaryFutureStatusChangeMaxOrderByAggregateInput> =
  z
    .object({
...
export const BeneficiaryFutureStatusChangeMaxOrderByAggregateInputObjectSchema =
  Schema;
