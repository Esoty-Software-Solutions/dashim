...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedCreateWithoutBeneficiaryServicesInput> =
  z
    .object({
      id: z.string(),
...
export const EntryRecordUncheckedCreateWithoutBeneficiaryServicesInputObjectSchema =
  Schema;
