...
const Schema: z.ZodType<Prisma.MedicalServiceTemplateWhereInput> = z
  .object({
    AND: z
      .union([
        z.lazy(() => MedicalServiceTemplateWhereInputObjectSchema),
        z.lazy(() => MedicalServiceTemplateWhereInputObjectSchema).array(),
      ])
      .optional(),
    OR: z
...
export const MedicalServiceTemplateWhereInputObjectSchema = Schema;
