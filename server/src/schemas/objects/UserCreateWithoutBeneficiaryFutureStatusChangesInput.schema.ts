...
const Schema: z.ZodType<Prisma.UserCreateWithoutBeneficiaryFutureStatusChangesInput> =
  z
    .object({
      id: z.string(),
...
export const UserCreateWithoutBeneficiaryFutureStatusChangesInputObjectSchema =
  Schema;
