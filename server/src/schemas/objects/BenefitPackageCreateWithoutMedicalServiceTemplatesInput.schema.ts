...
const Schema: z.ZodType<Prisma.BenefitPackageCreateWithoutMedicalServiceTemplatesInput> =
  z
    .object({
      id: z.string(),
...
export const BenefitPackageCreateWithoutMedicalServiceTemplatesInputObjectSchema =
  Schema;
