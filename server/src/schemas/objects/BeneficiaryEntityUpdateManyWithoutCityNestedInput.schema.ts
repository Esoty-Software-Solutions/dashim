...
const Schema: z.ZodType<Prisma.BeneficiaryEntityUpdateManyWithoutCityNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryEntityUpdateManyWithoutCityNestedInputObjectSchema =
  Schema;
