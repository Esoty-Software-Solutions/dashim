...
const Schema: z.ZodType<Prisma.ReviewStatusUpdateWithoutBeneficiaryServiceInput> =
  z
    .object({
      id: z
        .union([
...
export const ReviewStatusUpdateWithoutBeneficiaryServiceInputObjectSchema =
  Schema;
