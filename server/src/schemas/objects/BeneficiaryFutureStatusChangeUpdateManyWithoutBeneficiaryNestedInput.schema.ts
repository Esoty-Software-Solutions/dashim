...
const Schema: z.ZodType<Prisma.BeneficiaryFutureStatusChangeUpdateManyWithoutBeneficiaryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryFutureStatusChangeUpdateManyWithoutBeneficiaryNestedInputObjectSchema =
  Schema;
