...
const Schema: z.ZodType<Prisma.MedicalServiceTemplateCountOrderByAggregateInput> =
  z
    .object({
...
export const MedicalServiceTemplateCountOrderByAggregateInputObjectSchema =
  Schema;
