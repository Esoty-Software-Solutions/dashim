...
const Schema: z.ZodType<Prisma.InstitutionCreateWithoutMedicalCenterPricingInput> =
  z
    .object({
      id: z.string(),
...
export const InstitutionCreateWithoutMedicalCenterPricingInputObjectSchema =
  Schema;
