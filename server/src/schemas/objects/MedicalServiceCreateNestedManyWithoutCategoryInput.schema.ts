...
const Schema: z.ZodType<Prisma.MedicalServiceCreateNestedManyWithoutCategoryInput> =
  z
    .object({
      create: z
        .union([
...
export const MedicalServiceCreateNestedManyWithoutCategoryInputObjectSchema =
  Schema;
