...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutBeneficiaryServiceCreationsInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutBeneficiaryServiceCreationsInputObjectSchema =
  Schema;
