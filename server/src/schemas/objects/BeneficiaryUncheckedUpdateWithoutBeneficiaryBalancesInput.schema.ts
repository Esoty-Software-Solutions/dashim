...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedUpdateWithoutBeneficiaryBalancesInput> =
  z
    .object({
      id: z
        .union([
...
export const BeneficiaryUncheckedUpdateWithoutBeneficiaryBalancesInputObjectSchema =
  Schema;
