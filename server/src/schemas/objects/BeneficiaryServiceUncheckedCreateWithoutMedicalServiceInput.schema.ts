...
const Schema: z.ZodType<Prisma.BeneficiaryServiceUncheckedCreateWithoutMedicalServiceInput> =
  z
    .object({
      id: z.string(),
...
export const BeneficiaryServiceUncheckedCreateWithoutMedicalServiceInputObjectSchema =
  Schema;
