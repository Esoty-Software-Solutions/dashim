...
const Schema: z.ZodType<Prisma.UserCreateWithoutSubscriberStatusChangesInput> =
  z
    .object({
      id: z.string(),
...
export const UserCreateWithoutSubscriberStatusChangesInputObjectSchema = Schema;
