...
const Schema: z.ZodType<Prisma.SubscriberUncheckedUpdateManyWithoutStatusSetByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberUncheckedUpdateManyWithoutStatusSetByNestedInputObjectSchema =
  Schema;
