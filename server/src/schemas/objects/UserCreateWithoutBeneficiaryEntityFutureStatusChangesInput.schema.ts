...
const Schema: z.ZodType<Prisma.UserCreateWithoutBeneficiaryEntityFutureStatusChangesInput> =
  z
    .object({
      id: z.string(),
...
export const UserCreateWithoutBeneficiaryEntityFutureStatusChangesInputObjectSchema =
  Schema;
