...
const Schema: z.ZodType<Prisma.UserCreateWithoutBeneficiaryFutureStatusCreationsInput> =
  z
    .object({
      id: z.string(),
...
export const UserCreateWithoutBeneficiaryFutureStatusCreationsInputObjectSchema =
  Schema;
