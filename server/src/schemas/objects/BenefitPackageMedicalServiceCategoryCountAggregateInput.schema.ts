...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryCountAggregateInputType> =
  z
    .object({
...
export const BenefitPackageMedicalServiceCategoryCountAggregateInputObjectSchema =
  Schema;
