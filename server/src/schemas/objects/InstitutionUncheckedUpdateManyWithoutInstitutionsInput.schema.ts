...
const Schema: z.ZodType<Prisma.InstitutionUncheckedUpdateManyWithoutInstitutionsInput> =
  z
    .object({
      id: z
        .union([
...
export const InstitutionUncheckedUpdateManyWithoutInstitutionsInputObjectSchema =
  Schema;
