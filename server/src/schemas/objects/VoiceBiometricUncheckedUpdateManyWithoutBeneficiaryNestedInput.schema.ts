...
const Schema: z.ZodType<Prisma.VoiceBiometricUncheckedUpdateManyWithoutBeneficiaryNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () =>
              VoiceBiometricUpsertWithWhereUniqueWithoutBeneficiaryInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      update: z
        .union([
          z.lazy(
            () =>
              VoiceBiometricUpdateWithWhereUniqueWithoutBeneficiaryInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      updateMany: z
        .union([
          z.lazy(
            () =>
              VoiceBiometricUpdateManyWithWhereWithoutBeneficiaryInputObjectSchema,
          ),
          z
            .lazy(
              () =>
...
export const VoiceBiometricUncheckedUpdateManyWithoutBeneficiaryNestedInputObjectSchema =
  Schema;
