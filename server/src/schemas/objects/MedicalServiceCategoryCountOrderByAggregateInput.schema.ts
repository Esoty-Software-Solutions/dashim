...
const Schema: z.ZodType<Prisma.MedicalServiceCategoryCountOrderByAggregateInput> =
  z
    .object({
...
export const MedicalServiceCategoryCountOrderByAggregateInputObjectSchema =
  Schema;
