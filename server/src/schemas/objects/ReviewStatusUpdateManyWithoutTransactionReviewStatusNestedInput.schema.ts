...
const Schema: z.ZodType<Prisma.ReviewStatusUpdateManyWithoutTransactionReviewStatusNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ReviewStatusUpdateManyWithoutTransactionReviewStatusNestedInputObjectSchema =
  Schema;
