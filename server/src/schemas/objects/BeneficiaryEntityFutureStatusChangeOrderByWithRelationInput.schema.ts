...
const Schema: z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeOrderByWithRelationInput> =
  z
    .object({
...
export const BeneficiaryEntityFutureStatusChangeOrderByWithRelationInputObjectSchema =
  Schema;
