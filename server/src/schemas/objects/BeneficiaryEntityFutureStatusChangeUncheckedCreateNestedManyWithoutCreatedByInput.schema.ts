...
const Schema: z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeUncheckedCreateNestedManyWithoutCreatedByInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryEntityFutureStatusChangeUncheckedCreateNestedManyWithoutCreatedByInputObjectSchema =
  Schema;
