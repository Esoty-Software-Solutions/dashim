...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutSubscriberFutureStatusCreationsInput> =
  z
    .object({
      id: z.string(),
...
export const UserUncheckedCreateWithoutSubscriberFutureStatusCreationsInputObjectSchema =
  Schema;
