...
const Schema: z.ZodType<Prisma.BeneficiaryServiceUncheckedUpdateManyWithoutEntryRecordNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryServiceUncheckedUpdateManyWithoutEntryRecordNestedInputObjectSchema =
  Schema;
