...
const Schema: z.ZodType<Prisma.BeneficiaryServiceCreateNestedManyWithoutCreatedByInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryServiceCreateNestedManyWithoutCreatedByInputObjectSchema =
  Schema;
