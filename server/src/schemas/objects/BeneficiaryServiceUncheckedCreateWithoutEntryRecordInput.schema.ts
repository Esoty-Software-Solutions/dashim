...
const Schema: z.ZodType<Prisma.BeneficiaryServiceUncheckedCreateWithoutEntryRecordInput> =
  z
    .object({
      id: z.string(),
...
export const BeneficiaryServiceUncheckedCreateWithoutEntryRecordInputObjectSchema =
  Schema;
