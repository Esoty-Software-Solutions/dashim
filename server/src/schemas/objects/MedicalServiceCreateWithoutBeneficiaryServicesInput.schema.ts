...
const Schema: z.ZodType<Prisma.MedicalServiceCreateWithoutBeneficiaryServicesInput> =
  z
    .object({
      id: z.string(),
...
export const MedicalServiceCreateWithoutBeneficiaryServicesInputObjectSchema =
  Schema;
