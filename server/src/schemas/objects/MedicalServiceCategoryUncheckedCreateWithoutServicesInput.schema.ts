...
const Schema: z.ZodType<Prisma.MedicalServiceCategoryUncheckedCreateWithoutServicesInput> =
  z
    .object({
      id: z.string(),
...
export const MedicalServiceCategoryUncheckedCreateWithoutServicesInputObjectSchema =
  Schema;
