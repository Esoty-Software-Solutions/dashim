...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalCenterServiceTemplateUpdateWithoutBenefitPackageInput> =
  z
    .object({
      id: z
        .union([
...
export const BenefitPackageMedicalCenterServiceTemplateUpdateWithoutBenefitPackageInputObjectSchema =
  Schema;
