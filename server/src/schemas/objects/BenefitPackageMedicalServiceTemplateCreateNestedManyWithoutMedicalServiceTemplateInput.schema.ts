...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceTemplateCreateNestedManyWithoutMedicalServiceTemplateInput> =
  z
    .object({
      create: z
        .union([
...
export const BenefitPackageMedicalServiceTemplateCreateNestedManyWithoutMedicalServiceTemplateInputObjectSchema =
  Schema;
