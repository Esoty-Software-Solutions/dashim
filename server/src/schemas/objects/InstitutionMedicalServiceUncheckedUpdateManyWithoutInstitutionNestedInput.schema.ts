...
const Schema: z.ZodType<Prisma.InstitutionMedicalServiceUncheckedUpdateManyWithoutInstitutionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const InstitutionMedicalServiceUncheckedUpdateManyWithoutInstitutionNestedInputObjectSchema =
  Schema;
