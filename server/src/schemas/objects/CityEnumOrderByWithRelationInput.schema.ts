...
const Schema: z.ZodType<Prisma.CityEnumOrderByWithRelationInput> = z
  .object({
    ...
    country: z
      .lazy(() => CountryEnumOrderByWithRelationInputObjectSchema)
      .optional(),
    institutions: z
...
export const CityEnumOrderByWithRelationInputObjectSchema = Schema;
