...
const Schema: z.ZodType<Prisma.MedicalServiceUpdateManyWithoutMedicalCenterNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MedicalServiceUpdateManyWithoutMedicalCenterNestedInputObjectSchema =
  Schema;
