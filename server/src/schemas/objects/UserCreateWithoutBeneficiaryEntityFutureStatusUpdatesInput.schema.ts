...
const Schema: z.ZodType<Prisma.UserCreateWithoutBeneficiaryEntityFutureStatusUpdatesInput> =
  z
    .object({
      id: z.string(),
...
export const UserCreateWithoutBeneficiaryEntityFutureStatusUpdatesInputObjectSchema =
  Schema;
