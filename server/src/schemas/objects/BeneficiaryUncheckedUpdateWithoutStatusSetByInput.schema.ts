...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedUpdateWithoutStatusSetByInput> =
  z
    .object({
      id: z
        .union([
...
export const BeneficiaryUncheckedUpdateWithoutStatusSetByInputObjectSchema =
  Schema;
