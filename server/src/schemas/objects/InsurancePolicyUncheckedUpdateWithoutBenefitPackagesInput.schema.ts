...
const Schema: z.ZodType<Prisma.InsurancePolicyUncheckedUpdateWithoutBenefitPackagesInput> =
  z
    .object({
      id: z
        .union([
...
export const InsurancePolicyUncheckedUpdateWithoutBenefitPackagesInputObjectSchema =
  Schema;
