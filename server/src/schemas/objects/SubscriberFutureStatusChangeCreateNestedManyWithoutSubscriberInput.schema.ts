...
const Schema: z.ZodType<Prisma.SubscriberFutureStatusChangeCreateNestedManyWithoutSubscriberInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberFutureStatusChangeCreateNestedManyWithoutSubscriberInputObjectSchema =
  Schema;
