...
const Schema: z.ZodType<Prisma.MedicalServiceCategoryUncheckedUpdateWithoutServicesInput> =
  z
    .object({
      id: z
        .union([
...
export const MedicalServiceCategoryUncheckedUpdateWithoutServicesInputObjectSchema =
  Schema;
