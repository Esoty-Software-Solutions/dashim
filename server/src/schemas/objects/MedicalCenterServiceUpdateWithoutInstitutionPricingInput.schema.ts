...
const Schema: z.ZodType<Prisma.MedicalCenterServiceUpdateWithoutInstitutionPricingInput> =
  z
    .object({
      id: z
        .union([
...
export const MedicalCenterServiceUpdateWithoutInstitutionPricingInputObjectSchema =
  Schema;
