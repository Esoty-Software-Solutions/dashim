...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryMaxAggregateInputType> =
  z
    .object({
...
export const BenefitPackageMedicalServiceCategoryMaxAggregateInputObjectSchema =
  Schema;
