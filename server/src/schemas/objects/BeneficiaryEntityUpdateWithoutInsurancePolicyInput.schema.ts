...
const Schema: z.ZodType<Prisma.BeneficiaryEntityUpdateWithoutInsurancePolicyInput> =
  z
    .object({
      id: z
        .union([
...
export const BeneficiaryEntityUpdateWithoutInsurancePolicyInputObjectSchema =
  Schema;
