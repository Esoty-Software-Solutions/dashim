...
const Schema: z.ZodType<Prisma.UserCreateWithoutBeneficiaryEntityFutureStatusCreationsInput> =
  z
    .object({
      id: z.string(),
      ...
      EntryRecordServiceCreations: z
        .lazy(
          () => EntryRecordCreateNestedManyWithoutCreatedByInputObjectSchema,
        )
        .optional(),
      EntryRecordServiceUpdates: z
        .lazy(
          () => EntryRecordCreateNestedManyWithoutUpdatedByInputObjectSchema,
        )
        .optional(),
    })
    .strict();

export const UserCreateWithoutBeneficiaryEntityFutureStatusCreationsInputObjectSchema =
  Schema;
