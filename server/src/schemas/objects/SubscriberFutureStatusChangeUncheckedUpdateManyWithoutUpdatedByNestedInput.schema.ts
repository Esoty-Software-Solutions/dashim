...
const Schema: z.ZodType<Prisma.SubscriberFutureStatusChangeUncheckedUpdateManyWithoutUpdatedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberFutureStatusChangeUncheckedUpdateManyWithoutUpdatedByNestedInputObjectSchema =
  Schema;
