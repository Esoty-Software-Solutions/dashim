...
const Schema: z.ZodType<Prisma.BeneficiaryServiceUpdateManyWithoutUpdatedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryServiceUpdateManyWithoutUpdatedByNestedInputObjectSchema =
  Schema;
