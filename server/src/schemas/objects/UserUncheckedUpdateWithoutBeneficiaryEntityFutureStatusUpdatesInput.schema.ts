...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutBeneficiaryEntityFutureStatusUpdatesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutBeneficiaryEntityFutureStatusUpdatesInputObjectSchema =
  Schema;
