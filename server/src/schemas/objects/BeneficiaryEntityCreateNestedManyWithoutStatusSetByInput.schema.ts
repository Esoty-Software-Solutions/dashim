...
const Schema: z.ZodType<Prisma.BeneficiaryEntityCreateNestedManyWithoutStatusSetByInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryEntityCreateNestedManyWithoutStatusSetByInputObjectSchema =
  Schema;
