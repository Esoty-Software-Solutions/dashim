...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedCreateNestedManyWithoutVoiceBiometricInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordUncheckedCreateNestedManyWithoutVoiceBiometricInputObjectSchema =
  Schema;
