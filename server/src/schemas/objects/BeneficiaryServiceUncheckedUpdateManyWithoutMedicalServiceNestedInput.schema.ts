...
const Schema: z.ZodType<Prisma.BeneficiaryServiceUncheckedUpdateManyWithoutMedicalServiceNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryServiceUncheckedUpdateManyWithoutMedicalServiceNestedInputObjectSchema =
  Schema;
