...
const Schema: z.ZodType<Prisma.ReviewStatusEnumUncheckedUpdateWithoutMedicalBeneficiaryServicesInput> =
  z
    .object({
      id: z
        .union([
...
export const ReviewStatusEnumUncheckedUpdateWithoutMedicalBeneficiaryServicesInputObjectSchema =
  Schema;
