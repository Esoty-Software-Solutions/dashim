...
const Schema: z.ZodType<Prisma.BeneficiaryCreateNestedManyWithoutStatusSetByInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryCreateNestedManyWithoutStatusSetByInputObjectSchema =
  Schema;
