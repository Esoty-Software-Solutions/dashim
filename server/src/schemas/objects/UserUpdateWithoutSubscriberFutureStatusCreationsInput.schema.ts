...
const Schema: z.ZodType<Prisma.UserUpdateWithoutSubscriberFutureStatusCreationsInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUpdateWithoutSubscriberFutureStatusCreationsInputObjectSchema =
  Schema;
