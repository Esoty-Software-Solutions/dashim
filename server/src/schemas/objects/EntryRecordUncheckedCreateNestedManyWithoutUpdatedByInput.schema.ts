...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedCreateNestedManyWithoutUpdatedByInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordUncheckedCreateNestedManyWithoutUpdatedByInputObjectSchema =
  Schema;
