...
const Schema: z.ZodType<Prisma.EntryRecordUpdateManyWithWhereWithoutFaceBiometricInput> =
  z
    .object({
...
export const EntryRecordUpdateManyWithWhereWithoutFaceBiometricInputObjectSchema =
  Schema;
