...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutBeneficiaryFutureStatusCreationsInput> =
  z
    .object({
      id: z.string(),
...
export const UserUncheckedCreateWithoutBeneficiaryFutureStatusCreationsInputObjectSchema =
  Schema;
