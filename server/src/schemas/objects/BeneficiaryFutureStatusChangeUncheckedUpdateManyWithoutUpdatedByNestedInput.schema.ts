...
const Schema: z.ZodType<Prisma.BeneficiaryFutureStatusChangeUncheckedUpdateManyWithoutUpdatedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryFutureStatusChangeUncheckedUpdateManyWithoutUpdatedByNestedInputObjectSchema =
  Schema;
