...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryUncheckedUpdateManyWithoutMedicalServiceCategoryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BenefitPackageMedicalServiceCategoryUncheckedUpdateManyWithoutMedicalServiceCategoryNestedInputObjectSchema =
  Schema;
