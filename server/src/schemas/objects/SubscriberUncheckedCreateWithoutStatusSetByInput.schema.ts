...
const Schema: z.ZodType<Prisma.SubscriberUncheckedCreateWithoutStatusSetByInput> =
  z
    .object({
      id: z.string(),
...
export const SubscriberUncheckedCreateWithoutStatusSetByInputObjectSchema =
  Schema;
