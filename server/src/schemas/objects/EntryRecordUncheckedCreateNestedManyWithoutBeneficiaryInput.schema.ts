...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedCreateNestedManyWithoutBeneficiaryInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordUncheckedCreateNestedManyWithoutBeneficiaryInputObjectSchema =
  Schema;
