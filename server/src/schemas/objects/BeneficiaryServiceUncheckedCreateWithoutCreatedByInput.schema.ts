...
const Schema: z.ZodType<Prisma.BeneficiaryServiceUncheckedCreateWithoutCreatedByInput> =
  z
    .object({
      id: z.string(),
...
export const BeneficiaryServiceUncheckedCreateWithoutCreatedByInputObjectSchema =
  Schema;
