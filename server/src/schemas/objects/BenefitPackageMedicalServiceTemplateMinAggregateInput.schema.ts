...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceTemplateMinAggregateInputType> =
  z
    .object({
...
export const BenefitPackageMedicalServiceTemplateMinAggregateInputObjectSchema =
  Schema;
