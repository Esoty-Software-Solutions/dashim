...
const Schema: z.ZodType<Prisma.MedicalServiceUncheckedUpdateWithoutInstitutionPricingInput> =
  z
    .object({
      id: z
        .union([
...
export const MedicalServiceUncheckedUpdateWithoutInstitutionPricingInputObjectSchema =
  Schema;
