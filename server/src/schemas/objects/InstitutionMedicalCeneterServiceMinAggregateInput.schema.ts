...
const Schema: z.ZodType<Prisma.InstitutionMedicalCeneterServiceMinAggregateInputType> =
  z
    .object({
...
export const InstitutionMedicalCeneterServiceMinAggregateInputObjectSchema =
  Schema;
