...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalCenterServiceTemplateCreateWithoutMedicalCenterServiceTemplateInput> =
  z
    .object({
      id: z.string(),
...
export const BenefitPackageMedicalCenterServiceTemplateCreateWithoutMedicalCenterServiceTemplateInputObjectSchema =
  Schema;
