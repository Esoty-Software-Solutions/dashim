...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceTemplateCreateNestedManyWithoutBenefitPackageInput> =
  z
    .object({
      create: z
        .union([
...
export const BenefitPackageMedicalServiceTemplateCreateNestedManyWithoutBenefitPackageInputObjectSchema =
  Schema;
