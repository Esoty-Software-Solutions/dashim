...
const Schema: z.ZodType<Prisma.BenefitPackageUncheckedUpdateWithoutMedicalServiceTemplatesInput> =
  z
    .object({
      id: z
        .union([
...
export const BenefitPackageUncheckedUpdateWithoutMedicalServiceTemplatesInputObjectSchema =
  Schema;
