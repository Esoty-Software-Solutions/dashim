...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutEntryRecordServiceUpdatesInput> =
  z
    .object({
      id: z.string(),
...
export const UserUncheckedCreateWithoutEntryRecordServiceUpdatesInputObjectSchema =
  Schema;
