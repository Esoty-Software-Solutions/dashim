...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalCenterServiceTemplateCreateNestedManyWithoutBenefitPackageInput> =
  z
    .object({
      create: z
        .union([
...
export const BenefitPackageMedicalCenterServiceTemplateCreateNestedManyWithoutBenefitPackageInputObjectSchema =
  Schema;
