...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutBeneficiaryEntityStatusChangesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutBeneficiaryEntityStatusChangesInputObjectSchema =
  Schema;
