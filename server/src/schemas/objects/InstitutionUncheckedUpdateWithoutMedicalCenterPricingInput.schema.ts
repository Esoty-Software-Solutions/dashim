...
const Schema: z.ZodType<Prisma.InstitutionUncheckedUpdateWithoutMedicalCenterPricingInput> =
  z
    .object({
      id: z
        .union([
...
export const InstitutionUncheckedUpdateWithoutMedicalCenterPricingInputObjectSchema =
  Schema;
