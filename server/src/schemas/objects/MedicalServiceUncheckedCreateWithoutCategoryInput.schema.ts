...
const Schema: z.ZodType<Prisma.MedicalServiceUncheckedCreateWithoutCategoryInput> =
  z
    .object({
      id: z.string(),
...
export const MedicalServiceUncheckedCreateWithoutCategoryInputObjectSchema =
  Schema;
