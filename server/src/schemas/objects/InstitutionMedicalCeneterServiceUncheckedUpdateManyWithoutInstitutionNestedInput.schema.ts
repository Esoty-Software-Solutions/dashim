...
const Schema: z.ZodType<Prisma.InstitutionMedicalCeneterServiceUncheckedUpdateManyWithoutInstitutionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const InstitutionMedicalCeneterServiceUncheckedUpdateManyWithoutInstitutionNestedInputObjectSchema =
  Schema;
