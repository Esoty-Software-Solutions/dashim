...
const Schema: z.ZodType<Prisma.BeneficiaryEntityCountOrderByAggregateInput> = z
  .object({
...
export const BeneficiaryEntityCountOrderByAggregateInputObjectSchema = Schema;
