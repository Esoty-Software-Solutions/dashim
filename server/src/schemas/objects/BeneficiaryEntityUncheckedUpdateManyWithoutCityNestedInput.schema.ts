...
const Schema: z.ZodType<Prisma.BeneficiaryEntityUncheckedUpdateManyWithoutCityNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () =>
              BeneficiaryEntityUpsertWithWhereUniqueWithoutCityInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      update: z
        .union([
          z.lazy(
            () =>
              BeneficiaryEntityUpdateWithWhereUniqueWithoutCityInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      updateMany: z
        .union([
          z.lazy(
            () =>
              BeneficiaryEntityUpdateManyWithWhereWithoutCityInputObjectSchema,
          ),
          z
            .lazy(
              () =>
...
export const BeneficiaryEntityUncheckedUpdateManyWithoutCityNestedInputObjectSchema =
  Schema;
