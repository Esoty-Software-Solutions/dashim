...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutSubscriberFutureStatusChangesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutSubscriberFutureStatusChangesInputObjectSchema =
  Schema;
