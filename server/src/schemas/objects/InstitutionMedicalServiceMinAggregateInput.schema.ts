...
const Schema: z.ZodType<Prisma.InstitutionMedicalServiceMinAggregateInputType> =
  z
    .object({
...
export const InstitutionMedicalServiceMinAggregateInputObjectSchema = Schema;
