...
const Schema: z.ZodType<Prisma.BeneficiaryServiceUpdateWithoutUpdatedByInput> =
  z
    .object({
      id: z
        .union([
...
export const BeneficiaryServiceUpdateWithoutUpdatedByInputObjectSchema = Schema;
