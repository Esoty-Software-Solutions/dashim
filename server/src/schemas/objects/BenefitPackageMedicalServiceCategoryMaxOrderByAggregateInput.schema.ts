...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryMaxOrderByAggregateInput> =
  z
    .object({
...
export const BenefitPackageMedicalServiceCategoryMaxOrderByAggregateInputObjectSchema =
  Schema;
