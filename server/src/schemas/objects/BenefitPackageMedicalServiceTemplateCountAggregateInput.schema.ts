...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceTemplateCountAggregateInputType> =
  z
    .object({
...
export const BenefitPackageMedicalServiceTemplateCountAggregateInputObjectSchema =
  Schema;
