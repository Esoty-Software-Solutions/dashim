...
const Schema: z.ZodType<Prisma.CityEnumCreateNestedManyWithoutCountryInput> = z
  .object({
    create: z
      .union([
...
export const CityEnumCreateNestedManyWithoutCountryInputObjectSchema = Schema;
