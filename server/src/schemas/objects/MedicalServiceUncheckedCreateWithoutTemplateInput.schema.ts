...
const Schema: z.ZodType<Prisma.MedicalServiceUncheckedCreateWithoutTemplateInput> =
  z
    .object({
      id: z.string(),
...
export const MedicalServiceUncheckedCreateWithoutTemplateInputObjectSchema =
  Schema;
