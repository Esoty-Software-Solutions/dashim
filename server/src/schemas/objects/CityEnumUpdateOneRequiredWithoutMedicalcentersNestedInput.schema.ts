...
const Schema: z.ZodType<Prisma.CityEnumUpdateOneRequiredWithoutMedicalcentersNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      connectOrCreate: z
        ...
        .optional(),
      upsert: z
        .lazy(() => CityEnumUpsertWithoutMedicalcentersInputObjectSchema)
        .optional(),
...
export const CityEnumUpdateOneRequiredWithoutMedicalcentersNestedInputObjectSchema =
  Schema;
