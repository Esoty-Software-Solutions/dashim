...
const Schema: z.ZodType<Prisma.BeneficiaryEntityUncheckedUpdateWithoutInsurancePolicyInput> =
  z
    .object({
      id: z
        .union([
      ...
      beneficiaries: z
        .lazy(
          () =>
            BeneficiaryUncheckedUpdateManyWithoutBeneficiaryEntityNestedInputObjectSchema,
        )
        .optional(),
      futureStatus: z
        .lazy(
...
export const BeneficiaryEntityUncheckedUpdateWithoutInsurancePolicyInputObjectSchema =
  Schema;
