...
const Schema: z.ZodType<Prisma.UserUpdateWithoutBeneficiaryEntityFutureStatusChangesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUpdateWithoutBeneficiaryEntityFutureStatusChangesInputObjectSchema =
  Schema;
