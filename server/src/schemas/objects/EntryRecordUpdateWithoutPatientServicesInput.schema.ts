...
const Schema: z.ZodType<Prisma.EntryRecordUpdateWithoutPatientServicesInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const EntryRecordUpdateWithoutPatientServicesInputObjectSchema = Schema;
