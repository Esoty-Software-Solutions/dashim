...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutBeneficiaryFutureStatusChangesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutBeneficiaryFutureStatusChangesInputObjectSchema =
  Schema;
