...
const Schema: z.ZodType<Prisma.SubscriberUncheckedCreateWithoutFutureStatusInput> =
  z
    .object({
      id: z.string(),
...
export const SubscriberUncheckedCreateWithoutFutureStatusInputObjectSchema =
  Schema;
