...
const Schema: z.ZodType<Prisma.CityEnumOrderByWithAggregationInput> = z
  .object({
    ...
    _count: z
      .lazy(() => CityEnumCountOrderByAggregateInputObjectSchema)
      .optional(),
...
export const CityEnumOrderByWithAggregationInputObjectSchema = Schema;
