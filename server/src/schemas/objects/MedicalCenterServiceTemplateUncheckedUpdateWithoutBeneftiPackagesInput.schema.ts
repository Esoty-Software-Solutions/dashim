...
const Schema: z.ZodType<Prisma.MedicalCenterServiceTemplateUncheckedUpdateWithoutBeneftiPackagesInput> =
  z
    .object({
      id: z
        .union([
...
export const MedicalCenterServiceTemplateUncheckedUpdateWithoutBeneftiPackagesInputObjectSchema =
  Schema;
