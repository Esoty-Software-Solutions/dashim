...
const Schema: z.ZodType<Prisma.CityEnumUncheckedUpdateManyWithoutCountryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CityEnumUncheckedUpdateManyWithoutCountryNestedInputObjectSchema =
  Schema;
