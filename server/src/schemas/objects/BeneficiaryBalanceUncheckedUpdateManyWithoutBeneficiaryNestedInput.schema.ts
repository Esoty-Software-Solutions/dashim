...
const Schema: z.ZodType<Prisma.BeneficiaryBalanceUncheckedUpdateManyWithoutBeneficiaryNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () =>
              BeneficiaryBalanceUpsertWithWhereUniqueWithoutBeneficiaryInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      update: z
        .union([
          z.lazy(
            () =>
              BeneficiaryBalanceUpdateWithWhereUniqueWithoutBeneficiaryInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      updateMany: z
        .union([
          z.lazy(
            () =>
              BeneficiaryBalanceUpdateManyWithWhereWithoutBeneficiaryInputObjectSchema,
          ),
          z
            .lazy(
              () =>
...
export const BeneficiaryBalanceUncheckedUpdateManyWithoutBeneficiaryNestedInputObjectSchema =
  Schema;
