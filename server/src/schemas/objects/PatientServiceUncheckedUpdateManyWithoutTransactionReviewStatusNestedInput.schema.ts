...
const Schema: z.ZodType<Prisma.PatientServiceUncheckedUpdateManyWithoutTransactionReviewStatusNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PatientServiceUncheckedUpdateManyWithoutTransactionReviewStatusNestedInputObjectSchema =
  Schema;
