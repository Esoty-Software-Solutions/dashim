...
const Schema: z.ZodType<Prisma.InstitutionMedicalCeneterServiceMinOrderByAggregateInput> =
  z
    .object({
...
export const InstitutionMedicalCeneterServiceMinOrderByAggregateInputObjectSchema =
  Schema;
