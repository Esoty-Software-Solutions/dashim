...
const Schema: z.ZodType<Prisma.BeneficiaryServiceUncheckedCreateWithoutReviewStatusInput> =
  z
    .object({
      id: z.string(),
...
export const BeneficiaryServiceUncheckedCreateWithoutReviewStatusInputObjectSchema =
  Schema;
