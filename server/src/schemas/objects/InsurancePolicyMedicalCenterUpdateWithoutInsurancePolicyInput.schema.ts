...
const Schema: z.ZodType<Prisma.InsurancePolicyMedicalCenterUpdateWithoutInsurancePolicyInput> =
  z
    .object({
      id: z
        .union([
...
export const InsurancePolicyMedicalCenterUpdateWithoutInsurancePolicyInputObjectSchema =
  Schema;
