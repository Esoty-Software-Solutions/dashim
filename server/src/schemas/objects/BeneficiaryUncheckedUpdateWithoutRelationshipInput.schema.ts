...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedUpdateWithoutRelationshipInput> =
  z
    .object({
      id: z
        .union([
...
export const BeneficiaryUncheckedUpdateWithoutRelationshipInputObjectSchema =
  Schema;
