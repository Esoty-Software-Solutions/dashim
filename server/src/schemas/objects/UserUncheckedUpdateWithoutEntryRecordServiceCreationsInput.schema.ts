...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutEntryRecordServiceCreationsInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutEntryRecordServiceCreationsInputObjectSchema =
  Schema;
