...
const Schema: z.ZodType<Prisma.UserUpdateWithoutSubscriberStatusChangesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUpdateWithoutSubscriberStatusChangesInputObjectSchema = Schema;
