...
const Schema: z.ZodType<Prisma.PatientServiceUncheckedCreateWithoutTransactionReviewStatusInput> =
  z
    .object({
      id: z.string(),
...
export const PatientServiceUncheckedCreateWithoutTransactionReviewStatusInputObjectSchema =
  Schema;
