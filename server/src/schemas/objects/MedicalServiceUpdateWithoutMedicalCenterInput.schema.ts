...
const Schema: z.ZodType<Prisma.MedicalServiceUpdateWithoutMedicalCenterInput> =
  z
    .object({
      id: z
        .union([
...
export const MedicalServiceUpdateWithoutMedicalCenterInputObjectSchema = Schema;
