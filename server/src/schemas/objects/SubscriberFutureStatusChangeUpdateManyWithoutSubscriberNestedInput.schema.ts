...
const Schema: z.ZodType<Prisma.SubscriberFutureStatusChangeUpdateManyWithoutSubscriberNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberFutureStatusChangeUpdateManyWithoutSubscriberNestedInputObjectSchema =
  Schema;
