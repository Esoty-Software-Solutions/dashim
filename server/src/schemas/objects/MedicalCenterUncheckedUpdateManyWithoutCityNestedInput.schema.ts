...
const Schema: z.ZodType<Prisma.MedicalCenterUncheckedUpdateManyWithoutCityNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () =>
              MedicalCenterUpsertWithWhereUniqueWithoutCityInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      update: z
        .union([
          z.lazy(
            () =>
              MedicalCenterUpdateWithWhereUniqueWithoutCityInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      updateMany: z
        .union([
          z.lazy(
            () => MedicalCenterUpdateManyWithWhereWithoutCityInputObjectSchema,
          ),
          z
            .lazy(
              () =>
...
export const MedicalCenterUncheckedUpdateManyWithoutCityNestedInputObjectSchema =
  Schema;
