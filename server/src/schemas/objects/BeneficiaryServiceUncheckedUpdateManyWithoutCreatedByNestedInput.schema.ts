...
const Schema: z.ZodType<Prisma.BeneficiaryServiceUncheckedUpdateManyWithoutCreatedByNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () =>
              BeneficiaryServiceUpsertWithWhereUniqueWithoutCreatedByInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      update: z
        .union([
          z.lazy(
            () =>
              BeneficiaryServiceUpdateWithWhereUniqueWithoutCreatedByInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      updateMany: z
        .union([
          z.lazy(
            () =>
              BeneficiaryServiceUpdateManyWithWhereWithoutCreatedByInputObjectSchema,
          ),
          z
            .lazy(
              () =>
...
export const BeneficiaryServiceUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema =
  Schema;
