...
const Schema: z.ZodType<Prisma.UserUpdateWithoutBeneficiaryServiceCreationsInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUpdateWithoutBeneficiaryServiceCreationsInputObjectSchema =
  Schema;
