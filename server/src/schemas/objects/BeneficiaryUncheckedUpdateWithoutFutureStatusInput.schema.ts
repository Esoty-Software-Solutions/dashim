...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedUpdateWithoutFutureStatusInput> =
  z
    .object({
      id: z
        .union([
...
export const BeneficiaryUncheckedUpdateWithoutFutureStatusInputObjectSchema =
  Schema;
