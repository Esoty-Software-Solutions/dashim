...
const Schema: z.ZodType<Prisma.VoiceBiometricUpdateManyWithoutBeneficiaryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const VoiceBiometricUpdateManyWithoutBeneficiaryNestedInputObjectSchema =
  Schema;
