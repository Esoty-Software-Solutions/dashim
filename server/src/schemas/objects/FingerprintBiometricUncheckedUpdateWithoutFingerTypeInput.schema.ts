...
const Schema: z.ZodType<Prisma.FingerprintBiometricUncheckedUpdateWithoutFingerTypeInput> =
  z
    .object({
      id: z
        .union([
...
export const FingerprintBiometricUncheckedUpdateWithoutFingerTypeInputObjectSchema =
  Schema;
