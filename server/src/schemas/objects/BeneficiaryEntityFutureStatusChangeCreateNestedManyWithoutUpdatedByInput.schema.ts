...
const Schema: z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeCreateNestedManyWithoutUpdatedByInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryEntityFutureStatusChangeCreateNestedManyWithoutUpdatedByInputObjectSchema =
  Schema;
