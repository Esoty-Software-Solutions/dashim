...
const Schema: z.ZodType<Prisma.BeneficiaryEntityUpdateManyWithoutStatusSetByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryEntityUpdateManyWithoutStatusSetByNestedInputObjectSchema =
  Schema;
