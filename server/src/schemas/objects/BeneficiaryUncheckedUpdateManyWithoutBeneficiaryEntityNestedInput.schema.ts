...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedUpdateManyWithoutBeneficiaryEntityNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () =>
              BeneficiaryUpsertWithWhereUniqueWithoutBeneficiaryEntityInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      update: z
        .union([
          z.lazy(
            () =>
              BeneficiaryUpdateWithWhereUniqueWithoutBeneficiaryEntityInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      updateMany: z
        .union([
          z.lazy(
            () =>
              BeneficiaryUpdateManyWithWhereWithoutBeneficiaryEntityInputObjectSchema,
          ),
          z
            .lazy(
              () =>
...
export const BeneficiaryUncheckedUpdateManyWithoutBeneficiaryEntityNestedInputObjectSchema =
  Schema;
