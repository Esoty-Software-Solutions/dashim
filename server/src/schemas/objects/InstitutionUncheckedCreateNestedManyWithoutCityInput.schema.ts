...
const Schema: z.ZodType<Prisma.InstitutionUncheckedCreateNestedManyWithoutCityInput> =
  z
    .object({
      create: z
        .union([
...
export const InstitutionUncheckedCreateNestedManyWithoutCityInputObjectSchema =
  Schema;
