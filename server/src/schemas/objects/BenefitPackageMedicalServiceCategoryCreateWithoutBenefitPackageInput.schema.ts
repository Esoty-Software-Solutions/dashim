...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryCreateWithoutBenefitPackageInput> =
  z
    .object({
      id: z.string(),
...
export const BenefitPackageMedicalServiceCategoryCreateWithoutBenefitPackageInputObjectSchema =
  Schema;
