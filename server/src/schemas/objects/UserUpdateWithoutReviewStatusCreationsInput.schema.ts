...
const Schema: z.ZodType<Prisma.UserUpdateWithoutReviewStatusCreationsInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const UserUpdateWithoutReviewStatusCreationsInputObjectSchema = Schema;
