...
const Schema: z.ZodType<Prisma.InsurancePolicyMedicalCenterOrderByWithRelationInput> =
  z
    .object({
...
export const InsurancePolicyMedicalCenterOrderByWithRelationInputObjectSchema =
  Schema;
