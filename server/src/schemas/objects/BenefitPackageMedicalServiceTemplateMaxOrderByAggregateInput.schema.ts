...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceTemplateMaxOrderByAggregateInput> =
  z
    .object({
...
export const BenefitPackageMedicalServiceTemplateMaxOrderByAggregateInputObjectSchema =
  Schema;
