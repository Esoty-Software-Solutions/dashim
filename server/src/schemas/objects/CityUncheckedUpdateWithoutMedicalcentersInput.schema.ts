...
const Schema: z.ZodType<Prisma.CityUncheckedUpdateWithoutMedicalcentersInput> =
  z
    .object({
      id: z
        .union([
...
export const CityUncheckedUpdateWithoutMedicalcentersInputObjectSchema = Schema;
