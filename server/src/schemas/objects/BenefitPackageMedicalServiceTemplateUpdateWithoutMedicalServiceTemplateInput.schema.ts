...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceTemplateUpdateWithoutMedicalServiceTemplateInput> =
  z
    .object({
      id: z
        .union([
...
export const BenefitPackageMedicalServiceTemplateUpdateWithoutMedicalServiceTemplateInputObjectSchema =
  Schema;
