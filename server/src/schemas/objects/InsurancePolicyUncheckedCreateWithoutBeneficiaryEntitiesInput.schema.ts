...
const Schema: z.ZodType<Prisma.InsurancePolicyUncheckedCreateWithoutBeneficiaryEntitiesInput> =
  z
    .object({
      id: z.string(),
...
export const InsurancePolicyUncheckedCreateWithoutBeneficiaryEntitiesInputObjectSchema =
  Schema;
