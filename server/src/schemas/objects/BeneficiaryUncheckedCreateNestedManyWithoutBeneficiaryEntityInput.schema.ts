...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedCreateNestedManyWithoutBeneficiaryEntityInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryUncheckedCreateNestedManyWithoutBeneficiaryEntityInputObjectSchema =
  Schema;
