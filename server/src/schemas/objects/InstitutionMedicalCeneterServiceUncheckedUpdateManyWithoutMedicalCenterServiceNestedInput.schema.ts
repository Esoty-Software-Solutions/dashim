...
const Schema: z.ZodType<Prisma.InstitutionMedicalCeneterServiceUncheckedUpdateManyWithoutMedicalCenterServiceNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const InstitutionMedicalCeneterServiceUncheckedUpdateManyWithoutMedicalCenterServiceNestedInputObjectSchema =
  Schema;
