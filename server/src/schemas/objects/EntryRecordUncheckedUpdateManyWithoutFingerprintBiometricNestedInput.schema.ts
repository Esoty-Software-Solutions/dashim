...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedUpdateManyWithoutFingerprintBiometricNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordUncheckedUpdateManyWithoutFingerprintBiometricNestedInputObjectSchema =
  Schema;
