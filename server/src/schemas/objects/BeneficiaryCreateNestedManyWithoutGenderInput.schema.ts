...
const Schema: z.ZodType<Prisma.BeneficiaryCreateNestedManyWithoutGenderInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryCreateNestedManyWithoutGenderInputObjectSchema = Schema;
