...
const Schema: z.ZodType<Prisma.UserCreateWithoutEntryRecordServiceCreationsInput> =
  z
    .object({
      id: z.string(),
...
export const UserCreateWithoutEntryRecordServiceCreationsInputObjectSchema =
  Schema;
