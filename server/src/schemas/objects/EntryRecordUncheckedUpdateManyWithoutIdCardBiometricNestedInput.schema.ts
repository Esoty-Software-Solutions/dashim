...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedUpdateManyWithoutIdCardBiometricNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordUncheckedUpdateManyWithoutIdCardBiometricNestedInputObjectSchema =
  Schema;
