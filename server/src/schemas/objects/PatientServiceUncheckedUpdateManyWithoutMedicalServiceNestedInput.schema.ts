...
const Schema: z.ZodType<Prisma.PatientServiceUncheckedUpdateManyWithoutMedicalServiceNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PatientServiceUncheckedUpdateManyWithoutMedicalServiceNestedInputObjectSchema =
  Schema;
