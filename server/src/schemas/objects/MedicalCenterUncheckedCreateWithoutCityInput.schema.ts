...
const Schema: z.ZodType<Prisma.MedicalCenterUncheckedCreateWithoutCityInput> = z
  .object({
    id: z.string(),
...
export const MedicalCenterUncheckedCreateWithoutCityInputObjectSchema = Schema;
