...
const Schema: z.ZodType<Prisma.MedicalCenterUncheckedCreateNestedManyWithoutCityInput> =
  z
    .object({
      create: z
        .union([
...
export const MedicalCenterUncheckedCreateNestedManyWithoutCityInputObjectSchema =
  Schema;
