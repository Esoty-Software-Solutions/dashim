...
const Schema: z.ZodType<Prisma.BeneficiaryFutureStatusChangeMinOrderByAggregateInput> =
  z
    .object({
...
export const BeneficiaryFutureStatusChangeMinOrderByAggregateInputObjectSchema =
  Schema;
