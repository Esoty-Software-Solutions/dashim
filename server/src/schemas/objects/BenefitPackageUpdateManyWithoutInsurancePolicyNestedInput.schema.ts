...
const Schema: z.ZodType<Prisma.BenefitPackageUpdateManyWithoutInsurancePolicyNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BenefitPackageUpdateManyWithoutInsurancePolicyNestedInputObjectSchema =
  Schema;
