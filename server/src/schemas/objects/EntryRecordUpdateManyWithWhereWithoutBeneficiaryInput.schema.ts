...
const Schema: z.ZodType<Prisma.EntryRecordUpdateManyWithWhereWithoutBeneficiaryInput> =
  z
    .object({
...
export const EntryRecordUpdateManyWithWhereWithoutBeneficiaryInputObjectSchema =
  Schema;
