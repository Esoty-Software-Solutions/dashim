...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceTemplateUncheckedUpdateManyWithoutBenefitPackageNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BenefitPackageMedicalServiceTemplateUncheckedUpdateManyWithoutBenefitPackageNestedInputObjectSchema =
  Schema;
