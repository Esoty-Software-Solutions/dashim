...
const Schema: z.ZodType<Prisma.ReviewStatusCreateNestedManyWithoutTransactionReviewStatusInput> =
  z
    .object({
      create: z
        .union([
...
export const ReviewStatusCreateNestedManyWithoutTransactionReviewStatusInputObjectSchema =
  Schema;
