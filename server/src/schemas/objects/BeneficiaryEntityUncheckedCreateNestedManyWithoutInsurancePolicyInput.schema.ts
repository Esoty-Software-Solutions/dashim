...
const Schema: z.ZodType<Prisma.BeneficiaryEntityUncheckedCreateNestedManyWithoutInsurancePolicyInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryEntityUncheckedCreateNestedManyWithoutInsurancePolicyInputObjectSchema =
  Schema;
