...
const Schema: z.ZodType<Prisma.BeneficiaryUpdateManyWithWhereWithoutGenderInput> =
  z
    .object({
...
export const BeneficiaryUpdateManyWithWhereWithoutGenderInputObjectSchema =
  Schema;
