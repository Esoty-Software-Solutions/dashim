...
const Schema: z.ZodType<Prisma.BenefitPackageUncheckedCreateWithoutMedicalServiceTemplatesInput> =
  z
    .object({
      id: z.string(),
...
export const BenefitPackageUncheckedCreateWithoutMedicalServiceTemplatesInputObjectSchema =
  Schema;
