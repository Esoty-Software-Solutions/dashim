...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryUncheckedUpdateManyWithoutBenefitPackageNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BenefitPackageMedicalServiceCategoryUncheckedUpdateManyWithoutBenefitPackageNestedInputObjectSchema =
  Schema;
