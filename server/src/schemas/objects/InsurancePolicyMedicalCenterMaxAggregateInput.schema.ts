...
const Schema: z.ZodType<Prisma.InsurancePolicyMedicalCenterMaxAggregateInputType> =
  z
    .object({
...
export const InsurancePolicyMedicalCenterMaxAggregateInputObjectSchema = Schema;
