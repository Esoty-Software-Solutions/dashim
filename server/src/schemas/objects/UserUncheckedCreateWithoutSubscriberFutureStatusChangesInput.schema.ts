...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutSubscriberFutureStatusChangesInput> =
  z
    .object({
      id: z.string(),
...
export const UserUncheckedCreateWithoutSubscriberFutureStatusChangesInputObjectSchema =
  Schema;
