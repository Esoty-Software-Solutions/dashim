...
const Schema: z.ZodType<Prisma.MedicalServiceUncheckedUpdateWithoutBeneficiaryServicesInput> =
  z
    .object({
      id: z
        .union([
...
export const MedicalServiceUncheckedUpdateWithoutBeneficiaryServicesInputObjectSchema =
  Schema;
