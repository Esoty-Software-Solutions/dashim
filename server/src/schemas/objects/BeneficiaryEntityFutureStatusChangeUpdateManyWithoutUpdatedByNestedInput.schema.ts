...
const Schema: z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeUpdateManyWithoutUpdatedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryEntityFutureStatusChangeUpdateManyWithoutUpdatedByNestedInputObjectSchema =
  Schema;
