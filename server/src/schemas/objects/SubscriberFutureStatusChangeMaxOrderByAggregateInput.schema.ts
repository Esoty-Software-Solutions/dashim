...
const Schema: z.ZodType<Prisma.SubscriberFutureStatusChangeMaxOrderByAggregateInput> =
  z
    .object({
...
export const SubscriberFutureStatusChangeMaxOrderByAggregateInputObjectSchema =
  Schema;
