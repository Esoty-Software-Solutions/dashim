...
const Schema: z.ZodType<Prisma.MedicalServiceUpdateManyWithWhereWithoutTemplateInput> =
  z
    .object({
...
export const MedicalServiceUpdateManyWithWhereWithoutTemplateInputObjectSchema =
  Schema;
