...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutEntryRecordServiceUpdatesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutEntryRecordServiceUpdatesInputObjectSchema =
  Schema;
