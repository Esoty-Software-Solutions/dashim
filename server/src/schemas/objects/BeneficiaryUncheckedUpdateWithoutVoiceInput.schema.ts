...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedUpdateWithoutVoiceInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const BeneficiaryUncheckedUpdateWithoutVoiceInputObjectSchema = Schema;
