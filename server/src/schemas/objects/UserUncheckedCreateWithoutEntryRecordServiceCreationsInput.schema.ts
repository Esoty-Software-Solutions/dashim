...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutEntryRecordServiceCreationsInput> =
  z
    .object({
      id: z.string(),
...
export const UserUncheckedCreateWithoutEntryRecordServiceCreationsInputObjectSchema =
  Schema;
