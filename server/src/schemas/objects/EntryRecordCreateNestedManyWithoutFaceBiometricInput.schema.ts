...
const Schema: z.ZodType<Prisma.EntryRecordCreateNestedManyWithoutFaceBiometricInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordCreateNestedManyWithoutFaceBiometricInputObjectSchema =
  Schema;
