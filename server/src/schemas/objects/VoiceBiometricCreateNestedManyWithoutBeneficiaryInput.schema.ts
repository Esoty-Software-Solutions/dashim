...
const Schema: z.ZodType<Prisma.VoiceBiometricCreateNestedManyWithoutBeneficiaryInput> =
  z
    .object({
      create: z
        .union([
...
export const VoiceBiometricCreateNestedManyWithoutBeneficiaryInputObjectSchema =
  Schema;
