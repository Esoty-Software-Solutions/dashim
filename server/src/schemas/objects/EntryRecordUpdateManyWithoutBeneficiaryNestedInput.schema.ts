...
const Schema: z.ZodType<Prisma.EntryRecordUpdateManyWithoutBeneficiaryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordUpdateManyWithoutBeneficiaryNestedInputObjectSchema =
  Schema;
