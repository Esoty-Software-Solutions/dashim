...
const Schema: z.ZodType<Prisma.BeneficiaryServiceCreateNestedManyWithoutUpdatedByInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryServiceCreateNestedManyWithoutUpdatedByInputObjectSchema =
  Schema;
