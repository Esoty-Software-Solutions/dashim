...
const Schema: z.ZodType<Prisma.UserUpdateWithoutBeneficiaryEntityFutureStatusCreationsInput> =
  z
    .object({
      id: z
        .union([
      ...
      gender: z
        .lazy(
          () => GenderEnumUpdateOneRequiredWithoutUserNestedInputObjectSchema,
        )
        .optional(),
      deviceToken: z
...
export const UserUpdateWithoutBeneficiaryEntityFutureStatusCreationsInputObjectSchema =
  Schema;
