...
const Schema: z.ZodType<Prisma.PatientServiceUncheckedCreateNestedManyWithoutMedicalServiceInput> =
  z
    .object({
      create: z
        .union([
...
export const PatientServiceUncheckedCreateNestedManyWithoutMedicalServiceInputObjectSchema =
  Schema;
