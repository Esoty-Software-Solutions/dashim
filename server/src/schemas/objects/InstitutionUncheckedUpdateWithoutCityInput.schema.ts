...
const Schema: z.ZodType<Prisma.InstitutionUncheckedUpdateWithoutCityInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    MedicalCenterPricing: z
      .lazy(
        () =>
          InstitutionMedicalServiceUncheckedUpdateManyWithoutInstitutionNestedInputObjectSchema,
      )
      .optional(),
  })
  .strict();

export const InstitutionUncheckedUpdateWithoutCityInputObjectSchema = Schema;
