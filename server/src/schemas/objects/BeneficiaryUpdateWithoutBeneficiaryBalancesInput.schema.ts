...
const Schema: z.ZodType<Prisma.BeneficiaryUpdateWithoutBeneficiaryBalancesInput> =
  z
    .object({
      id: z
        .union([
...
export const BeneficiaryUpdateWithoutBeneficiaryBalancesInputObjectSchema =
  Schema;
