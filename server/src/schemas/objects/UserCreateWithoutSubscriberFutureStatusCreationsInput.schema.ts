...
const Schema: z.ZodType<Prisma.UserCreateWithoutSubscriberFutureStatusCreationsInput> =
  z
    .object({
      id: z.string(),
...
export const UserCreateWithoutSubscriberFutureStatusCreationsInputObjectSchema =
  Schema;
