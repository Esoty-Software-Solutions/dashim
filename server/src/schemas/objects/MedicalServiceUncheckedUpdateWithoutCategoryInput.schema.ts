...
const Schema: z.ZodType<Prisma.MedicalServiceUncheckedUpdateWithoutCategoryInput> =
  z
    .object({
      id: z
        .union([
...
export const MedicalServiceUncheckedUpdateWithoutCategoryInputObjectSchema =
  Schema;
