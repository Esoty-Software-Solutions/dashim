...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutBeneficiaryEntityStatusChangesInput> =
  z
    .object({
      id: z.string(),
...
export const UserUncheckedCreateWithoutBeneficiaryEntityStatusChangesInputObjectSchema =
  Schema;
