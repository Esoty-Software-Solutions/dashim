...
const Schema: z.ZodType<Prisma.BeneficiaryServiceCreateNestedManyWithoutEntryRecordInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryServiceCreateNestedManyWithoutEntryRecordInputObjectSchema =
  Schema;
