...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutVoiceInput> = z
  .object({
    id: z.string(),
...
export const BeneficiaryUncheckedCreateWithoutVoiceInputObjectSchema = Schema;
