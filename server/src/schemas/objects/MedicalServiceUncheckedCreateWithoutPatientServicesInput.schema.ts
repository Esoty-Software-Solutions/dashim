...
const Schema: z.ZodType<Prisma.MedicalServiceUncheckedCreateWithoutPatientServicesInput> =
  z
    .object({
      id: z.string(),
...
export const MedicalServiceUncheckedCreateWithoutPatientServicesInputObjectSchema =
  Schema;
