...
const Schema: z.ZodType<Prisma.CityUncheckedCreateWithoutBeneficiaryEntitiesInput> =
  z
    .object({
      id: z.string(),
...
export const CityUncheckedCreateWithoutBeneficiaryEntitiesInputObjectSchema =
  Schema;
