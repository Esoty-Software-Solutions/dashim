...
const Schema: z.ZodType<Prisma.MedicalServiceUpdateManyWithoutCategoryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MedicalServiceUpdateManyWithoutCategoryNestedInputObjectSchema =
  Schema;
