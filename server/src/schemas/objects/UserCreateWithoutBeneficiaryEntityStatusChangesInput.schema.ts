...
const Schema: z.ZodType<Prisma.UserCreateWithoutBeneficiaryEntityStatusChangesInput> =
  z
    .object({
      id: z.string(),
...
export const UserCreateWithoutBeneficiaryEntityStatusChangesInputObjectSchema =
  Schema;
