...
const Schema: z.ZodType<Prisma.BeneficiaryServiceCreateNestedManyWithoutMedicalServiceInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryServiceCreateNestedManyWithoutMedicalServiceInputObjectSchema =
  Schema;
