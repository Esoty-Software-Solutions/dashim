...
const Schema: z.ZodType<Prisma.InsurancePolicyMedicalCenterUpdateManyWithoutMedicalCenterNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const InsurancePolicyMedicalCenterUpdateManyWithoutMedicalCenterNestedInputObjectSchema =
  Schema;
