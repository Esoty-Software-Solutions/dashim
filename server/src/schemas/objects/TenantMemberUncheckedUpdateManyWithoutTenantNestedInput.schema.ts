...
const Schema: z.ZodType<Prisma.TenantMemberUncheckedUpdateManyWithoutTenantNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TenantMemberUncheckedUpdateManyWithoutTenantNestedInputObjectSchema =
  Schema;
