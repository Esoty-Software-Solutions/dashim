...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutBeneficiaryServiceUpdatesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutBeneficiaryServiceUpdatesInputObjectSchema =
  Schema;
