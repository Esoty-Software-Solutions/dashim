...
const Schema: z.ZodType<Prisma.BeneficiaryServiceCreateManyEntryRecordInput> = z
  .object({
    id: z.string(),
...
export const BeneficiaryServiceCreateManyEntryRecordInputObjectSchema = Schema;
