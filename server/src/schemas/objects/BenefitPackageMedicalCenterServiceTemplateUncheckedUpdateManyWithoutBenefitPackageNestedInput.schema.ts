...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalCenterServiceTemplateUncheckedUpdateManyWithoutBenefitPackageNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BenefitPackageMedicalCenterServiceTemplateUncheckedUpdateManyWithoutBenefitPackageNestedInputObjectSchema =
  Schema;
