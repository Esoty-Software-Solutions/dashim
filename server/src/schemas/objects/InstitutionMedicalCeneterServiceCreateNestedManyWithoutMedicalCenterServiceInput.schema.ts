...
const Schema: z.ZodType<Prisma.InstitutionMedicalCeneterServiceCreateNestedManyWithoutMedicalCenterServiceInput> =
  z
    .object({
      create: z
        .union([
...
export const InstitutionMedicalCeneterServiceCreateNestedManyWithoutMedicalCenterServiceInputObjectSchema =
  Schema;
