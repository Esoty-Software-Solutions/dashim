...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutBeneficiaryEntityFutureStatusUpdatesInput> =
  z
    .object({
      id: z.string(),
...
export const UserUncheckedCreateWithoutBeneficiaryEntityFutureStatusUpdatesInputObjectSchema =
  Schema;
