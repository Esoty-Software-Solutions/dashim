...
const Schema: z.ZodType<Prisma.UserUpdateWithoutBeneficiaryEntityStatusChangesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUpdateWithoutBeneficiaryEntityStatusChangesInputObjectSchema =
  Schema;
