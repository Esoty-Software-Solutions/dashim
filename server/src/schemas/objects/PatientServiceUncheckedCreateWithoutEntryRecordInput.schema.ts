...
const Schema: z.ZodType<Prisma.PatientServiceUncheckedCreateWithoutEntryRecordInput> =
  z
    .object({
      id: z.string(),
...
export const PatientServiceUncheckedCreateWithoutEntryRecordInputObjectSchema =
  Schema;
