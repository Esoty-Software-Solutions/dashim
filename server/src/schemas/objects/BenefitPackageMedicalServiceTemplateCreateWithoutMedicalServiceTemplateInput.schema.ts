...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceTemplateCreateWithoutMedicalServiceTemplateInput> =
  z
    .object({
      id: z.string(),
...
export const BenefitPackageMedicalServiceTemplateCreateWithoutMedicalServiceTemplateInputObjectSchema =
  Schema;
