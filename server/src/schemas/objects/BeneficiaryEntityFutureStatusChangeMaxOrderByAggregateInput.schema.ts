...
const Schema: z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeMaxOrderByAggregateInput> =
  z
    .object({
...
export const BeneficiaryEntityFutureStatusChangeMaxOrderByAggregateInputObjectSchema =
  Schema;
