...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutReviewStatusUpdatesInput> =
  z
    .object({
      id: z.string(),
...
export const UserUncheckedCreateWithoutReviewStatusUpdatesInputObjectSchema =
  Schema;
