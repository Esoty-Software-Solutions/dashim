...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryUpdateManyWithoutMedicalServiceCategoryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BenefitPackageMedicalServiceCategoryUpdateManyWithoutMedicalServiceCategoryNestedInputObjectSchema =
  Schema;
