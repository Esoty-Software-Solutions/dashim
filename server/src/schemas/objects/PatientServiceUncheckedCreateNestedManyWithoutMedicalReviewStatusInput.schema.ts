...
const Schema: z.ZodType<Prisma.PatientServiceUncheckedCreateNestedManyWithoutMedicalReviewStatusInput> =
  z
    .object({
      create: z
        .union([
...
export const PatientServiceUncheckedCreateNestedManyWithoutMedicalReviewStatusInputObjectSchema =
  Schema;
