...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutStatusSetByInput> =
  z
    .object({
      id: z.string(),
...
export const BeneficiaryUncheckedCreateWithoutStatusSetByInputObjectSchema =
  Schema;
