...
const Schema: z.ZodType<Prisma.SubscriberUncheckedUpdateWithoutStatusSetByInput> =
  z
    .object({
      id: z
        .union([
...
export const SubscriberUncheckedUpdateWithoutStatusSetByInputObjectSchema =
  Schema;
