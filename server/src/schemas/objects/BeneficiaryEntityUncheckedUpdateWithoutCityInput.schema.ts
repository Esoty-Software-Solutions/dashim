...
const Schema: z.ZodType<Prisma.BeneficiaryEntityUncheckedUpdateWithoutCityInput> =
  z
    .object({
      id: z
        .union([
...
export const BeneficiaryEntityUncheckedUpdateWithoutCityInputObjectSchema =
  Schema;
