...
const Schema: z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeUncheckedCreateNestedManyWithoutBeneficiaryEntityInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryEntityFutureStatusChangeUncheckedCreateNestedManyWithoutBeneficiaryEntityInputObjectSchema =
  Schema;
