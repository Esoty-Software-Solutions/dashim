...
const Schema: z.ZodType<Prisma.CityEnumUncheckedUpdateWithoutMedicalcentersInput> =
  z
    .object({
      id: z
        .union([
...
export const CityEnumUncheckedUpdateWithoutMedicalcentersInputObjectSchema =
  Schema;
