...
const Schema: z.ZodType<Prisma.BeneficiaryServiceUncheckedUpdateOneWithoutReviewStatusNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryServiceUncheckedUpdateOneWithoutReviewStatusNestedInputObjectSchema =
  Schema;
