...
const Schema: z.ZodType<Prisma.ReviewStatusUpdateManyWithoutUpdatedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ReviewStatusUpdateManyWithoutUpdatedByNestedInputObjectSchema =
  Schema;
