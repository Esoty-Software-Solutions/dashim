...
const Schema: z.ZodType<Prisma.BenefitPackageUncheckedCreateWithoutMedicalServiceCategoriesInput> =
  z
    .object({
      id: z.string(),
...
export const BenefitPackageUncheckedCreateWithoutMedicalServiceCategoriesInputObjectSchema =
  Schema;
