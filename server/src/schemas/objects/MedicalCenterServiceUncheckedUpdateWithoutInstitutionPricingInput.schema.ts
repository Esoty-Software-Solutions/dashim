...
const Schema: z.ZodType<Prisma.MedicalCenterServiceUncheckedUpdateWithoutInstitutionPricingInput> =
  z
    .object({
      id: z
        .union([
...
export const MedicalCenterServiceUncheckedUpdateWithoutInstitutionPricingInputObjectSchema =
  Schema;
