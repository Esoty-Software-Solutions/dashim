...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedUpdateManyWithoutStatusSetByNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () =>
              BeneficiaryUpsertWithWhereUniqueWithoutStatusSetByInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      update: z
        .union([
          z.lazy(
            () =>
              BeneficiaryUpdateWithWhereUniqueWithoutStatusSetByInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      updateMany: z
        .union([
          z.lazy(
            () =>
              BeneficiaryUpdateManyWithWhereWithoutStatusSetByInputObjectSchema,
          ),
          z
            .lazy(
              () =>
...
export const BeneficiaryUncheckedUpdateManyWithoutStatusSetByNestedInputObjectSchema =
  Schema;
