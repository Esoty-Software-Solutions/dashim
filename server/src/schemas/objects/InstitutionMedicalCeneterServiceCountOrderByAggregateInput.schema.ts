...
const Schema: z.ZodType<Prisma.InstitutionMedicalCeneterServiceCountOrderByAggregateInput> =
  z
    .object({
...
export const InstitutionMedicalCeneterServiceCountOrderByAggregateInputObjectSchema =
  Schema;
