...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedUpdateWithoutFingerprintInput> =
  z
    .object({
      id: z
        .union([
...
export const BeneficiaryUncheckedUpdateWithoutFingerprintInputObjectSchema =
  Schema;
