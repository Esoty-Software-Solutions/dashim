...
const Schema: z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeUpdateManyWithoutCreatedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryEntityFutureStatusChangeUpdateManyWithoutCreatedByNestedInputObjectSchema =
  Schema;
