...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutBeneficiaryBalancesInput> =
  z
    .object({
      id: z.string(),
...
export const BeneficiaryUncheckedCreateWithoutBeneficiaryBalancesInputObjectSchema =
  Schema;
