...
const Schema: z.ZodType<Prisma.UserUpdateWithoutBeneficiaryEntityFutureStatusUpdatesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUpdateWithoutBeneficiaryEntityFutureStatusUpdatesInputObjectSchema =
  Schema;
