...
const Schema: z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeWhereInput> =
  z
    .object({
      AND: z
        .union([
          z.lazy(
            () => BeneficiaryEntityFutureStatusChangeWhereInputObjectSchema,
          ),
          z
            .lazy(
              () => BeneficiaryEntityFutureStatusChangeWhereInputObjectSchema,
...
export const BeneficiaryEntityFutureStatusChangeWhereInputObjectSchema = Schema;
