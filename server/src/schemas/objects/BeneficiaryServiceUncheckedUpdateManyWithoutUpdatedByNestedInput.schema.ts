...
const Schema: z.ZodType<Prisma.BeneficiaryServiceUncheckedUpdateManyWithoutUpdatedByNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () =>
              BeneficiaryServiceUpsertWithWhereUniqueWithoutUpdatedByInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      update: z
        .union([
          z.lazy(
            () =>
              BeneficiaryServiceUpdateWithWhereUniqueWithoutUpdatedByInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      updateMany: z
        .union([
          z.lazy(
            () =>
              BeneficiaryServiceUpdateManyWithWhereWithoutUpdatedByInputObjectSchema,
          ),
          z
            .lazy(
              () =>
...
export const BeneficiaryServiceUncheckedUpdateManyWithoutUpdatedByNestedInputObjectSchema =
  Schema;
