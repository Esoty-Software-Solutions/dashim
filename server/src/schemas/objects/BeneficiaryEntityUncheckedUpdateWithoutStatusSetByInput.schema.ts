...
const Schema: z.ZodType<Prisma.BeneficiaryEntityUncheckedUpdateWithoutStatusSetByInput> =
  z
    .object({
      id: z
        .union([
...
export const BeneficiaryEntityUncheckedUpdateWithoutStatusSetByInputObjectSchema =
  Schema;
