...
const Schema: z.ZodType<Prisma.BeneficiaryEntityUncheckedUpdateManyWithoutInsurancePolicyNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryEntityUncheckedUpdateManyWithoutInsurancePolicyNestedInputObjectSchema =
  Schema;
