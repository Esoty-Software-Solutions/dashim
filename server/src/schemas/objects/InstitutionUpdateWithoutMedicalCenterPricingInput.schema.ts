...
const Schema: z.ZodType<Prisma.InstitutionUpdateWithoutMedicalCenterPricingInput> =
  z
    .object({
      id: z
        .union([
...
export const InstitutionUpdateWithoutMedicalCenterPricingInputObjectSchema =
  Schema;
