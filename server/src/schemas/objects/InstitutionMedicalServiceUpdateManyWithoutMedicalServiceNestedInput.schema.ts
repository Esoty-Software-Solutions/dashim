...
const Schema: z.ZodType<Prisma.InstitutionMedicalServiceUpdateManyWithoutMedicalServiceNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const InstitutionMedicalServiceUpdateManyWithoutMedicalServiceNestedInputObjectSchema =
  Schema;
