...
const Schema: z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeUncheckedUpdateManyWithoutUpdatedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryEntityFutureStatusChangeUncheckedUpdateManyWithoutUpdatedByNestedInputObjectSchema =
  Schema;
