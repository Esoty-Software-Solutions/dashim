...
const Schema: z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeCountOrderByAggregateInput> =
  z
    .object({
...
export const BeneficiaryEntityFutureStatusChangeCountOrderByAggregateInputObjectSchema =
  Schema;
