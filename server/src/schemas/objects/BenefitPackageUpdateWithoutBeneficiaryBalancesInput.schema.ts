...
const Schema: z.ZodType<Prisma.BenefitPackageUpdateWithoutBeneficiaryBalancesInput> =
  z
    .object({
      id: z
        .union([
...
export const BenefitPackageUpdateWithoutBeneficiaryBalancesInputObjectSchema =
  Schema;
