...
const Schema: z.ZodType<Prisma.InstitutionMedicalServiceMinOrderByAggregateInput> =
  z
    .object({
...
export const InstitutionMedicalServiceMinOrderByAggregateInputObjectSchema =
  Schema;
