...
const Schema: z.ZodType<Prisma.ReviewStatusUncheckedCreateNestedManyWithoutTransactionReviewStatusInput> =
  z
    .object({
      create: z
        .union([
...
export const ReviewStatusUncheckedCreateNestedManyWithoutTransactionReviewStatusInputObjectSchema =
  Schema;
