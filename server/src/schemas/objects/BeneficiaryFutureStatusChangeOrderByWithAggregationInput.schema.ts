...
const Schema: z.ZodType<Prisma.BeneficiaryFutureStatusChangeOrderByWithAggregationInput> =
  z
    .object({
      ...
      _count: z
        .lazy(
          () =>
            BeneficiaryFutureStatusChangeCountOrderByAggregateInputObjectSchema,
        )
        .optional(),
      _max: z
        .lazy(
          () =>
            BeneficiaryFutureStatusChangeMaxOrderByAggregateInputObjectSchema,
        )
        .optional(),
      _min: z
        .lazy(
          () =>
            BeneficiaryFutureStatusChangeMinOrderByAggregateInputObjectSchema,
        )
        .optional(),
    })
    .strict();

export const BeneficiaryFutureStatusChangeOrderByWithAggregationInputObjectSchema =
  Schema;
