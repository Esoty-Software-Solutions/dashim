...
const Schema: z.ZodType<Prisma.PatientServiceCreateManyMedicalServiceInput> = z
  .object({
    id: z.string(),
...
export const PatientServiceCreateManyMedicalServiceInputObjectSchema = Schema;
