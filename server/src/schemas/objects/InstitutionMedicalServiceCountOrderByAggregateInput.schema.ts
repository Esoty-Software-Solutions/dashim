...
const Schema: z.ZodType<Prisma.InstitutionMedicalServiceCountOrderByAggregateInput> =
  z
    .object({
...
export const InstitutionMedicalServiceCountOrderByAggregateInputObjectSchema =
  Schema;
