...
const Schema: z.ZodType<Prisma.EntryRecordCreateWithoutBeneficiaryServicesInput> =
  z
    .object({
      id: z.string(),
...
export const EntryRecordCreateWithoutBeneficiaryServicesInputObjectSchema =
  Schema;
