...
const Schema: z.ZodType<Prisma.UserCreateWithoutReviewStatusCreationsInput> = z
  .object({
    id: z.string(),
...
export const UserCreateWithoutReviewStatusCreationsInputObjectSchema = Schema;
