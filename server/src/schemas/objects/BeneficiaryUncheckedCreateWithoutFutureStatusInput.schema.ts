...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutFutureStatusInput> =
  z
    .object({
      id: z.string(),
...
export const BeneficiaryUncheckedCreateWithoutFutureStatusInputObjectSchema =
  Schema;
