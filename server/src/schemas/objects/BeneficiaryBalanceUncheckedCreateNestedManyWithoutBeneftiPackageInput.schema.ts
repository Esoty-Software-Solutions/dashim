...
const Schema: z.ZodType<Prisma.BeneficiaryBalanceUncheckedCreateNestedManyWithoutBeneftiPackageInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryBalanceUncheckedCreateNestedManyWithoutBeneftiPackageInputObjectSchema =
  Schema;
