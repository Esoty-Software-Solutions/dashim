...
const Schema: z.ZodType<Prisma.BenefitPackageUncheckedUpdateWithoutMedicalServiceCategoriesInput> =
  z
    .object({
      id: z
        .union([
...
export const BenefitPackageUncheckedUpdateWithoutMedicalServiceCategoriesInputObjectSchema =
  Schema;
