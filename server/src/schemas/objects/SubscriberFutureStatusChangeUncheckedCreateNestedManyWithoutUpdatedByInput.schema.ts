...
const Schema: z.ZodType<Prisma.SubscriberFutureStatusChangeUncheckedCreateNestedManyWithoutUpdatedByInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberFutureStatusChangeUncheckedCreateNestedManyWithoutUpdatedByInputObjectSchema =
  Schema;
