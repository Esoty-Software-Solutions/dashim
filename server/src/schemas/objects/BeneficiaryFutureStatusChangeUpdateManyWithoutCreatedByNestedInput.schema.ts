...
const Schema: z.ZodType<Prisma.BeneficiaryFutureStatusChangeUpdateManyWithoutCreatedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryFutureStatusChangeUpdateManyWithoutCreatedByNestedInputObjectSchema =
  Schema;
