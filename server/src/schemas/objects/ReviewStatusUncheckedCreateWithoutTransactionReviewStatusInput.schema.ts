...
const Schema: z.ZodType<Prisma.ReviewStatusUncheckedCreateWithoutTransactionReviewStatusInput> =
  z
    .object({
      id: z.string(),
...
export const ReviewStatusUncheckedCreateWithoutTransactionReviewStatusInputObjectSchema =
  Schema;
