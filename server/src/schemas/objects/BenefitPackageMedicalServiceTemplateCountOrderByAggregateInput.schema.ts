...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceTemplateCountOrderByAggregateInput> =
  z
    .object({
...
export const BenefitPackageMedicalServiceTemplateCountOrderByAggregateInputObjectSchema =
  Schema;
