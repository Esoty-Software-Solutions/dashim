...
const Schema: z.ZodType<Prisma.MedicalCenterServiceTemplateUncheckedCreateWithoutBeneftiPackagesInput> =
  z
    .object({
      id: z.string(),
...
export const MedicalCenterServiceTemplateUncheckedCreateWithoutBeneftiPackagesInputObjectSchema =
  Schema;
