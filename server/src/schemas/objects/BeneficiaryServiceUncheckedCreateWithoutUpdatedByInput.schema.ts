...
const Schema: z.ZodType<Prisma.BeneficiaryServiceUncheckedCreateWithoutUpdatedByInput> =
  z
    .object({
      id: z.string(),
...
export const BeneficiaryServiceUncheckedCreateWithoutUpdatedByInputObjectSchema =
  Schema;
