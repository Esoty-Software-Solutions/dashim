...
const Schema: z.ZodType<Prisma.GenderUncheckedCreateWithoutBeneficiaryInput> = z
  .object({
    id: z.string(),
...
export const GenderUncheckedCreateWithoutBeneficiaryInputObjectSchema = Schema;
