...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryCreateNestedManyWithoutBenefitPackageInput> =
  z
    .object({
      create: z
        .union([
...
export const BenefitPackageMedicalServiceCategoryCreateNestedManyWithoutBenefitPackageInputObjectSchema =
  Schema;
