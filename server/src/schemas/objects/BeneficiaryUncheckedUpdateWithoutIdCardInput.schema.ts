...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedUpdateWithoutIdCardInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const BeneficiaryUncheckedUpdateWithoutIdCardInputObjectSchema = Schema;
