...
const Schema: z.ZodType<Prisma.PatientServiceUpdateManyWithoutMedicalReviewStatusNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PatientServiceUpdateManyWithoutMedicalReviewStatusNestedInputObjectSchema =
  Schema;
