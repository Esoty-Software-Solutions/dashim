...
const Schema: z.ZodType<Prisma.VoiceBiometricUncheckedUpdateWithoutBeneficiaryInput> =
  z
    .object({
      id: z
        .union([
...
export const VoiceBiometricUncheckedUpdateWithoutBeneficiaryInputObjectSchema =
  Schema;
