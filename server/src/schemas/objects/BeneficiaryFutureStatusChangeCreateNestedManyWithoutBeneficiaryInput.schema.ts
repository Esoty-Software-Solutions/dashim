...
const Schema: z.ZodType<Prisma.BeneficiaryFutureStatusChangeCreateNestedManyWithoutBeneficiaryInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryFutureStatusChangeCreateNestedManyWithoutBeneficiaryInputObjectSchema =
  Schema;
