...
const Schema: z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeMinOrderByAggregateInput> =
  z
    .object({
...
export const BeneficiaryEntityFutureStatusChangeMinOrderByAggregateInputObjectSchema =
  Schema;
