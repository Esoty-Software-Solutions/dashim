...
const Schema: z.ZodType<Prisma.PatientServiceUpdateManyWithWhereWithoutMedicalServiceInput> =
  z
    .object({
...
export const PatientServiceUpdateManyWithWhereWithoutMedicalServiceInputObjectSchema =
  Schema;
