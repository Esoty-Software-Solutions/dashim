...
const Schema: z.ZodType<Prisma.ReviewStatusUncheckedUpdateWithoutMedicalReviewStatusInput> =
  z
    .object({
      id: z
        .union([
...
export const ReviewStatusUncheckedUpdateWithoutMedicalReviewStatusInputObjectSchema =
  Schema;
