...
const Schema: z.ZodType<Prisma.MedicalCenterServiceTemplateCreateWithoutBeneftiPackagesInput> =
  z
    .object({
      id: z.string(),
...
export const MedicalCenterServiceTemplateCreateWithoutBeneftiPackagesInputObjectSchema =
  Schema;
