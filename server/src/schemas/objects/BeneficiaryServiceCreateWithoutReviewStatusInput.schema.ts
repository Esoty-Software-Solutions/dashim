...
const Schema: z.ZodType<Prisma.BeneficiaryServiceCreateWithoutReviewStatusInput> =
  z
    .object({
      id: z.string(),
...
export const BeneficiaryServiceCreateWithoutReviewStatusInputObjectSchema =
  Schema;
