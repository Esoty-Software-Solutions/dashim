...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryMinOrderByAggregateInput> =
  z
    .object({
...
export const BenefitPackageMedicalServiceCategoryMinOrderByAggregateInputObjectSchema =
  Schema;
