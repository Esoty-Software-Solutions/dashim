...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutBeneficiaryFutureStatusChangesInput> =
  z
    .object({
      id: z.string(),
...
export const UserUncheckedCreateWithoutBeneficiaryFutureStatusChangesInputObjectSchema =
  Schema;
