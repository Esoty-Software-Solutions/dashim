...
const Schema: z.ZodType<Prisma.SubscriberFutureStatusChangeUncheckedUpdateManyWithoutCreatedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberFutureStatusChangeUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema =
  Schema;
