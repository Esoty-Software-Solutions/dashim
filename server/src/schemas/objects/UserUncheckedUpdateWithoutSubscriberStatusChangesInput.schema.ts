...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutSubscriberStatusChangesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutSubscriberStatusChangesInputObjectSchema =
  Schema;
