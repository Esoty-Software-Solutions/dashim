...
const Schema: z.ZodType<Prisma.InsurancePolicyMedicalCenterUncheckedUpdateManyWithoutInsurancePolicyNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const InsurancePolicyMedicalCenterUncheckedUpdateManyWithoutInsurancePolicyNestedInputObjectSchema =
  Schema;
