...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutBeneficiaryFutureStatusCreationsInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutBeneficiaryFutureStatusCreationsInputObjectSchema =
  Schema;
