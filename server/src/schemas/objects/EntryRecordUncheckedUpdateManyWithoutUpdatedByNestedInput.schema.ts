...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedUpdateManyWithoutUpdatedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordUncheckedUpdateManyWithoutUpdatedByNestedInputObjectSchema =
  Schema;
