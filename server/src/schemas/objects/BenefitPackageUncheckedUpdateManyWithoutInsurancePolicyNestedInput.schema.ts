...
const Schema: z.ZodType<Prisma.BenefitPackageUncheckedUpdateManyWithoutInsurancePolicyNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () =>
              BenefitPackageUpsertWithWhereUniqueWithoutInsurancePolicyInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      update: z
        .union([
          z.lazy(
            () =>
              BenefitPackageUpdateWithWhereUniqueWithoutInsurancePolicyInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      updateMany: z
        .union([
          z.lazy(
            () =>
              BenefitPackageUpdateManyWithWhereWithoutInsurancePolicyInputObjectSchema,
          ),
          z
            .lazy(
              () =>
...
export const BenefitPackageUncheckedUpdateManyWithoutInsurancePolicyNestedInputObjectSchema =
  Schema;
