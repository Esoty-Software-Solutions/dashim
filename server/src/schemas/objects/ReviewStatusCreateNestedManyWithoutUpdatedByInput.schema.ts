...
const Schema: z.ZodType<Prisma.ReviewStatusCreateNestedManyWithoutUpdatedByInput> =
  z
    .object({
      create: z
        .union([
...
export const ReviewStatusCreateNestedManyWithoutUpdatedByInputObjectSchema =
  Schema;
