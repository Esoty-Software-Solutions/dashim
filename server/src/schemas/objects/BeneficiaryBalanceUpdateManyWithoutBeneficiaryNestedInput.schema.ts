...
const Schema: z.ZodType<Prisma.BeneficiaryBalanceUpdateManyWithoutBeneficiaryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryBalanceUpdateManyWithoutBeneficiaryNestedInputObjectSchema =
  Schema;
