...
const Schema: z.ZodType<Prisma.UserCreateWithoutBeneficiaryServiceCreationsInput> =
  z
    .object({
      id: z.string(),
...
export const UserCreateWithoutBeneficiaryServiceCreationsInputObjectSchema =
  Schema;
