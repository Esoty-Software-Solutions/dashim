...
const Schema: z.ZodType<Prisma.MedicalCenterUpdateWithoutEntryRecordsInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const MedicalCenterUpdateWithoutEntryRecordsInputObjectSchema = Schema;
