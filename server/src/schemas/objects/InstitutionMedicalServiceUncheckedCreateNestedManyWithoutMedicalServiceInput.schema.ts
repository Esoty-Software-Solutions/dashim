...
const Schema: z.ZodType<Prisma.InstitutionMedicalServiceUncheckedCreateNestedManyWithoutMedicalServiceInput> =
  z
    .object({
      create: z
        .union([
...
export const InstitutionMedicalServiceUncheckedCreateNestedManyWithoutMedicalServiceInputObjectSchema =
  Schema;
