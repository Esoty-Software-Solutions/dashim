...
const Schema: z.ZodType<Prisma.UserUpdateWithoutBeneficiaryFutureStatusUpdatesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUpdateWithoutBeneficiaryFutureStatusUpdatesInputObjectSchema =
  Schema;
