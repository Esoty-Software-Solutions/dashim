...
const Schema: z.ZodType<Prisma.InstitutionMedicalServiceMaxAggregateInputType> =
  z
    .object({
...
export const InstitutionMedicalServiceMaxAggregateInputObjectSchema = Schema;
