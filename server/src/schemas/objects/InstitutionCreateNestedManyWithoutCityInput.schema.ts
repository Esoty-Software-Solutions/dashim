...
const Schema: z.ZodType<Prisma.InstitutionCreateNestedManyWithoutCityInput> = z
  .object({
    create: z
      .union([
...
export const InstitutionCreateNestedManyWithoutCityInputObjectSchema = Schema;
