...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryCountOrderByAggregateInput> =
  z
    .object({
...
export const BenefitPackageMedicalServiceCategoryCountOrderByAggregateInputObjectSchema =
  Schema;
