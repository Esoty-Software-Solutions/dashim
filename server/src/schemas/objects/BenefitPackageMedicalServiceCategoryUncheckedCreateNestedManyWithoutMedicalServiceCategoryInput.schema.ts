...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryUncheckedCreateNestedManyWithoutMedicalServiceCategoryInput> =
  z
    .object({
      create: z
        .union([
...
export const BenefitPackageMedicalServiceCategoryUncheckedCreateNestedManyWithoutMedicalServiceCategoryInputObjectSchema =
  Schema;
