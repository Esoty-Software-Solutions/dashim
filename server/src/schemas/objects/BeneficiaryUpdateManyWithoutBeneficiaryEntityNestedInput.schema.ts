...
const Schema: z.ZodType<Prisma.BeneficiaryUpdateManyWithoutBeneficiaryEntityNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryUpdateManyWithoutBeneficiaryEntityNestedInputObjectSchema =
  Schema;
