...
const Schema: z.ZodType<Prisma.MedicalServiceUncheckedUpdateManyWithoutTemplateNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MedicalServiceUncheckedUpdateManyWithoutTemplateNestedInputObjectSchema =
  Schema;
