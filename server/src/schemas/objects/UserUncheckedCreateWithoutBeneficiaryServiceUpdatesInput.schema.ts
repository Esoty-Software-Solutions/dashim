...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutBeneficiaryServiceUpdatesInput> =
  z
    .object({
      id: z.string(),
...
export const UserUncheckedCreateWithoutBeneficiaryServiceUpdatesInputObjectSchema =
  Schema;
