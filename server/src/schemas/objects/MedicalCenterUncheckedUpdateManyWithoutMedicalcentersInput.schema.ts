...
const Schema: z.ZodType<Prisma.MedicalCenterUncheckedUpdateManyWithoutMedicalcentersInput> =
  z
    .object({
      id: z
        .union([
...
export const MedicalCenterUncheckedUpdateManyWithoutMedicalcentersInputObjectSchema =
  Schema;
