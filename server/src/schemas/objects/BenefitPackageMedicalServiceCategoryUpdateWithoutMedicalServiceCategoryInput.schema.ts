...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryUpdateWithoutMedicalServiceCategoryInput> =
  z
    .object({
      id: z
        .union([
...
export const BenefitPackageMedicalServiceCategoryUpdateWithoutMedicalServiceCategoryInputObjectSchema =
  Schema;
