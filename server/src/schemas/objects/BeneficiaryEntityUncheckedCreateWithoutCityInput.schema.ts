...
const Schema: z.ZodType<Prisma.BeneficiaryEntityUncheckedCreateWithoutCityInput> =
  z
    .object({
      id: z.string(),
...
export const BeneficiaryEntityUncheckedCreateWithoutCityInputObjectSchema =
  Schema;
