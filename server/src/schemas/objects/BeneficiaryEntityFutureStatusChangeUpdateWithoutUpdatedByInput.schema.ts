...
const Schema: z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeUpdateWithoutUpdatedByInput> =
  z
    .object({
      id: z
        .union([
...
export const BeneficiaryEntityFutureStatusChangeUpdateWithoutUpdatedByInputObjectSchema =
  Schema;
