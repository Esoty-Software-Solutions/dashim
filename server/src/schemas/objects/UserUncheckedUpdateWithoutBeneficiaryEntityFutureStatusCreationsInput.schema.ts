...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutBeneficiaryEntityFutureStatusCreationsInput> =
  z
    .object({
      id: z
        .union([
      ...
      ownerOf: z
        .lazy(
          () => TenantUncheckedUpdateManyWithoutOwnerNestedInputObjectSchema,
        )
        .optional(),
      memberOf: z
        .lazy(
...
export const UserUncheckedUpdateWithoutBeneficiaryEntityFutureStatusCreationsInputObjectSchema =
  Schema;
