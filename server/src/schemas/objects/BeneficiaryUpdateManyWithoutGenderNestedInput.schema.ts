...
const Schema: z.ZodType<Prisma.BeneficiaryUpdateManyWithoutGenderNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryUpdateManyWithoutGenderNestedInputObjectSchema = Schema;
