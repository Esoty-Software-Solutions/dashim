...
const Schema: z.ZodType<Prisma.InstitutionUncheckedCreateWithoutMedicalCenterPricingInput> =
  z
    .object({
      id: z.string(),
...
export const InstitutionUncheckedCreateWithoutMedicalCenterPricingInputObjectSchema =
  Schema;
