...
const Schema: z.ZodType<Prisma.MedicalServiceUncheckedCreateNestedManyWithoutTemplateInput> =
  z
    .object({
      create: z
        .union([
...
export const MedicalServiceUncheckedCreateNestedManyWithoutTemplateInputObjectSchema =
  Schema;
