...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutBeneficiaryEntityFutureStatusChangesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutBeneficiaryEntityFutureStatusChangesInputObjectSchema =
  Schema;
