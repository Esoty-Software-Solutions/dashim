...
const Schema: z.ZodType<Prisma.InsurancePolicyUncheckedUpdateWithoutBeneficiaryEntitiesInput> =
  z
    .object({
      id: z
        .union([
...
export const InsurancePolicyUncheckedUpdateWithoutBeneficiaryEntitiesInputObjectSchema =
  Schema;
