...
const Schema: z.ZodType<Prisma.GenderEnumUncheckedUpdateWithoutBeneficiaryInput> =
  z
    .object({
      id: z
        .union([
...
export const GenderEnumUncheckedUpdateWithoutBeneficiaryInputObjectSchema =
  Schema;
