...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutBeneficiaryFutureStatusUpdatesInput> =
  z
    .object({
      id: z.string(),
...
export const UserUncheckedCreateWithoutBeneficiaryFutureStatusUpdatesInputObjectSchema =
  Schema;
