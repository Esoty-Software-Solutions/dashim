...
const Schema: z.ZodType<Prisma.CityUncheckedCreateWithoutMedicalcentersInput> =
  z
    .object({
      id: z.string(),
...
export const CityUncheckedCreateWithoutMedicalcentersInputObjectSchema = Schema;
