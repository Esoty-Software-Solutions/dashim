...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutBeneficiaryFutureStatusUpdatesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutBeneficiaryFutureStatusUpdatesInputObjectSchema =
  Schema;
