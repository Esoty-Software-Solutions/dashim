...
const Schema: z.ZodType<Prisma.FingerprintBiometricUncheckedCreateNestedManyWithoutBeneficiaryInput> =
  z
    .object({
      create: z
        .union([
...
export const FingerprintBiometricUncheckedCreateNestedManyWithoutBeneficiaryInputObjectSchema =
  Schema;
