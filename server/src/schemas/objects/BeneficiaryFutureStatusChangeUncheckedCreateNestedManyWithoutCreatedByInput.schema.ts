...
const Schema: z.ZodType<Prisma.BeneficiaryFutureStatusChangeUncheckedCreateNestedManyWithoutCreatedByInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryFutureStatusChangeUncheckedCreateNestedManyWithoutCreatedByInputObjectSchema =
  Schema;
