...
const Schema: z.ZodType<Prisma.InstitutionMedicalServiceCountAggregateInputType> =
  z
    .object({
...
export const InstitutionMedicalServiceCountAggregateInputObjectSchema = Schema;
