...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedUpdateManyWithoutFaceBiometricNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordUncheckedUpdateManyWithoutFaceBiometricNestedInputObjectSchema =
  Schema;
