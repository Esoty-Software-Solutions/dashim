...
const Schema: z.ZodType<Prisma.BeneficiaryServiceUpdateManyWithoutCreatedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryServiceUpdateManyWithoutCreatedByNestedInputObjectSchema =
  Schema;
