...
const Schema: z.ZodType<Prisma.UserUpdateWithoutBeneficiaryFutureStatusCreationsInput> =
  z
    .object({
      id: z
        .union([
      ...
      subscriberStatusChanges: z
        .lazy(
          () => SubscriberUpdateManyWithoutStatusSetByNestedInputObjectSchema,
        )
        .optional(),
...
export const UserUpdateWithoutBeneficiaryFutureStatusCreationsInputObjectSchema =
  Schema;
