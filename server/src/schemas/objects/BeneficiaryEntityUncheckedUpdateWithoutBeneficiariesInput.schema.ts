...
const Schema: z.ZodType<Prisma.BeneficiaryEntityUncheckedUpdateWithoutBeneficiariesInput> =
  z
    .object({
      id: z
        .union([
...
export const BeneficiaryEntityUncheckedUpdateWithoutBeneficiariesInputObjectSchema =
  Schema;
