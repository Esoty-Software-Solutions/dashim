...
const Schema: z.ZodType<Prisma.FingerprintBiometricUncheckedUpdateWithoutBeneficiaryInput> =
  z
    .object({
      id: z
        .union([
...
export const FingerprintBiometricUncheckedUpdateWithoutBeneficiaryInputObjectSchema =
  Schema;
