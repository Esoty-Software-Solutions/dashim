...
const Schema: z.ZodType<Prisma.CountryEnumOrderByWithAggregationInput> = z
  .object({
    ...
    _count: z
      .lazy(() => CountryEnumCountOrderByAggregateInputObjectSchema)
      .optional(),
    _max: z
      .lazy(() => CountryEnumMaxOrderByAggregateInputObjectSchema)
      .optional(),
    _min: z
      .lazy(() => CountryEnumMinOrderByAggregateInputObjectSchema)
      .optional(),
  })
  .strict();

export const CountryEnumOrderByWithAggregationInputObjectSchema = Schema;
