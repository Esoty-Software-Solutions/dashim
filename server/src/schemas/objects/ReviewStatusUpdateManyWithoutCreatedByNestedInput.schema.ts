...
const Schema: z.ZodType<Prisma.ReviewStatusUpdateManyWithoutCreatedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ReviewStatusUpdateManyWithoutCreatedByNestedInputObjectSchema =
  Schema;
