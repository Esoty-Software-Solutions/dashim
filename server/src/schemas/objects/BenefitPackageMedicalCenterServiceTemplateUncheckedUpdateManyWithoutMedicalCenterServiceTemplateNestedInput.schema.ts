...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalCenterServiceTemplateUncheckedUpdateManyWithoutMedicalCenterServiceTemplateNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BenefitPackageMedicalCenterServiceTemplateUncheckedUpdateManyWithoutMedicalCenterServiceTemplateNestedInputObjectSchema =
  Schema;
