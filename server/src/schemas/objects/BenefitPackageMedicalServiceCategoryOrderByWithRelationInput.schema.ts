...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceCategoryOrderByWithRelationInput> =
  z
    .object({
...
export const BenefitPackageMedicalServiceCategoryOrderByWithRelationInputObjectSchema =
  Schema;
