...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedCreateNestedManyWithoutFingerprintBiometricInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordUncheckedCreateNestedManyWithoutFingerprintBiometricInputObjectSchema =
  Schema;
