...
const Schema: z.ZodType<Prisma.UserCreateWithoutBeneficiaryFutureStatusUpdatesInput> =
  z
    .object({
      id: z.string(),
...
export const UserCreateWithoutBeneficiaryFutureStatusUpdatesInputObjectSchema =
  Schema;
