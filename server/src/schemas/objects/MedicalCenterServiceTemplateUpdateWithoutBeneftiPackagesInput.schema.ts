...
const Schema: z.ZodType<Prisma.MedicalCenterServiceTemplateUpdateWithoutBeneftiPackagesInput> =
  z
    .object({
      id: z
        .union([
...
export const MedicalCenterServiceTemplateUpdateWithoutBeneftiPackagesInputObjectSchema =
  Schema;
