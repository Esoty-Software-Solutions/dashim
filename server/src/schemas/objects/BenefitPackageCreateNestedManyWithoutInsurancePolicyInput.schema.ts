...
const Schema: z.ZodType<Prisma.BenefitPackageCreateNestedManyWithoutInsurancePolicyInput> =
  z
    .object({
      create: z
        .union([
...
export const BenefitPackageCreateNestedManyWithoutInsurancePolicyInputObjectSchema =
  Schema;
