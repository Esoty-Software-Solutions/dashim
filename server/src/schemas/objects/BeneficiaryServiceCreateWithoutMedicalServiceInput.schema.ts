...
const Schema: z.ZodType<Prisma.BeneficiaryServiceCreateWithoutMedicalServiceInput> =
  z
    .object({
      id: z.string(),
      ...
      CreatedBy: z.lazy(
        () =>
          UserCreateNestedOneWithoutBeneficiaryServiceCreationsInputObjectSchema,
      ),
      UpdatedBy: z
        .lazy(
          () =>
...
export const BeneficiaryServiceCreateWithoutMedicalServiceInputObjectSchema =
  Schema;
