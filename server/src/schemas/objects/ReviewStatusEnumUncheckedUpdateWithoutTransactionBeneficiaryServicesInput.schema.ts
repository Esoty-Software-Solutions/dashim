...
const Schema: z.ZodType<Prisma.ReviewStatusEnumUncheckedUpdateWithoutTransactionBeneficiaryServicesInput> =
  z
    .object({
      id: z
        .union([
...
export const ReviewStatusEnumUncheckedUpdateWithoutTransactionBeneficiaryServicesInputObjectSchema =
  Schema;
