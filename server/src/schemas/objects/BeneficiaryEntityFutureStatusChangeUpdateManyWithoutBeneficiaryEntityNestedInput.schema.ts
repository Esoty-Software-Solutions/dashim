...
const Schema: z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeUpdateManyWithoutBeneficiaryEntityNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryEntityFutureStatusChangeUpdateManyWithoutBeneficiaryEntityNestedInputObjectSchema =
  Schema;
