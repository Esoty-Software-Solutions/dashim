...
const Schema: z.ZodType<Prisma.BeneficiaryUpdateManyWithoutSubscriberNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryUpdateManyWithoutSubscriberNestedInputObjectSchema =
  Schema;
