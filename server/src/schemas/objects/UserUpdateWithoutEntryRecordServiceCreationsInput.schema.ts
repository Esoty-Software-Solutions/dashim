...
const Schema: z.ZodType<Prisma.UserUpdateWithoutEntryRecordServiceCreationsInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUpdateWithoutEntryRecordServiceCreationsInputObjectSchema =
  Schema;
