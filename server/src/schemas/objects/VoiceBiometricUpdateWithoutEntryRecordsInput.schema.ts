...
const Schema: z.ZodType<Prisma.VoiceBiometricUpdateWithoutEntryRecordsInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const VoiceBiometricUpdateWithoutEntryRecordsInputObjectSchema = Schema;
