...
const Schema: z.ZodType<Prisma.UserCreateWithoutSubscriberFutureStatusChangesInput> =
  z
    .object({
      id: z.string(),
...
export const UserCreateWithoutSubscriberFutureStatusChangesInputObjectSchema =
  Schema;
