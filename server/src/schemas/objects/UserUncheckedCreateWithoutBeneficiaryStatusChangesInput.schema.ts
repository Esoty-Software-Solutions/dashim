...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutBeneficiaryStatusChangesInput> =
  z
    .object({
      id: z.string(),
...
export const UserUncheckedCreateWithoutBeneficiaryStatusChangesInputObjectSchema =
  Schema;
