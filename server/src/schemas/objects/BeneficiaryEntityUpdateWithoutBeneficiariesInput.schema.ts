...
const Schema: z.ZodType<Prisma.BeneficiaryEntityUpdateWithoutBeneficiariesInput> =
  z
    .object({
      id: z
        .union([
...
export const BeneficiaryEntityUpdateWithoutBeneficiariesInputObjectSchema =
  Schema;
