...
const Schema: z.ZodType<Prisma.FingerprintBiometricUncheckedCreateWithoutFingerTypeInput> =
  z
    .object({
      id: z.string(),
...
export const FingerprintBiometricUncheckedCreateWithoutFingerTypeInputObjectSchema =
  Schema;
