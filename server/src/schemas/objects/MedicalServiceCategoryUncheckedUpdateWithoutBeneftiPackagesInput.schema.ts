...
const Schema: z.ZodType<Prisma.MedicalServiceCategoryUncheckedUpdateWithoutBeneftiPackagesInput> =
  z
    .object({
      id: z
        .union([
...
export const MedicalServiceCategoryUncheckedUpdateWithoutBeneftiPackagesInputObjectSchema =
  Schema;
