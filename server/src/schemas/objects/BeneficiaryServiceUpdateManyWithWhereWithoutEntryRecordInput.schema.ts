...
const Schema: z.ZodType<Prisma.BeneficiaryServiceUpdateManyWithWhereWithoutEntryRecordInput> =
  z
    .object({
...
export const BeneficiaryServiceUpdateManyWithWhereWithoutEntryRecordInputObjectSchema =
  Schema;
