...
const Schema: z.ZodType<Prisma.BeneficiaryEntityFutureStatusChangeUpdateWithoutBeneficiaryEntityInput> =
  z
    .object({
      id: z
        .union([
...
export const BeneficiaryEntityFutureStatusChangeUpdateWithoutBeneficiaryEntityInputObjectSchema =
  Schema;
