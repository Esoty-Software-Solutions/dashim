...
const Schema: z.ZodType<Prisma.MedicalServiceUncheckedUpdateWithoutTemplateInput> =
  z
    .object({
      id: z
        .union([
...
export const MedicalServiceUncheckedUpdateWithoutTemplateInputObjectSchema =
  Schema;
