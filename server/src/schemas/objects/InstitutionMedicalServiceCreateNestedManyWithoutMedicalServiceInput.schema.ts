...
const Schema: z.ZodType<Prisma.InstitutionMedicalServiceCreateNestedManyWithoutMedicalServiceInput> =
  z
    .object({
      create: z
        .union([
...
export const InstitutionMedicalServiceCreateNestedManyWithoutMedicalServiceInputObjectSchema =
  Schema;
