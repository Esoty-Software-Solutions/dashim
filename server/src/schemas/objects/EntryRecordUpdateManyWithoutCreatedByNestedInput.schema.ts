...
const Schema: z.ZodType<Prisma.EntryRecordUpdateManyWithoutCreatedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordUpdateManyWithoutCreatedByNestedInputObjectSchema =
  Schema;
