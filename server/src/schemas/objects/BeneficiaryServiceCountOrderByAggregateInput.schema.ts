...
const Schema: z.ZodType<Prisma.BeneficiaryServiceCountOrderByAggregateInput> = z
  .object({
...
export const BeneficiaryServiceCountOrderByAggregateInputObjectSchema = Schema;
