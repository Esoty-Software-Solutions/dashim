...
const Schema: z.ZodType<Prisma.MedicalServiceUpdateManyWithWhereWithoutMedicalCenterInput> =
  z
    .object({
...
export const MedicalServiceUpdateManyWithWhereWithoutMedicalCenterInputObjectSchema =
  Schema;
