...
const Schema: z.ZodType<Prisma.InsurancePolicyCreateWithoutBeneficiaryEntitiesInput> =
  z
    .object({
      id: z.string(),
...
export const InsurancePolicyCreateWithoutBeneficiaryEntitiesInputObjectSchema =
  Schema;
