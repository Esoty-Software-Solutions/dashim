...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalServiceTemplateUncheckedUpdateManyWithoutMedicalServiceTemplateNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BenefitPackageMedicalServiceTemplateUncheckedUpdateManyWithoutMedicalServiceTemplateNestedInputObjectSchema =
  Schema;
