...
const Schema: z.ZodType<Prisma.InstitutionMedicalCeneterServiceMaxOrderByAggregateInput> =
  z
    .object({
...
export const InstitutionMedicalCeneterServiceMaxOrderByAggregateInputObjectSchema =
  Schema;
