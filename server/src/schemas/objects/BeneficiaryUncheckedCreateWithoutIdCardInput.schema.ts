...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutIdCardInput> = z
  .object({
    id: z.string(),
...
export const BeneficiaryUncheckedCreateWithoutIdCardInputObjectSchema = Schema;
