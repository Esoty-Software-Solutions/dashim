...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutBeneficiaryEntityInput> =
  z
    .object({
      id: z.string(),
...
export const BeneficiaryUncheckedCreateWithoutBeneficiaryEntityInputObjectSchema =
  Schema;
