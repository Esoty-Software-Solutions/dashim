...
const Schema: z.ZodType<Prisma.TenantMemberUncheckedUpdateManyWithoutMemberNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () =>
              TenantMemberUpsertWithWhereUniqueWithoutMemberInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      update: z
        .union([
          z.lazy(
            () =>
              TenantMemberUpdateWithWhereUniqueWithoutMemberInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      updateMany: z
        .union([
          z.lazy(
            () => TenantMemberUpdateManyWithWhereWithoutMemberInputObjectSchema,
          ),
          z
            .lazy(
              () =>
...
export const TenantMemberUncheckedUpdateManyWithoutMemberNestedInputObjectSchema =
  Schema;
