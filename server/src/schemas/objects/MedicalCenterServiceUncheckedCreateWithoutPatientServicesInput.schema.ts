...
const Schema: z.ZodType<Prisma.MedicalCenterServiceUncheckedCreateWithoutPatientServicesInput> =
  z
    .object({
      id: z.string(),
...
export const MedicalCenterServiceUncheckedCreateWithoutPatientServicesInputObjectSchema =
  Schema;
