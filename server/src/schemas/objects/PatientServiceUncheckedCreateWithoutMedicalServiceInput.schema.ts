...
const Schema: z.ZodType<Prisma.PatientServiceUncheckedCreateWithoutMedicalServiceInput> =
  z
    .object({
      id: z.string(),
...
export const PatientServiceUncheckedCreateWithoutMedicalServiceInputObjectSchema =
  Schema;
