...
const Schema: z.ZodType<Prisma.CurrencyEnumOrderByWithAggregationInput> = z
  .object({
    ...
    _count: z
      .lazy(() => CurrencyEnumCountOrderByAggregateInputObjectSchema)
      .optional(),
    _avg: z
      .lazy(() => CurrencyEnumAvgOrderByAggregateInputObjectSchema)
      .optional(),
    _max: z
      .lazy(() => CurrencyEnumMaxOrderByAggregateInputObjectSchema)
      .optional(),
    _min: z
      .lazy(() => CurrencyEnumMinOrderByAggregateInputObjectSchema)
      .optional(),
    _sum: z
      .lazy(() => CurrencyEnumSumOrderByAggregateInputObjectSchema)
      .optional(),
  })
  .strict();

export const CurrencyEnumOrderByWithAggregationInputObjectSchema = Schema;
