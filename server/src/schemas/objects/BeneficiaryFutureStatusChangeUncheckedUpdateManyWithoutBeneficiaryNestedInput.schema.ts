...
const Schema: z.ZodType<Prisma.BeneficiaryFutureStatusChangeUncheckedUpdateManyWithoutBeneficiaryNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () =>
              BeneficiaryFutureStatusChangeUpsertWithWhereUniqueWithoutBeneficiaryInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      update: z
        .union([
          z.lazy(
            () =>
              BeneficiaryFutureStatusChangeUpdateWithWhereUniqueWithoutBeneficiaryInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      updateMany: z
        .union([
          z.lazy(
            () =>
              BeneficiaryFutureStatusChangeUpdateManyWithWhereWithoutBeneficiaryInputObjectSchema,
          ),
          z
            .lazy(
              () =>
...
export const BeneficiaryFutureStatusChangeUncheckedUpdateManyWithoutBeneficiaryNestedInputObjectSchema =
  Schema;
