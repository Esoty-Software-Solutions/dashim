...
const Schema: z.ZodType<Prisma.ReviewStatusUncheckedCreateNestedManyWithoutCreatedByInput> =
  z
    .object({
      create: z
        .union([
...
export const ReviewStatusUncheckedCreateNestedManyWithoutCreatedByInputObjectSchema =
  Schema;
