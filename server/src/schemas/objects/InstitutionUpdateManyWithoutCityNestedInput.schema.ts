...
const Schema: z.ZodType<Prisma.InstitutionUpdateManyWithoutCityNestedInput> = z
  .object({
    create: z
      .union([
...
export const InstitutionUpdateManyWithoutCityNestedInputObjectSchema = Schema;
