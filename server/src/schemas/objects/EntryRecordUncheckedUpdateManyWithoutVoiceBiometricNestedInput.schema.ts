...
const Schema: z.ZodType<Prisma.EntryRecordUncheckedUpdateManyWithoutVoiceBiometricNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const EntryRecordUncheckedUpdateManyWithoutVoiceBiometricNestedInputObjectSchema =
  Schema;
