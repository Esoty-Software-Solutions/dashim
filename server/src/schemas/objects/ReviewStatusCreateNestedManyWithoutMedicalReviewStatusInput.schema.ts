...
const Schema: z.ZodType<Prisma.ReviewStatusCreateNestedManyWithoutMedicalReviewStatusInput> =
  z
    .object({
      create: z
        .union([
...
export const ReviewStatusCreateNestedManyWithoutMedicalReviewStatusInputObjectSchema =
  Schema;
