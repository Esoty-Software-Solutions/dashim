...
const Schema: z.ZodType<Prisma.PatientServiceUpdateManyWithoutEntryRecordNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PatientServiceUpdateManyWithoutEntryRecordNestedInputObjectSchema =
  Schema;
