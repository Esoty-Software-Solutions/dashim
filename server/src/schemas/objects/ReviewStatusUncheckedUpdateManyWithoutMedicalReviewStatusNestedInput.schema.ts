...
const Schema: z.ZodType<Prisma.ReviewStatusUncheckedUpdateManyWithoutMedicalReviewStatusNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () =>
              ReviewStatusUpsertWithWhereUniqueWithoutMedicalReviewStatusInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      update: z
        .union([
          z.lazy(
            () =>
              ReviewStatusUpdateWithWhereUniqueWithoutMedicalReviewStatusInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      updateMany: z
        .union([
          z.lazy(
            () =>
              ReviewStatusUpdateManyWithWhereWithoutMedicalReviewStatusInputObjectSchema,
          ),
          z
            .lazy(
              () =>
...
export const ReviewStatusUncheckedUpdateManyWithoutMedicalReviewStatusNestedInputObjectSchema =
  Schema;
