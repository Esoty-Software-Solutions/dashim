...
const Schema: z.ZodType<Prisma.IDCardUncheckedUpdateManyWithoutBeneficiaryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const IDCardUncheckedUpdateManyWithoutBeneficiaryNestedInputObjectSchema =
  Schema;
