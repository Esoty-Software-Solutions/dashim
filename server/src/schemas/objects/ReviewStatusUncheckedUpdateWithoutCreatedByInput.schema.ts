...
const Schema: z.ZodType<Prisma.ReviewStatusUncheckedUpdateWithoutCreatedByInput> =
  z
    .object({
      id: z
        .union([
...
export const ReviewStatusUncheckedUpdateWithoutCreatedByInputObjectSchema =
  Schema;
