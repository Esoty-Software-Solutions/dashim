...
const Schema: z.ZodType<Prisma.BeneficiaryFutureStatusChangeUpdateWithoutUpdatedByInput> =
  z
    .object({
      id: z
        .union([
...
export const BeneficiaryFutureStatusChangeUpdateWithoutUpdatedByInputObjectSchema =
  Schema;
