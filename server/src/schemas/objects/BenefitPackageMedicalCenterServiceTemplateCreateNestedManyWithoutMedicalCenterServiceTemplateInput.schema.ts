...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalCenterServiceTemplateCreateNestedManyWithoutMedicalCenterServiceTemplateInput> =
  z
    .object({
      create: z
        .union([
...
export const BenefitPackageMedicalCenterServiceTemplateCreateNestedManyWithoutMedicalCenterServiceTemplateInputObjectSchema =
  Schema;
