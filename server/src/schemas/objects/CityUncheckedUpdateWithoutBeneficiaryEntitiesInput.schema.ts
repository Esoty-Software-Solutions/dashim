...
const Schema: z.ZodType<Prisma.CityUncheckedUpdateWithoutBeneficiaryEntitiesInput> =
  z
    .object({
      id: z
        .union([
...
export const CityUncheckedUpdateWithoutBeneficiaryEntitiesInputObjectSchema =
  Schema;
