...
const Schema: z.ZodType<Prisma.BenefitPackageMedicalCenterServiceTemplateUpdateWithoutMedicalCenterServiceTemplateInput> =
  z
    .object({
      id: z
        .union([
...
export const BenefitPackageMedicalCenterServiceTemplateUpdateWithoutMedicalCenterServiceTemplateInputObjectSchema =
  Schema;
