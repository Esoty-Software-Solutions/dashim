...
const Schema: z.ZodType<Prisma.BenefitPackageUpdateWithoutMedicalServiceTemplatesInput> =
  z
    .object({
      id: z
        .union([
...
export const BenefitPackageUpdateWithoutMedicalServiceTemplatesInputObjectSchema =
  Schema;
