...
const Schema: z.ZodType<Prisma.EntryRecordUpdateManyWithWhereWithoutFingerprintBiometricInput> =
  z
    .object({
...
export const EntryRecordUpdateManyWithWhereWithoutFingerprintBiometricInputObjectSchema =
  Schema;
