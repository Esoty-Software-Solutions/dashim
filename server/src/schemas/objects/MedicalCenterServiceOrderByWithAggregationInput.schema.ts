...
import { MedicalCenterServiceAvgOrderByAggregateInputObjectSchema } from './MedicalCenterServiceAvgOrderByAggregateInput.schema';
...
import { MedicalCenterServiceSumOrderByAggregateInputObjectSchema } from './MedicalCenterServiceSumOrderByAggregateInput.schema';
  ...
  z
    .object({
      ...
      _count: z
        ...
        .optional(),
      _avg: z
        .lazy(() => MedicalCenterServiceAvgOrderByAggregateInputObjectSchema)
        .optional(),
      _max: z
      ...
      _min: z
        ...
        .optional(),
      _sum: z
        .lazy(() => MedicalCenterServiceSumOrderByAggregateInputObjectSchema)
        .optional(),
    })
    .strict();
