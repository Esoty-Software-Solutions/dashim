...
const Schema: z.ZodType<Prisma.MedicalServiceUncheckedUpdateWithoutMedicalCenterInput> =
  z
    .object({
      id: z
        .union([
...
export const MedicalServiceUncheckedUpdateWithoutMedicalCenterInputObjectSchema =
  Schema;
