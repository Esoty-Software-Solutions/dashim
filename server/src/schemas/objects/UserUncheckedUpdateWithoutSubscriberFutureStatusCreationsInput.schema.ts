...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutSubscriberFutureStatusCreationsInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutSubscriberFutureStatusCreationsInputObjectSchema =
  Schema;
