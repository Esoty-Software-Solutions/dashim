...
const Schema: z.ZodType<Prisma.SubscriberFutureStatusChangeMinOrderByAggregateInput> =
  z
    .object({
...
export const SubscriberFutureStatusChangeMinOrderByAggregateInputObjectSchema =
  Schema;
