...
const Schema: z.ZodType<Prisma.ReviewStatusUncheckedUpdateWithoutTransactionReviewStatusInput> =
  z
    .object({
      id: z
        .union([
...
export const ReviewStatusUncheckedUpdateWithoutTransactionReviewStatusInputObjectSchema =
  Schema;
