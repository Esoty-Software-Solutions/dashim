...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutSubscriberStatusChangesInput> =
  z
    .object({
      id: z.string(),
...
export const UserUncheckedCreateWithoutSubscriberStatusChangesInputObjectSchema =
  Schema;
