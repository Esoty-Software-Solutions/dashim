...
const Schema: z.ZodType<Prisma.CityUncheckedUpdateWithoutInstitutionsInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const CityUncheckedUpdateWithoutInstitutionsInputObjectSchema = Schema;
