...
const Schema: z.ZodType<Prisma.PatientServiceUpdateWithoutMedicalReviewStatusInput> =
  z
    .object({
      id: z
        .union([
...
export const PatientServiceUpdateWithoutMedicalReviewStatusInputObjectSchema =
  Schema;
