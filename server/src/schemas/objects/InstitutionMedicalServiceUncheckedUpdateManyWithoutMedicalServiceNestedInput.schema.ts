...
const Schema: z.ZodType<Prisma.InstitutionMedicalServiceUncheckedUpdateManyWithoutMedicalServiceNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      connectOrCreate: z
        .union([
          z.lazy(
            () =>
              InstitutionMedicalServiceCreateOrConnectWithoutMedicalServiceInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      upsert: z
        .union([
          z.lazy(
            () =>
              InstitutionMedicalServiceUpsertWithWhereUniqueWithoutMedicalServiceInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      createMany: z
        .lazy(
          () =>
            InstitutionMedicalServiceCreateManyMedicalServiceInputEnvelopeObjectSchema,
        )
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(
            () =>
              InstitutionMedicalServiceUpdateWithWhereUniqueWithoutMedicalServiceInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      updateMany: z
        .union([
          z.lazy(
            () =>
              InstitutionMedicalServiceUpdateManyWithWhereWithoutMedicalServiceInputObjectSchema,
          ),
          z
            .lazy(
              () =>
...
export const InstitutionMedicalServiceUncheckedUpdateManyWithoutMedicalServiceNestedInputObjectSchema =
  Schema;
