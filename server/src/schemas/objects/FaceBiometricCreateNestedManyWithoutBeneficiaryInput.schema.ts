...
const Schema: z.ZodType<Prisma.FaceBiometricCreateNestedManyWithoutBeneficiaryInput> =
  z
    .object({
      create: z
        .union([
...
export const FaceBiometricCreateNestedManyWithoutBeneficiaryInputObjectSchema =
  Schema;
