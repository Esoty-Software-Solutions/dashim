...
const Schema: z.ZodType<Prisma.SubscriberFutureStatusChangeUncheckedCreateNestedManyWithoutCreatedByInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberFutureStatusChangeUncheckedCreateNestedManyWithoutCreatedByInputObjectSchema =
  Schema;
