...
const Schema: z.ZodType<Prisma.BeneficiaryFutureStatusChangeCountOrderByAggregateInput> =
  z
    .object({
...
export const BeneficiaryFutureStatusChangeCountOrderByAggregateInputObjectSchema =
  Schema;
