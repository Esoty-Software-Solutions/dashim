...
const Schema: z.ZodType<Prisma.ReviewStatusCreateNestedManyWithoutCreatedByInput> =
  z
    .object({
      create: z
        .union([
...
export const ReviewStatusCreateNestedManyWithoutCreatedByInputObjectSchema =
  Schema;
