...
const Schema: z.ZodType<Prisma.BeneficiaryUpdateManyWithoutRelationshipNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryUpdateManyWithoutRelationshipNestedInputObjectSchema =
  Schema;
