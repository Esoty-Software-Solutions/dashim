...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutReviewStatusUpdatesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutReviewStatusUpdatesInputObjectSchema =
  Schema;
