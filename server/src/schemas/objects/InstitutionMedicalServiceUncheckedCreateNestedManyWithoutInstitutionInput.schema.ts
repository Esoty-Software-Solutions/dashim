...
const Schema: z.ZodType<Prisma.InstitutionMedicalServiceUncheckedCreateNestedManyWithoutInstitutionInput> =
  z
    .object({
      create: z
        .union([
...
export const InstitutionMedicalServiceUncheckedCreateNestedManyWithoutInstitutionInputObjectSchema =
  Schema;
