...
const Schema: z.ZodType<Prisma.BeneficiaryEntityUncheckedCreateNestedManyWithoutCityInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryEntityUncheckedCreateNestedManyWithoutCityInputObjectSchema =
  Schema;
