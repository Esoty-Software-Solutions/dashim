...
const Schema: z.ZodType<Prisma.InstitutionMedicalCeneterServiceUncheckedCreateNestedManyWithoutInstitutionInput> =
  z
    .object({
      create: z
        .union([
...
export const InstitutionMedicalCeneterServiceUncheckedCreateNestedManyWithoutInstitutionInputObjectSchema =
  Schema;
