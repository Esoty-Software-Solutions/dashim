...
const Schema: z.ZodType<Prisma.BeneficiaryUncheckedCreateWithoutFingerprintInput> =
  z
    .object({
      id: z.string(),
...
export const BeneficiaryUncheckedCreateWithoutFingerprintInputObjectSchema =
  Schema;
