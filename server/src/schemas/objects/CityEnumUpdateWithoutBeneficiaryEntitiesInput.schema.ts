...
const Schema: z.ZodType<Prisma.CityEnumUpdateWithoutBeneficiaryEntitiesInput> =
  z
    .object({
      id: z
        .union([
...
export const CityEnumUpdateWithoutBeneficiaryEntitiesInputObjectSchema = Schema;
