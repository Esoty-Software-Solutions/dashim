...
const Schema: z.ZodType<Prisma.IDCardUpdateManyWithWhereWithoutBeneficiaryInput> =
  z
    .object({
...
export const IDCardUpdateManyWithWhereWithoutBeneficiaryInputObjectSchema =
  Schema;
