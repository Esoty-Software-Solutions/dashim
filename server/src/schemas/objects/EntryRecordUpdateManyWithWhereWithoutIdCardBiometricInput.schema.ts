...
const Schema: z.ZodType<Prisma.EntryRecordUpdateManyWithWhereWithoutIdCardBiometricInput> =
  z
    .object({
...
export const EntryRecordUpdateManyWithWhereWithoutIdCardBiometricInputObjectSchema =
  Schema;
