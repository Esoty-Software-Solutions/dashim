...
const Schema: z.ZodType<Prisma.BeneficiaryCreateWithoutBeneficiaryBalancesInput> =
  z
    .object({
      id: z.string(),
...
export const BeneficiaryCreateWithoutBeneficiaryBalancesInputObjectSchema =
  Schema;
