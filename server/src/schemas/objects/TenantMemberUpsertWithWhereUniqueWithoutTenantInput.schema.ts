...
const Schema: z.ZodType<Prisma.TenantMemberUpsertWithWhereUniqueWithoutTenantInput> =
  z
    .object({
...
export const TenantMemberUpsertWithWhereUniqueWithoutTenantInputObjectSchema =
  Schema;
