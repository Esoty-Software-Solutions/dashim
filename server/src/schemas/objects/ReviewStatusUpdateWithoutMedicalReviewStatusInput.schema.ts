...
const Schema: z.ZodType<Prisma.ReviewStatusUpdateWithoutMedicalReviewStatusInput> =
  z
    .object({
      id: z
        .union([
...
export const ReviewStatusUpdateWithoutMedicalReviewStatusInputObjectSchema =
  Schema;
