...
const Schema: z.ZodType<Prisma.BeneficiaryServiceCreateWithoutUpdatedByInput> =
  z
    .object({
      id: z.string(),
...
export const BeneficiaryServiceCreateWithoutUpdatedByInputObjectSchema = Schema;
