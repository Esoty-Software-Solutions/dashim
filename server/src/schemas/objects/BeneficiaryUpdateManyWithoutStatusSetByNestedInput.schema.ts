...
const Schema: z.ZodType<Prisma.BeneficiaryUpdateManyWithoutStatusSetByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficiaryUpdateManyWithoutStatusSetByNestedInputObjectSchema =
  Schema;
